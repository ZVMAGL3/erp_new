...
return array(
    ...
    "copyright_desc"                 => "Swexplorer是一款备受好评的web文档管理系统，你可以用它来做内部文档管理或共享、也可以用来管理服务器上的网站，取代Ftp，甚至可以当作webIDE直接在线开发。同时你也可以将此程序二次开发整合到你现有的系统。",
    "copyright_contact"              => "授权或定制请联系QQ:<a href=\"http://wpa.qq.com/msgrd?v=3&uin=6277979&site=qq&menu=yes\" target=\"_blank\">6277979</a><a href=\"javascript:core.openWindow('https://bbs.rcg.cn/');\">问题反馈</a>",
    "copyright_info"                 => "Copyright © swcom.cn",
    "copyright_pre"                  => "Powered by swcom",
    "kod_name"                       => "swExplorer",
    "kod_name_desc"                  => "SwExplorer深网是业内领先的政务•资源管理器",
    "kod_power_by"                   => " - Powered by swcom",
    "kod_name_copyright"             => "深网•资源管理器",
    "kod_meta_name"                  => "SwExplorer",
    "kod_meta_keywords"              => "SwExplorer,Sw,SwCloud,webos,webIDE,php filemanage,filemanage,文档管理系统,企业云盘,资源管理器,,在线文档,在线Office,在线办公,在线CAD预览,在线编辑,在线编辑器 ",
    "kod_meta_description"           => "SwExplorer深网是业内领先的政务/企业私有云和在线文档管理系统，为个人网站、企业私有云部署、网络存储、在线文档管理、在线办公等提供安全可控，简便易用、可高度定制的私有云产品。采用windows风格界面、操作习惯，无需适应即可快速上手，支持几百种常用文件格式的在线预览、播放和编辑，环境友好，功能强大，是一款一经试用，就再也离不开的私有云产品。",
    "kod_meta_copyright"             => "swcom.cn",
    "login"                          => "登录",
    "guest_login"                    => "游客登录",
    "username"                       => "登录账号",
    "userNickName"                   => "用户昵称",
