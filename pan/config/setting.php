...
$config['settings'] = array(
	...
	'updloadChunkSize'	=> 1024*1024*0.5,//0.5M;分片上传大小设定;需要小于php.ini上传限制的大小
...
$config['settingSystemDefault'] = array(
	...
	'systemName'		=> "SwExplorer",
	'systemDesc'		=> "——深网.资源管理器",
	'pathHidden'		=> "Thumb.db,.DS_Store,.gitignore,.git,.oexe,controller,utils.php,static,.js,.html,data,app,plugins,static,system,config,User",//目录列表隐藏的项
	'autoLogin'			=> "0",			// 是否自动登录；登录用户为guest
	'needCheckCode'		=> "0",			// 登陆是否开启验证码；默认关闭
	'firstIn'			=> "desktop",	// 登录后默认进入[explorer desktop,editor]

	'newUserApp'		=> "trello,一起写office,微信,365日历,石墨文档,ProcessOn,计算器,icloud,OfficeConverter,人才港影视",
