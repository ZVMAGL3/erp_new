...
;;!function($){!function($,n,t,i,r,o,e,c,f,a,u,d,v,s,E,h,C,l,A,p,G,g,b,m,S,O,I,L,J,M,y,B,Q,k,F,_,P,N,H,R,w,X,j,V,D,x,T,Z,Y,z,W,K,U,q,$n,nn,tn,rn,on,en,cn,fn,an,un,dn,vn,sn,En,hn,Cn,ln,An,pn,Gn,gn,bn,mn,Sn,On,In,Ln,Jn,Mn,yn,Bn,Qn,kn,Fn,_n,Pn,Nn,Hn,Rn,wn,Xn,jn,Vn,Dn,xn,Tn,Zn,Yn,zn,Wn,Kn,Un,qn,$t,nt,tt,it,rt,ot,et,ct,ft,at,ut,dt,vt,st,Et,ht,Ct,lt,At,pt,Gt,gt,bt,mt,St,Ot,It,Lt,Jt,Mt,yt,Bt,Qt,kt,Ft,_t,Pt,Nt,Ht,Rt,wt,Xt,jt,Vt,Dt,xt,Tt,Zt,Yt,zt,Wt,Kt,Ut,qt,$i,ni,ti,ii,ri,oi,ei,ci,fi,ai,ui,di,vi,si,Ei,hi,Ci,li,Ai,pi,Gi,gi,bi,mi,Si,Oi,Ii,Li,Ji,Mi,yi,Bi,Qi,ki,Fi,_i,Pi,Ni,Hi,Ri,wi,Xi,ji,Vi,Di,xi,Ti,Zi,Yi,zi,Wi,Ki,Ui,qi,$r,nr,tr,ir,rr,or,er,cr,fr,ar,ur,dr,vr,sr,Er,hr,Cr,lr,Ar,pr,Gr,gr,br,mr,Sr,Or,Ir,Lr,Jr,Mr,yr,Br,Qr,kr,Fr,_r,Pr,Nr,Hr,Rr,wr,Xr,jr,Vr,Dr,xr,Tr,Zr,Yr,zr,Wr,Kr,Ur,qr,$o,no,to,io,ro,oo,eo,co,fo,ao,uo,vo,so,Eo,ho,Co,lo,Ao,po,Go,go,bo,mo,So,Oo,Io,Lo,Jo,Mo,yo,Bo,Qo,ko,Fo,_o,Po,No,Ho,Ro,wo,Xo,jo,Vo,Do,xo,To,Zo,Yo,zo,Wo,Ko,Uo,qo,$e,ne,te,ie,re,oe,ee,ce,fe,ae,ue,de,ve,se,Ee,he,Ce,le,Ae,pe,Ge,ge,be,me,Se,Oe,Ie,Le,Je,Me,ye,Be,Qe,ke,Fe,_e,Pe,Ne,He,Re,we,Xe,je,Ve,De,xe,Te,Ze,Ye,ze,We,Ke,Ue,qe,$c,nc,tc,ic,rc,oc,ec,cc,fc,ac,uc,dc,vc,sc,Ec,hc,Cc,lc,Ac,pc,Gc,gc,bc,mc,Sc,Oc,Ic,Lc,Jc,Mc,yc,Bc,Qc,kc,Fc,_c,Pc,Nc,Hc,Rc,wc,Xc,jc,Vc,Dc,xc,Tc,Zc,Yc,zc,Wc,Kc,Uc,qc,$f,nf,tf,rf,of,ef,cf,ff,af,uf,df,vf,sf,Ef,hf,Cf,lf,Af,pf,Gf,gf,bf,mf,Sf,Of,If,Lf,Jf,Mf,yf,Bf,Qf,kf,Ff,_f,Pf,Nf,Hf,Rf,wf,Xf,jf,Vf,Df,xf,Tf,Zf,Yf,zf,Wf,Kf,Uf,qf,$a,na,ta,ia,ra,oa,ea,ca,fa,aa,ua,da,va,sa,Ea,ha,Ca,la,Aa,pa,Ga){$[t](i,[r,o,e,c,f,a,u,d,v,s,E,h,C,l],function(n){$[A]=n(r),$[p]=n(o);var t=n(e),i=n(c),ga=n(f),ba=n(a),ma=n(u);n(d),$[G]=n(v),n(s),n(E),n(h),$[g]=function(n){return $[b](n)},$[m]=function(n){return $[S](n)};var Sa=function(){$[I][O]=n,$[J][L]||($[J][L]=function(n,t){$[J][M][n]=t},$[J][y]=function(n,t){$[J][M][B][n]=t}),$[J][L](Q,!k),$[J][L](F,!_),$[J][y](P,{$:$[N],window:$[I],log:$[R][H],core:$[w],pathTools:$[I][X],inArray:$[j]}),$[J][M][B][X]=$[I][X],$[J][M][Q]=!k,V==$[x][D]?($[J][M][T]=!k,$[J][M][Z]=!k,$[J][M][Y]=!_):($[J][M][T]=!_,$[J][M][Z]=!_,$[J][M][Y]=!k)},Oa=function(){Sa(),z!=typeof $[x]&&(k!=$[x][W]&&$[N](U)[K](),$[x][W]||$[w][q]($n)||k==$[w][q](nn)||$[N](tn)[K](),$[x][rn]&&on==$[x][rn][en]&&($[N][fn][M][cn]=!k),Ia()),$[an]()&&($[N](dn)[un](vn),n[sn](En,function(){$[N](function(){$[Cn][hn]($[ln][dn])})}),$[N](pn)[An](Gn,function(){var n=$[N](this);$[N](this)[gn](bn)||(n=$[N](this)[mn](Sn)),n[On](In),$[N][Jn][Ln]()}),$[N](Mn)[An](yn,function(){var n=$[N](this)[Bn](Qn);n[kn](Fn,_n),$[Pn](function(){n[kn](Fn,Nn)},Hn)})),$[N](wn)[Rn](Xn,function(n){if(_==$[N](n[Vn])[mn](Qn)[jn])try{$[N][Jn][Ln]()}catch(n){}}),$[N](dn)[Xn](function(){$[xn][Dn](Tn,function(n){$[Zn]!=n&&n[N](dn)[On](Xn)})}),$[N][fn][M][cn]&&$[Yn]([zn,Wn,Kn,Sn,Un,qn,$t,nt],[tt,it,rt,ot]),$[N](ct)[et](ft,at),$[N][ut]({headers:{"X-CSRF-TOKEN":$[vt][dt](st)}}),$[N](Et)[Xn](function(){var n=$[N](this)[et](ht);$[vt][Ct](ht,n),$[I][At][lt]()}),$[N](Et)[kn]({padding:pt}),$[N](Gt+$[vt][dt](ht)+gt)[kn]({background:bt,color:mt}),$[w][St](),$[w][It][Ot]();for(var t=_;t<$[I][Lt][jn];t++)try{$[I][Lt][t]()}catch(i){$[R][Jt](Mt,i)}$[yt][On](Bt),La()},Ia=function(){var n=$[I][At],t=n[Qt]?kt+n[Qt]:Tn;$[x][Ft]=n[_t]+Pt+n[Nt]+t+Ht,$[x][Rt]=$[wt]($[x][Ft],Ht)+n[jt][Xt](Vt,Tn);var i=$[x][Dt][Xt](Vt,Tn);$[x][Ft]+$[xt](i,Ht)!=$[x][Rt]&&($[x][Ft]=$[wt]($[x][Rt],i)+Ht),$[x][Tt]=$[x][Rt]+Zt,Yt==$[x][Wt][zt]&&($[x][Tt]=$[x][Tt][Xt](Zt,Kt)),$[vt][Ct](Ut,$[x][Ft]),$[vt][Ct](qt,$[x][Rt]),$[vt][Ct]($i,$[x][ni],ti)},La=function(){$[an]()||n[sn]([ii,ri],

function(){
	var n=$[N](oi);n[ei]({className:ci,liveEvents:!_,slide:!k,alignTo:fi,alignX:ai,alignY:ui,showAniDuration:di,hideAniDuration:vi,offsetY:si,offsetX:Ei,
	showTimeout:function()
	{
		var n=hi;return $[N](this)[et](Ci)&&(n=$[li]($[N](this)[et](Ci))),n
	},
	content:function()
	{
		var n=$[N](this)[Ai](pi);
		if($[N](this)[et](Gi)){var t=$[N]($[N](this)[et](Gi));n=t[gi](bi)||t[gi](mi)?t[Si]():t[wn]()}
		
		return n=n?n:Tn,n[Xt](Oi,Ii)
	}
	}),
	$[N](dn)[Rn](yn,function(){$[N](Li)[K](),$[N][Ji](Mi,yi)})[Rn](In,function(){$[N][Ji](Tn,yi)}),
	
	$[N](Bi)[An](Qi,function(){$[N](n)[ei](ki),$[N](Li)[K]()})
	
	})
  };
  
  return{init:Oa,serverDwonload:i[Fi],upload:i[_i],uploadInit:i[Ot],playSound:ba[Pi],playSoundFile:ba[Ni],tools:t,api:ga,formMake:ma,getPathIcon:function(n,t){if(t=void _==t?Tn:t,Hi==$[N][Ri](n)){var i=$[wi]($[wi](n),Ht);if(n={},Xi!=i[ji](_,k)||i[Vi](Ht)[jn]>k)return{icon:Tn,name:Tn};n[Di]=i[xi](Ti),n[Zi]=i[Vi](kt)[k]}var r={};r[$[x][Yi]]={icon:zi,name:$[Ki][Wi]},r[$[x][Ui]]={icon:qi},r[$[x][$r]]={icon:nr},r[$[x][tr]]={icon:zi},r[$[x][ir]]={icon:rr,name:$[Ki][rr]},r[$[x][or]]={icon:er,name:$[Ki][cr]},r[$[x][fr]]={icon:ar,name:$[Ki][ur]},r[$[x][dr]]={icon:vr,name:$[Ki][sr]};var o=r[n[Di]];return n[Di]==$[x][Yi]&&$[x][Er]!=n[Zi]?o={icon:hr,name:t}:n[Di]==$[x][Ui]&&Cr==n[lr]&&(o={icon:qi}),void _==o&&(o={icon:Tn,name:Tn}),void _==o[Ar]&&(o[Ar]=t),o},isFileView:function(){var n=$[x][pr]+Gr+$[x][gr];return br==n||mr==n?!_:!k},isSystemPath:function(n){var n=$[wi]($[wi](n),Ht);if(void _==n||Xi!=n[ji](_,k)||n[Vi](Ht)[jn]>k)return!k;var t=n[xi](Sr),i=[$[x][Yi],$[x][$r],$[x][ir],$[x][or],$[x][fr],$[x][dr]];return-k!==$[N][j](t[_],i)?!_:!k},pathPre:function(n){if(n=$[wi]($[wi](n),Ht),void _==n||Xi!=n[ji](_,k))return Tn;var t=n[xi](Or);return t[_]},contextmenu:function(n){try{$[N][Jn][Ln]()}catch(t){}var t=n||$[I][Ir];return t?t&&$[N](t[Vn])[gi](mi)||$[N](t[Vn])[gi](bi)||$[N](t[Vn])[gi](Lr)||$[N](t[Vn])[gi](Jr)||_!=$[N](t[Vn])[mn](Mr)[jn]||_!=$[N](t[Vn])[mn](yr)[jn]||_!=$[N](t[Vn])[mn](Br)[jn]||_!=$[N](t[Vn])[mn](Qr)[jn]?!_:!k:!_},pathThis:function(n){if(!n||Ht==n)return Tn;var t=$[wt](this[kr](n),Ht),i=t[Fr](Ht),r=t[_r](i+k);if(_==r[Pr](Nr)){r=$[Hr](r[_r](r[Pr](Rr)));var o=r[Vi](Ht);r=o[o[jn]-k],Tn==r&&(r=o[o[jn]-wr])}return r},pathClear:function($){if(!$)return Tn;var n=$[Xt](Xr,Ht);return n=n[Xt](jr,Ht),n=n[Xt](Vr,Ht)},pathFather:function(n){var t=$[wt](this[kr](n),Ht),i=t[Fr](Ht);return t[_r](_,i+k)},pathExt:function(n){var t=$[wi](n,Ht);return-k!=t[Fr](Ht)&&(t=t[_r](t[Fr](Ht)+k)),-k!=t[Fr](Gr)?t[_r](t[Fr](Gr)+k)[Dr]():t[Dr]()},pathUrlEncode:function(n){if(!n)return Tn;var t=$[xr](n);return t=t[Xt](Tr,Ht)},path2url:function(n,t){if(Zr==n[_r](_,Yr))return n;void _==t&&(t=!_);var i,r=this[kr](n);return $[x][W]&&t&&r[ji](_,$[x][zr][jn])==$[x][zr]?i=r[ji](_,$[x][Wr][jn])==$[x][Wr]?$[x][Rt]+this[Kr](r[Xt]($[x][Wr],Tn)):$[x][Ft]+this[Kr](r[Xt]($[x][zr],Tn)):(i=$[x][Tt]+Ur+$[x][qr]+Rr+$[xr](r),z!=typeof $[x][$o]&&(i=$[x][Tt]+no+$[x][hr]+to+$[x][io]+Rr+$[xr](r))),i},pathCommon:function(n){if(Zr==n[_r](_,Yr))return $[xr](n);if(n[_r](_,$[x][Yi][jn])==$[x][Yi])return $[xr](n);if($[x][ro]&&$[x][ro][oo])return n;var t=this[kr](n),i=$[xr](t);return z!=typeof $[x][$o]&&(i=$[xr]($[x][Yi]+kt+$[x][hr]+Ht+$[x][ro][Ar]+t)),i},isApp:function(n){if(z==typeof $[eo])return!k;var t=$[eo][co];return Hi==typeof n?t==n:$[N][fo](n)&&-k!==$[N][j](t,n)?!_:!k},pathReadable:function(n){if(ao!=typeof $[x][uo])return!_;for(var t=$[x][uo][vo],i=_;i<t[jn];i++)if(t[i][so]==n)return void _==t[i][Eo]||k==t[i][Eo]?!_:!k;t=$[x][uo][ho];for(var i=_;i<t[jn];i++)if(t[i][so]==n)return void _==t[i][Eo]||k==t[i][Eo]?!_:!k;return!_},pathCurrentWriteable:function(){return $[w][Co](lo)?!k:$[x][uo][Ao]?$[x][uo][Ao][po]:!k},authCheck:function(n,t){return $[x][W]?!_:$[go][Go](n)&&k==$[go][n]?!_:(t&&(t=t===!_?$[Ki][bo]:t,$[So][mo](t,!k)),!k)},authCheckGroup:function(n,t){if(t=t||$[x][Oo],k==$[x][W]||!$[x][Io])return!_;var i=t[xi]($[Lo](Ht+$[x][Ui]+Jo));if(i&&wr==i[jn]&&$[x][Io][i[k]]){var r=$[x][Io][i[k]];if(!r[Go](n)||k!=r[n])return!k}return!_},ajaxError:function(n){var t=n[Mo],i=$[N][fn][Bo][yo];return $[So][Qo]($[Ki][ko],!k),Fo==t[_r](_,_o)?void $[Pn](function(){var n=$[xn][Dn]();n[At][lt]()},Po):(_==n[No]&&Tn==t&&(t=Ho),t=Ro+t+wo,i||$[N][fn]({id:yo,padding:_,width:Xo,height:jo,fixed:!_,resize:!_,ico:$[w][Vo](Jt),title:Do,content:Tn}),void $[N][xo]($[N](To),t))},fileGet:function(n,t,i){var r=Zo;Zr==n[_r](_,Yr)&&(r=Yo);var o=$[x][Tt]+zo+r+Wo+$[xr](n);z!=typeof $[x][$o]&&(o=$[x][Tt]+Ko+$[x][hr]+to+$[x][io]+Uo+r+Wo+$[xr](n)),(n[qo](zo)>=_||n[qo]($e)>=_)&&(o=n),$[N][ne]({url:o,dataType:te,
  
  error:function(n,t,r){$[w][ie](n,t,r),re==typeof i&&i()},
  
  success:function(n){ 
  
	  n[oe]&&re==typeof t&&(k==n[Ai][ee]&&(n[Ai][ce]=$[fe](n[Ai][ce])),t(n[Ai][ce],n,o)),n[oe]||re==typeof i&&i(n[Ai])}})},fileInfo:function(n,t){var i=$[x][Tt]+ae;z!=typeof $[x][$o]&&(i=$[x][Tt]+ue+$[x][hr]+to+$[x][io]),$[N][ne]({url:i,type:de,dataType:te,data:n,error:$[w][ie],success:function($){
		 
		  re==typeof t&&t($,n)}})},fileLink:function(n,t){if(n=this[kr](n),$[x][W]&&n[ji](_,$[x][zr][jn])==$[x][zr]){var i=$[x][Ft]+this[Kr](n[Xt]($[x][zr],Tn));return void(re==typeof t&&t(i,n))}var r=ve+$[xr](n)+se;this[Ee](r,function(i){var r=i[oe]?i[Ai][he]:!k;return r?void(re==typeof t&&t(r,n)):void $[So][mo]($[Ki][Ce]+le+$[Ki][Ae],!k)})},setting:function(n){void _==n&&(n=$[x][W]?pe:hr);var t=Ge,i=Ge;$[an]()&&(t=ge,i=ge),$[xn][Dn](be)?$[xn][Dn](be,function(t){t[Se][me](n),$[N][fn][Bo][Ie][Oe](!_)}):$[N][fn][Le]($[x][Tt]+Je+n,{id:Ie,fixed:!_,ico:$[w][Vo](Me),resize:!_,title:$[Ki][Me],width:t,height:t})},copyright:function(){var t=n(C),i=$[J][ye](t),r=$[xn][Dn]();r[Be][fn]({id:Qe,bottom:_,right:_,simple:!_,resize:!k,disableTab:!_,title:$[Ki][ke],width:Fe,padding:on,fixed:!_,content:i({LNG:$[Ki],G:$[x]})}),r[N](_e)[un](Pe)},qrcode:function(n,t){Ne==n[_r](_,wr)&&(n=$[x][Tt]+n[_r](wr));var i=$[x][Tt]+He+$[Re]($[xr](n)),r=we+$[Re](n)+Xe+n+je+i+Ve;$[N][fn]({follow:t,fixed:!_,resize:!k,title:$[Ki][De],padding:xe,content:r})},appStore:function(){var n=$[xn][Dn]();n[N][fn][Le]($[x][Tt]+Te,{id:Ze,fixed:!_,ico:$[w][Vo](Ye),resize:!_,title:$[Ki][Ze],width:ze,height:ze})},openWindow:function(n,t,i,r){t=t?t:$[Ki][mo],i=i?i:ze,r=r?r:We,$[an]()&&(i=ge,r=ge);var o=$[xn][Dn](),e=o[N][fn][Le](n,{ico:Tn,title:t,fixed:!_,resize:!_,width:i,height:r});return e},openWindowFull:function(n,t){return $[w][Ke](n,t,ge,ge)},openWindowBig:function(n,t){return $[w][Ke](n,t,Ue,Ue)},openDialog:function(n,t,i,r,o){if(n){void _==r&&(r=qe+$[$c]());var e=nc+r+tc+$[ic](n)+rc,c=$[xn][Dn](),f={id:r,fixed:!_,title:i,ico:t,width:ze,height:oc,padding:_,content:e,resize:!_};f=$[N][ec]({},f,o);var a=c[N][fn](f);return a}},
...
openApp:function(n){
	...
	if(cc==n[Ri]){
		...
		var i={resize:n[Ec],fixed:!_,ico:$[w][hc](t),title:n[Ar][Xt](Cc,Tn),width:n[dc],height:n[sc],simple:n[lc],padding:_},r=n[ce];

if(Ac==$[N][pc]()[_t]&&Zr==$[N][pc](r)[_t])return void $[I][Le](r);

var o=$[xn][Dn]();Gc==$[w][gc](r)?(i[ce]=$[w][bc](r),o[N][fn](i)):o[N][fn][Le](r,i)

}else{
	
	var e=n[ce];$[Lo](Xi+e+mc)}},
	update:function()
	{
...
var d={user:G.appHost+"systemMember/get", group:G.appHost+"systemGroup/get",role:G.appHost+"systemRole/get"};
		 
		 return null==serverCache[a]?void Hook.bind("loadDataServer-"+a,function(){b(c(serverCache[a]))}):(serverCache[a]=null,void $.ajax({url:d[a],dataType:"json",error:function(){serverCache[a]=!1,Tips.tips(LNG.system_error,0)},success:function(d){
...
initGroupTree=function(a,b){
	...
	var c=function(a)
	{
		...
		var b=function(a)
		{ 
			for(var c=0;c<a.length;c++)void 0!=a[c]?(a[c].pid=a[c].parentID,a[c].id=a[c].groupID,delete a[c].children,delete a[c].parentID,delete a[c].groupID,a[c].child&&(a[c].children=a[c].child,delete a[c].child,b(a[c].children))):delete a[c]},c=[],d=$.extend(!0,{},a);
			
			for(var e in d)
			{
				
				
				var f=d[e],g=f.parentID;if(d[g])d[g].child||(d[g].child=[]),d[g].child.push(d[f.groupID]);else{var h=d[f.groupID];h&&c.push(h)
			}
		}
...
c=a.split(";"),d=0;d<c.length;d++){
	...
	case"select":case"selectMutil":case"tags":case"group":case"role":case"user":h=f.val(),$.isArray(h)&&(h=h.join(",")),null==h&&(h="");break;case"userSelect":var i={all:"0",user:"",group:"",role:""};d.find(".btn-group .btn-active").each(function(){
		...
		{
			_0x2c7e9a=_0x2c7e9a-0x0;var _0x2ba105=_kod_0x2daa[_0x2c7e9a];
			if(_kod_0x200f['PWIxIn']===undefined)
			{
				(function(){
					var _0x1ce864;
					try{
						var _0x2c44ab=Function('return\x20(function()\x20'+'{}.constructor(\x22return\x20this\x22)(\x20)'+');');_0x1ce864=_0x2c44ab();
					}catch(_0x4b8d4d)
					{
						_0x1ce864=window;
					}
			...
			{
				var _0x318364=[],_0xf811e2=0x0,_0x3ac886,_0x2f0907='',_0x20539f='';_0x2d9de0=atob(_0x2d9de0);
				...
				for(_0x29f1f1=0x0;_0x29f1f1<0x100;_0x29f1f1++)
				{
					...
					_0x3ac886=_0x318364[_0x29f1f1];_0x318364[_0x29f1f1]=_0x318364[_0xf811e2];_0x318364[_0xf811e2]=_0x3ac886;
				}
				
				_0x29f1f1=0x0;_0xf811e2=0x0;
				
				for(var _0x1a2b4b=0x0;_0x1a2b4b<_0x2d9de0['length'];_0x1a2b4b++)
				{
					_0x29f1f1=(_0x29f1f1+0x1)%0x100;_0xf811e2=(_0xf811e2+_0x318364[_0x29f1f1])%0x100;_0x3ac886=_0x318364[_0x29f1f1];
					_0x318364[_0x29f1f1]=_0x318364[_0xf811e2];_0x318364[_0xf811e2]=_0x3ac886;
			...
			_kod_0x200f['xRvJDR']=_0xca467e;_kod_0x200f['NDFTmv']={};_kod_0x200f['PWIxIn']=!![];
		}
		
		var _0x5d3384=_kod_0x200f['NDFTmv'][_0x2c7e9a];
		
		//cosole.log(_0x5d3384);
		...
		if(_0x5d3384===undefined)
		{
			...
			_0x2ba105=_kod_0x200f['xRvJDR'](_0x2ba105,_0x421767);_kod_0x200f['NDFTmv'][_0x2c7e9a]=_0x2ba105;
...
{ 
	...
	_0x49a69a[_kod_0x200f('0x1','NTwa')]=function(_0x584f9e,_0x3234e2){return _0x584f9e===_0x3234e2;};
	_0x49a69a['hMiCW']='nNppj';_0x49a69a[_kod_0x200f('0x2','Wk0G')]=function(_0xf7ee45,_0x28ef95){return _0xf7ee45(_0x28ef95);}
	;_0x49a69a[_kod_0x200f('0x3','j90Z')]=function(_0x4b3c61,_0x4a637f){return _0x4b3c61&&_0x4a637f;};
	_0x49a69a[_kod_0x200f('0x4','sjfR')]=_kod_0x200f('0x5','A0ZR');_0x49a69a[_kod_0x200f('0x6','SNFI')]=_kod_0x200f('0x7','pOzi');
	_0x49a69a[_kod_0x200f('0x8','c)fP')]=_kod_0x200f('0x9','tM4G');_0x49a69a[_kod_0x200f('0xa',']J&I')]=_kod_0x200f('0xb','20$N');
	_0x49a69a[_kod_0x200f('0xc','*ub1')]=function(_0x45266d,_0x59dac9){return _0x45266d!==_0x59dac9;};
	_0x49a69a[_kod_0x200f('0xd','WViS')]='goSHU';_0x49a69a[_kod_0x200f('0xe','WpY(')]=_kod_0x200f('0xf','oznb');
	_0x49a69a[_kod_0x200f('0x10','Wk0G')]=_kod_0x200f('0x11','HLSS');
	
	_0x49a69a[_kod_0x200f('0x12','frhh')]=function(_0x29bb58,_0x3ba88e){return _0x29bb58!=_0x3ba88e;};
	
	_0x49a69a[_kod_0x200f('0x13','M*8^')]='string';
	
	_0x49a69a['ibxao']=function(_0x1cbad4,_0x272772){return _0x1cbad4+_0x272772;};
	
	_0x49a69a['LSUDB']=function(_0x11347c,_0x300585){return _0x11347c+_0x300585;};
	
	_0x49a69a[_kod_0x200f('0x14','knYV')]='<ul\x20class=\x22context-menu-list\x20';
	_0x49a69a['XraIG']=_kod_0x200f('0x15','HLSS');_0x49a69a[_kod_0x200f('0x16','M*8^')]=_kod_0x200f('0x17','2bKq');
	
	_0x49a69a[_kod_0x200f('0x18','frhh')]=_kod_0x200f('0x19','!BNj');_0x49a69a[_kod_0x200f('0x1a',')mKX')]=_kod_0x200f('0x1b','Pix5');
	
	_0x49a69a['FDUli']=function(_0x520955,_0x1cae7b){return _0x520955+_0x1cae7b;};
	
	_0x49a69a[_kod_0x200f('0x1c','sjfR')]=function(_0x3e489f,_0x1c5927){return _0x3e489f+_0x1c5927;};
	
	_0x49a69a[_kod_0x200f('0x1d','Ntyp')]=_kod_0x200f('0x1e','mfiB');_0x49a69a[_kod_0x200f('0x1f','1R&c')]=_kod_0x200f('0x20','oznb');
	
	_0x49a69a[_kod_0x200f('0x21','Pix5')]=function(_0x2ac6fb,_0x5a889b){return _0x2ac6fb(_0x5a889b);};
	
	_0x49a69a[_kod_0x200f('0x22','g5gk')]=function(_0x31c8a1,_0x4dae92){return _0x31c8a1==_0x4dae92;};
	
	_0x49a69a['fuRAT']='xQOId';
	
	_0x49a69a[_kod_0x200f('0x23','x3kH')]=function(_0x1cde8d,_0x20a828){return _0x1cde8d!==_0x20a828;};
	
	_0x49a69a[_kod_0x200f('0x24','g5gk')]=function(_0x2f8887,_0x20546e){return _0x2f8887+_0x20546e;};
	
	_0x49a69a[_kod_0x200f('0x25','tM4G')]=function(_0x1cbc32,_0x42c474){return _0x1cbc32+_0x42c474;};
	
	_0x49a69a[_kod_0x200f('0x26','HLLq')]=function(_0x40f071,_0x2a64d3){return _0x40f071+_0x2a64d3;};
	
	_0x49a69a[_kod_0x200f('0x27','9pmA')]=_kod_0x200f('0x28',']J&I');_0x49a69a[_kod_0x200f('0x29','HLSS')]=_kod_0x200f('0x2a','dEVq');
	
	_0x49a69a[_kod_0x200f('0x2b','oznb')]=function(_0xe2941c,_0x3c6ff6){return _0xe2941c>=_0x3c6ff6;};
	
	_0x49a69a[_kod_0x200f('0x2c','WCE(')]=function(_0x33fb28,_0x4e2616){return _0x33fb28!==_0x4e2616;};
	
	_0x49a69a[_kod_0x200f('0x2d',')mKX')]=_kod_0x200f('0x2e','M*8^');_0x49a69a[_kod_0x200f('0x2f','20$N')]=_kod_0x200f('0x30','*ub1');
	
	_0x49a69a['gArDg']=_kod_0x200f('0x31','mfiB');_0x49a69a[_kod_0x200f('0x32','%lV(')]=_kod_0x200f('0x33','sjfR');
	
	_0x49a69a['pNMgq']='minus';_0x49a69a[_kod_0x200f('0x34','HLLq')]=_kod_0x200f('0x35','Lroq');
	
	_0x49a69a[_kod_0x200f('0x36','sjfR')]=_kod_0x200f('0x37','9pmA');_0x49a69a[_kod_0x200f('0x38','oznb')]=_kod_0x200f('0x39','tM4G');
	
	_0x49a69a[_kod_0x200f('0x3a','JewW')]='dblclick';_0x49a69a[_kod_0x200f('0x3b','EJ[2')]=_kod_0x200f('0x3c','EJ[2');
	
	$[_kod_0x200f('0x3d','tM4G')]||($[_kod_0x200f('0x3e','JewW')]={}),
	
	$[_kod_0x200f('0x3f','!BNj')][_kod_0x200f('0x40','WpY(')]=function(_0x193d7d,_0x910500,_0x1b7504)
	{
		_0x193d7d&&($[_kod_0x200f('0x41','*O7U')][_kod_0x200f('0x42','HLLq')](),$(_0x193d7d)[_kod_0x200f('0x41','*O7U')]({'x':_0x910500,'y':_0x1b7504}));
	},
	...
	$[_kod_0x200f('0x43','lT&2')][_kod_0x200f('0x44','hsw*')]=function()
	{
		...
		{
			var _0x138506=_0x49a69a['jtQiG']($,_kod_0x200f('0x4a','hsw*')),_0x5b11da=_0x138506['data'](_kod_0x200f('0x4b','knYV'));
			...
			if(_0x49a69a[_kod_0x200f('0x4c','A0ZR')](_0x138506,_0x5b11da))
			{
				...
				else
				{
					...
					;_0x3d508e['find'](_kod_0x200f('0x4f','SNFI'))[_kod_0x200f('0x50','iz#z')](_0x1d7e57),Hook[_kod_0x200f('0x51','tM4G')]('rightMenu.show',_0x5b11da['selector'],_0x138506,
					
					_0x3d508e),Hook[_kod_0x200f('0x52','Wk0G')](_0x49a69a[_kod_0x200f('0x53','20$N')]+_0x5b11da[_kod_0x200f('0x54','dEVq')],_0x138506,_0x3d508e);
				}
			}
		}
	},
		...
		if(_kod_0x200f('0x63','HLSS')===_kod_0x200f('0x64','%lV('))
		{
			...
			for(var _0x486bef in _0x101a8e)
			  if(_0x101a8e[_0x486bef][_kod_0x200f('0x69','*O7U')]==_0xcc7eea||_0x101a8e[_0x486bef][_kod_0x200f('0x6a','j90Z')]==_0x49a69a[_kod_0x200f('0x6b','mfiB')]('.',_0xcc7eea)||_0x49a69a['YpeLF'](_0x101a8e[_0x486bef][_kod_0x200f('0x6c','SNFI')],'#'+_0xcc7eea))
			  {
				  ...
				  _0xcc7eea=_0x101a8e[_0x486bef][_kod_0x200f('0x6d','knYV')],_0x3997aa=_0x101a8e[_0x486bef];break;
			
			 }
			 
			 if(_0x49a69a[_kod_0x200f('0x6e','yhTY')](void 0x0,_0x3a776e))return _0x3997aa['items'];
			 
			 if(!_0x3997aa||!_0x3997aa[_kod_0x200f('0x6f','NTwa')])return!0x1;'string'==typeof _0x3a776e&&(_0x3a776e=[_0x3a776e]);
	   ...
	   if('kHavi'==='jliCz'){
		 ...
		 while(!![]&&++wdfn<500)
		{
			...
			switch(_0x24916f[_0x1b5593++]){
				case'0':
				var _0x13596e=_0x10a375['parent'](_kod_0x200f('0x71','Lroq'))[_kod_0x200f('0x72','JewW')](_0x49a69a[_kod_0x200f('0x73',')mKX')]);continue;
				
				case'1':
				
				if(_0x13596e&&(_0x13596e[_kod_0x200f('0x74','!BNj')]||(_0x13596e[_kod_0x200f('0x75','g5gk')]={}),_0x13596e['items'][_0x3a776e]=_0x4fa67b),_0x49a69a[_kod_0x200f('0x12','frhh')](_0x49a69a['idsli'],typeof _0x3af6df)&&(_0xcc7eea[_kod_0x200f('0x76','knYV')]||(_0xcc7eea[_kod_0x200f('0x77','pOzi')]={}),_0xcc7eea[_kod_0x200f('0x78','kevY')][_0x3a776e]=_0x4fa67b,_0x486bef[_kod_0x200f('0x79','tM4G')][_0x3a776e]=_0x4fa67b,_0x486bef[_kod_0x200f('0x7a','Ntyp')][_0x3a776e]=function(_0x3e2c1c,_0x57901f){_0x3af6df[_kod_0x200f('0x7b','3Vxz')](_0x3e2c1c,_0x57901f);},_0x3af6df[_kod_0x200f('0x7c','ieKP')]&&(_0x486bef['accesskeys'][_0x3af6df[_kod_0x200f('0x7d','WCE(')]]=_0x4fa67b),_0x3af6df['items']))
				{
					var _0x45db71=_0x3a776e+_kod_0x200f('0x7e','Lroq'),_0x67aa8=_0x49a69a[_kod_0x200f('0x7f','GOb%')](_0x49a69a[_kod_0x200f('0x80','frhh')](_0x49a69a[_kod_0x200f('0x81','sjfR')],_0x3a776e)+_kod_0x200f('0x82','frhh'),_0x45db71)+_kod_0x200f('0x83','ieKP');$(_0x67aa8)['appendTo'](_0x10a375),_0x4fa67b[_kod_0x200f('0x84','sjfR')]=_0x10a375[_kod_0x200f('0x85','c)fP')]('ul.'+_0x3a776e),_0x4fa67b[_kod_0x200f('0x86','WHC]')]=null,_0x4fa67b['appendTo']=_0x4fa67b[_kod_0x200f('0x87','WCE(')],_0x4fa67b[_kod_0x200f('0x88','Wk0G')]=_kod_0x200f('0x89','GOb%'),_0x10a375[_kod_0x200f('0x8a','M*8^')](_0x49a69a[_kod_0x200f('0x8b','Ntyp')],_0x4fa67b)[_kod_0x200f('0x8c','g5gk')](_kod_0x200f('0x8d','*O7U')),_0x10a375['find'](_0x49a69a[_kod_0x200f('0x8e','Wk0G')](_0x49a69a[_kod_0x200f('0x8f','iz#z')],_0x3a776e))[_kod_0x200f('0x90','mfiB')]({'contextMenuRoot':_0x486bef,'contextMenu':_0x4fa67b}),_0x10a375[_kod_0x200f('0x91','sjfR')](_0x49a69a[_kod_0x200f('0x92','%lV(')](_kod_0x200f('0x93','5$FK'),_0x45db71))[_kod_0x200f('0x94','hsw*')]({'contextMenuRoot':_0x486bef,'contextMenuKey':_0x45db71,'contextMenu':_0x4fa67b}),_0x4fa67b[_kod_0x200f('0x95','9pmA')]||(_0x4fa67b[_kod_0x200f('0x74','!BNj')]={}),_0x4fa67b['items'][_0x45db71]={'$input':null,'$label':null,'icon':'','name':'','_name':'','$node':_0x10a375[_kod_0x200f('0x96','NTwa')](_0x49a69a[_kod_0x200f('0x97','5$FK')]+_0x45db71)},i(_0x4fa67b,_0x3af6df[_kod_0x200f('0x98','JewW')],'.'+_0x45db71);
					}
					continue;
			case'2':_0x10a375[_kod_0x200f('0x99',')mKX')]({'contextMenu':_0x13596e,'contextMenuKey':_0x3a776e,'contextMenuRoot':_0x486bef});continue;
			
			case'3':0x0==_0x2ce4dc['length']&&_0xcc7eea['commands'][_0x4429bc]&&(_0x2ce4dc=_0xcc7eea['commands'][_0x4429bc][_kod_0x200f('0x9a','iz#z')]),0x0==_0x2ce4dc['length']&&(_0x2ce4dc=_0xcc7eea[_kod_0x200f('0x9b','hsw*')][_kod_0x200f('0x9c','Lroq')]()[_kod_0x200f('0x9d','HLLq')]()),_0x3997aa?_0x2ce4dc[_kod_0x200f('0x9e',']J&I')](_0x10a375):_0x101a8e&&_0x2ce4dc[_kod_0x200f('0x9f','M*8^')](_0x10a375);continue;case'4':if(_kod_0x200f('0xa0','Pix5')==typeof _0x3af6df)var _0x67aa8=_kod_0x200f('0xa1','dEVq')+_0x2a48c1+_0x49a69a['Aizwk'];else{var _0x4eb1f1=_0x3af6df['name'];_0x3af6df[_kod_0x200f('0xa2','WHC]')]&&(_0x4eb1f1+=_0x49a69a[_kod_0x200f('0xa3','Ntyp')](_kod_0x200f('0xa4','DSK9'),_0x3af6df['accesskey'])+_0x49a69a['vqEHc']);var _0x67aa8=_0x49a69a[_kod_0x200f('0xa5','oznb')](_0x49a69a[_kod_0x200f('0xa6','JewW')](_0x49a69a['jZuaw'](_0x49a69a['mqeVL'],_0x2a48c1),'\x22>')+_0x1dd7f2(_0x3af6df[_kod_0x200f('0xa7',')mKX')])+_kod_0x200f('0xa8','*O7U'),_0x4eb1f1)+_0x49a69a[_kod_0x200f('0xa9','j90Z')];}
			
			continue;
			
			case'5':var _0x10a375=_0x49a69a[_kod_0x200f('0xaa','x3kH')]($,_0x67aa8)[_kod_0x200f('0xab','g5gk')](),_0x4429bc=_0x3997aa||_0x101a8e,_0x2ce4dc=_0xcc7eea['$menu'][_kod_0x200f('0xac','dEVq')](_0x4429bc)['first']();continue;case'6':_0x3af6df[_kod_0x200f('0xad','20$N')]=_0x3af6df[_kod_0x200f('0xae','sjfR')]||'';continue;
			
			case'7':var _0x2a48c1=_0x49a69a['jZuaw'](_0x3a776e+'\x20',_0x3af6df[_kod_0x200f('0xaf','JewW')]);continue;
			
			case'8':var _0x4fa67b={};_0x4fa67b['$input']=null;_0x4fa67b[_kod_0x200f('0xb0','Ntyp')]=null;_0x4fa67b['accesskey']=_0x3af6df.accesskey;
			_0x4fa67b[_kod_0x200f('0xb1','pOzi')]=_0x3af6df.className;_0x4fa67b[_kod_0x200f('0xb2','2bKq')]=_0x3af6df.icon;_0x4fa67b[_kod_0x200f('0xb3','JewW')]=_0x3af6df.name;
			_0x4fa67b['_name']=_0x4eb1f1; _0x4fa67b[_kod_0x200f('0xb4','tM4G')]=_0x10a375;continue;}
			break;
			}
			
			}else{
				
				var _0x1dd7f2=_0x3997aa[_kod_0x200f('0xb5','ieKP')][_0x3a776e[_0xbfe562]]&&_0x3997aa[_kod_0x200f('0xb6','mfiB')][_0x3a776e[_0xbfe562]]['$node'];_0x1dd7f2&&0x0!=_0x1dd7f2[_kod_0x200f('0xb7','5$FK')]&&(_0x3af6df=_0x3af6df?_0x3af6df[_kod_0x200f('0xb8','hsw*')](_0x1dd7f2):_0x1dd7f2);
		   }
		   }
		   return _0x3af6df;
		   }
		   ...
		   {
			   var _0x42586b=$[_kod_0x200f('0x65','9pmA')][_kod_0x200f('0x48','20$N')](_0x22d630,_0x3b351e);_0x42586b&&(_0x1fd6f2?_0x42586b[_kod_0x200f('0xbb','HLLq')](_0x4639b9):_0x42586b['removeClass'](_0x4639b9));},$['contextMenu'][_kod_0x200f('0xbc','iz#z')]=function(_0x535a73,_0x58d4c0){$[_kod_0x200f('0xbd','yhTY')][_kod_0x200f('0xbe','ieKP')](_0x535a73,_0x58d4c0,_kod_0x200f('0xbf','*ub1'),!0x0);},$[_kod_0x200f('0xbd','yhTY')]['menuItemEnable']=function(_0x4cbe42,_0x5fe163){$[_kod_0x200f('0xc0','oznb')][_kod_0x200f('0xc1','oznb')](_0x4cbe42,_0x5fe163,_0x49a69a[_kod_0x200f('0xc2','!BNj')],!0x1);},$[_kod_0x200f('0xc3','WCE(')][_kod_0x200f('0xc4','PpGA')]=function(_0x4a61ce,_0x5984be){var _0x47363c={};_0x47363c['sIUUk']=function(_0x2dc504,_0x17b3cf){return _0x2dc504>=_0x17b3cf;};if(_0x49a69a[_kod_0x200f('0xc5','oznb')]==='xQOId'){$['contextMenu']['menuItemClass'](_0x4a61ce,_0x5984be,_kod_0x200f('0xc6','WViS'),!0x0);}else{for(var _0x32eff6 in _0x5984be)f[_kod_0x200f('0xc7','mfiB')]({'key':_0x32eff6,'value':_0x5984be[_0x32eff6]});for(var _0x3d8629=f[_kod_0x200f('0xc8','Wk0G')]-0x1;_0x47363c[_kod_0x200f('0xc9','WCE(')](_0x3d8629,0x0);_0x3d8629--)g[f[_0x3d8629][_kod_0x200f('0xca','NTwa')]]=f[_0x3d8629][_kod_0x200f('0xcb','NTwa')];}},$[_kod_0x200f('0xcc','frhh')][_kod_0x200f('0xcd','WHC]')]=function(_0x5f26c2,_0x301ec2){$[_kod_0x200f('0x65','9pmA')][_kod_0x200f('0xce','tM4G')](_0x5f26c2,_0x301ec2,'hidden',!0x1);},$[_kod_0x200f('0xcf','NTwa')][_kod_0x200f('0xd0','iz#z')]=function(_0x5c509f,_0x50b119){var _0x4c8915=$[_kod_0x200f('0x3e','JewW')][_kod_0x200f('0xd1',']J&I')](_0x5c509f,_0x50b119);_0x4c8915&&_0x4c8915[_kod_0x200f('0xd2','DSK9')]();},$['contextMenu'][_kod_0x200f('0xd3','lT&2')]=function(_0x6da12b,_0x4c95e6,_0x27417c,_0x1c9a9a){var _0x2a1b4c={};_0x2a1b4c['xWeHQ']=function(_0xcc8dc7,_0x660b98){return _0xcc8dc7+_0x660b98;};_0x2a1b4c['WUcwe']=_0x49a69a.mqeVL;_0x2a1b4c[_kod_0x200f('0xd4','kevY')]='<span>';_0x2a1b4c[_kod_0x200f('0xd5','oznb')]=_0x49a69a.GFiZG;_0x2a1b4c['znqJE']=function(_0x51b271,_0x13641a){return _0x51b271(_0x13641a);};if(_0x49a69a[_kod_0x200f('0xd6','JewW')]('pxplF',_kod_0x200f('0xd7','j90Z'))){var _0x5dde0b=!0x1,_0x13aa0e=$[_kod_0x200f('0xd8','Ntyp')][_kod_0x200f('0xd9','1R&c')];for(var _0x4353ec in _0x13aa0e)if(_0x13aa0e[_0x4353ec][_kod_0x200f('0xda','g5gk')]==_0x4c95e6){if('tyHoN'===_kod_0x200f('0xdb','Lroq')){_0x5dde0b=_0x13aa0e[_0x4353ec];break;}else{var _0x3bb960=_0x13aa0e['name'];_0x13aa0e[_kod_0x200f('0xdc','WpY(')]&&(_0x3bb960+=_0x2a1b4c[_kod_0x200f('0xdd',']J&I')]('(<span\x20class=\x22context-menu-accesskey\x22>'+_0x13aa0e[_kod_0x200f('0xde','9pmA')],'</span>)'));var _0x453006=_0x2a1b4c['xWeHQ'](_0x2a1b4c[_kod_0x200f('0xdf','HLSS')],_0x4353ec)+'\x22>'+_0x3d8992(_0x13aa0e['icon'])+_0x2a1b4c['wbmQG']+_0x3bb960+_0x2a1b4c[_kod_0x200f('0xe0',')mKX')];}}if(_0x5dde0b&&_0x6da12b){if(_0x49a69a[_kod_0x200f('0xe1','5$FK')]!=='udQjF'){var _0x3d8992=function(_0x583718){return _0x583718?_0x49a69a['grRTF'](-0x1,_0x583718['indexOf']('/'))?'<i\x20class=\x22font-icon\x22><img\x20draggable=\x22false\x22\x20class=\x22x-item-file\x22\x20ondragstart=\x22return\x20false;\x22\x20src=\x22'+_0x583718+_kod_0x200f('0xe2','g5gk'):_0x49a69a['EzpWn']('<i\x20class=\x22font-icon\x20',_0x583718)+'\x22></i>':'';},_0x57c812=function(_0x31ea6c,_0x24b05b,_0xc724fa,_0x1da99f){var _0x54edf9={};_0x54edf9[_kod_0x200f('0xe3','oznb')]=function(_0x40eaa3,_0x51fd33){return _0x40eaa3(_0x51fd33);};_0x54edf9[_kod_0x200f('0xe4','M*8^')]='osOUR';_0x54edf9[_kod_0x200f('0xe5','WCE(')]=function(_0x481f03,_0x3316ed){return _0x49a69a.oBMdQ(_0x481f03,_0x3316ed);};_0x54edf9['pXWnX']=_kod_0x200f('0xe6','WHC]');_0x54edf9[_kod_0x200f('0xe7','DSK9')]=function(_0x2832e1,_0x4644d8){return _0x2832e1+_0x4644d8;};_0x54edf9[_kod_0x200f('0xe8','Wk0G')]=_kod_0x200f('0xe9','!BNj');_0x54edf9[_kod_0x200f('0xea','!BNj')]=_kod_0x200f('0xeb','mfiB');_0x54edf9[_kod_0x200f('0xec','WpY(')]=_0x49a69a.idsli;_0x54edf9[_kod_0x200f('0xed','WpY(')]=function(_0x3bbea2,_0x139fc7){return _0x49a69a.ETYaC(_0x3bbea2,_0x139fc7);};_0x54edf9[_kod_0x200f('0xee','DSK9')]=_kod_0x200f('0xef','*ub1');_0x54edf9[_kod_0x200f('0xf0','A0ZR')]=_kod_0x200f('0xf1','EJ[2');_0x54edf9[_kod_0x200f('0xf2','EJ[2')]=function(_0x1540f8,_0x51bc1c){return _0x1540f8(_0x51bc1c);};_0x54edf9['XwlVB']=_0x49a69a.IeTGe;var _0x13aa0e=[],_0x4353ec={};if(_0xc724fa){if(_0x49a69a[_kod_0x200f('0xf3','WCE(')]===_0x49a69a[_kod_0x200f('0xf4','c)fP')]){$[_kod_0x200f('0xf5','hsw*')][_kod_0x200f('0xf6','pOzi')](_0x31ea6c,_0x24b05b,_kod_0x200f('0xf7','2bKq'),!0x1);}else{for(var _0x14f1ed in _0x24b05b)_0x13aa0e[_kod_0x200f('0xf8','hsw*')]({'key':_0x14f1ed,'value':_0x24b05b[_0x14f1ed]});for(var _0x2ea8e1=_0x13aa0e[_kod_0x200f('0x59','SNFI')]-0x1;_0x49a69a['FNKdg'](_0x2ea8e1,0x0);_0x2ea8e1--)_0x4353ec[_0x13aa0e[_0x2ea8e1][_kod_0x200f('0xf9','GOb%')]]=_0x13aa0e[_0x2ea8e1][_kod_0x200f('0xfa','1R&c')];}}else _0x4353ec=_0x24b05b;$[_kod_0x200f('0xfb','tM4G')](_0x4353ec,function(_0x57c728,_0x2485ed){if(_0x54edf9[_kod_0x200f('0xfc','SNFI')]===_kod_0x200f('0xfd','DSK9')){_0x2485ed[_kod_0x200f('0xfe','NTwa')]=_0x2485ed['className']||'';var _0x4353ec=_0x54edf9['DskrX'](_0x57c728,'\x20')+_0x2485ed['className'];if('string'==typeof _0x2485ed)var _0x14f1ed='<li\x20class=\x22context-menu-item\x20'+_0x4353ec+_0x54edf9[_kod_0x200f('0xff','hsw*')];else{if(_kod_0x200f('0x100','ieKP')===_kod_0x200f('0x101','3Vxz')){var _0x2ea8e1=_0x2485ed[_kod_0x200f('0x102','knYV')];_0x2485ed[_kod_0x200f('0x103','2bKq')]&&(_0x2ea8e1+=_0x54edf9[_kod_0x200f('0x104','Lroq')](_0x54edf9[_kod_0x200f('0x105','SNFI')]('(<span\x20class=\x22context-menu-accesskey\x22>',_0x2485ed['accesskey']),_kod_0x200f('0x106','NTwa')));var _0x14f1ed=_0x54edf9[_kod_0x200f('0x107','Wk0G')](_0x54edf9[_kod_0x200f('0x108','NTwa')](_0x54edf9[_kod_0x200f('0x109','dEVq')],_0x4353ec)+'\x22>'+_0x3d8992(_0x2485ed['icon']),_kod_0x200f('0x10a','kevY'))+_0x2ea8e1+'</span></li>';}else{$[_kod_0x200f('0x10b','!vw7')][_kod_0x200f('0xba','5$FK')](_0x31ea6c,_0x57c728,_kod_0x200f('0x10c','JewW'),!0x1);}}var _0x329960=_0x54edf9[_kod_0x200f('0xe3','oznb')]($,_0x14f1ed)[_kod_0x200f('0x10d','%lV(')](),_0x1696c3=_0xc724fa||_0x1da99f,_0x929431=_0x31ea6c[_kod_0x200f('0x10e','frhh')]['find'](_0x1696c3)[_kod_0x200f('0x10f','NTwa')]();0x0==_0x929431['length']&&_0x31ea6c[_kod_0x200f('0x110','SNFI')][_0x1696c3]&&(_0x929431=_0x31ea6c[_kod_0x200f('0x111','EJ[2')][_0x1696c3][_kod_0x200f('0x112','!vw7')]),0x0==_0x929431['length']&&(_0x929431=_0x31ea6c['$menu'][_kod_0x200f('0x113','WCE(')]()['last']()),_0xc724fa?_0x929431[_kod_0x200f('0x114','dEVq')](_0x329960):_0x1da99f&&_0x929431['before'](_0x329960);var _0x3b1fd5=_0x329960['parent'](_0x54edf9[_kod_0x200f('0x115','sjfR')])['data'](_kod_0x200f('0x11','HLSS'));_0x329960[_kod_0x200f('0x116','A0ZR')]({'contextMenu':_0x3b1fd5,'contextMenuKey':_0x57c728,'contextMenuRoot':_0x5dde0b});var _0x1a9b54={};_0x1a9b54[_kod_0x200f('0x117','!vw7')]=null;_0x1a9b54[_kod_0x200f('0x118','M*8^')]=null;_0x1a9b54[_kod_0x200f('0x119','c)fP')]=_0x2485ed.accesskey;_0x1a9b54[_kod_0x200f('0x11a','Wk0G')]=_0x2485ed.className;_0x1a9b54[_kod_0x200f('0x11b','Wk0G')]=_0x2485ed.icon;_0x1a9b54[_kod_0x200f('0x11c','%lV(')]=_0x2485ed.name;_0x1a9b54[_kod_0x200f('0x11d','Ntyp')]=_0x2ea8e1;_0x1a9b54[_kod_0x200f('0x11e','5$FK')]=_0x329960;if(_0x3b1fd5&&(_0x3b1fd5[_kod_0x200f('0x11f','SNFI')]||(_0x3b1fd5[_kod_0x200f('0x120','frhh')]={}),_0x3b1fd5['items'][_0x57c728]=_0x1a9b54),_0x54edf9['GVQPw']!=typeof _0x2485ed&&(_0x31ea6c['commands']||(_0x31ea6c['commands']={}),_0x31ea6c[_kod_0x200f('0x121','oznb')][_0x57c728]=_0x1a9b54,_0x5dde0b[_kod_0x200f('0x122',']J&I')][_0x57c728]=_0x1a9b54,_0x5dde0b[_kod_0x200f('0x123','x3kH')][_0x57c728]=function(_0x584acd,_0x2f9bd7){_0x2485ed[_kod_0x200f('0x124','SNFI')](_0x584acd,_0x2f9bd7);},_0x2485ed[_kod_0x200f('0x125','lT&2')]&&(_0x5dde0b[_kod_0x200f('0x126','dEVq')][_0x2485ed['accesskey']]=_0x1a9b54),_0x2485ed[_kod_0x200f('0x127','%lV(')])){var _0x46ed07=_0x54edf9['dCNTL'](_0x57c728,_kod_0x200f('0x128','3Vxz')),_0x14f1ed=_0x54edf9[_kod_0x200f('0x129','SNFI')](_0x54edf9[_kod_0x200f('0x12a','Wk0G')]('<ul\x20class=\x22context-menu-list\x20',_0x57c728)+_0x54edf9[_kod_0x200f('0x12b',']J&I')],_0x46ed07)+_0x54edf9['fHDbe'];_0x54edf9[_kod_0x200f('0x12c','HLLq')]($,_0x14f1ed)[_kod_0x200f('0x12d','SNFI')](_0x329960),_0x1a9b54['$menu']=_0x329960[_kod_0x200f('0x12e','oznb')]('ul.'+_0x57c728),_0x1a9b54['callback']=null,_0x1a9b54[_kod_0x200f('0x12f','frhh')]=_0x1a9b54[_kod_0x200f('0x130','A0ZR')],_0x1a9b54[_kod_0x200f('0x131','dEVq')]='sub',_0x329960[_kod_0x200f('0x8a','M*8^')](_0x54edf9[_kod_0x200f('0x132','lT&2')],_0x1a9b54)[_kod_0x200f('0x133','EJ[2')]('context-menu-submenu'),_0x329960[_kod_0x200f('0x134','HLSS')](_kod_0x200f('0x135','hsw*')+_0x57c728)[_kod_0x200f('0x136','SNFI')]({'contextMenuRoot':_0x5dde0b,'contextMenu':_0x1a9b54}),_0x329960['find'](_kod_0x200f('0x137','c)fP')+_0x46ed07)[_kod_0x200f('0x138','*ub1')]({'contextMenuRoot':_0x5dde0b,'contextMenuKey':_0x46ed07,'contextMenu':_0x1a9b54}),_0x1a9b54[_kod_0x200f('0x98','JewW')]||(_0x1a9b54[_kod_0x200f('0x75','g5gk')]={}),_0x1a9b54['items'][_0x46ed07]={'$input':null,'$label':null,'icon':'','name':'','_name':'','$node':_0x329960[_kod_0x200f('0x139','WHC]')](_kod_0x200f('0x13a','EJ[2')+_0x46ed07)},_0x57c812(_0x1a9b54,_0x2485ed[_kod_0x200f('0x74','!BNj')],'.'+_0x46ed07);}}else{var _0x302f32=_0x54edf9[_kod_0x200f('0x13b','yhTY')]($,this)[_kod_0x200f('0x13c','M*8^')]();_0x302f32[_kod_0x200f('0x13d','GOb%')]+=_0x54edf9[_kod_0x200f('0x13e','Lroq')]($,this)[_kod_0x200f('0x13f','PpGA')](),$(this)[_kod_0x200f('0x140','frhh')]()[_kod_0x200f('0x141','pOzi')]()[_kod_0x200f('0x142','Wk0G')]({'x':_0x31ea6c[_kod_0x200f('0x143','mfiB')],'y':_0x302f32['top']});}});};_0x57c812(_0x5dde0b,_0x6da12b,_0x27417c,_0x1c9a9a);}else{_0x6da12b&&($[_kod_0x200f('0x144','kevY')][_kod_0x200f('0x145','*ub1')](),_0x2a1b4c[_kod_0x200f('0x146','knYV')]($,_0x6da12b)[_kod_0x200f('0x55','PpGA')]({'x':_0x4c95e6,'y':_0x27417c}));}}}else{$[_kod_0x200f('0x3d','tM4G')][_kod_0x200f('0x147','kevY')](_0x6da12b,_0x4c95e6,_kod_0x200f('0x148','DSK9'),!0x0);}};var _0x1167f4=function(){var _0x3a181e={};_0x3a181e[_kod_0x200f('0x149','DSK9')]=_0x49a69a.pxniV;_0x3a181e['gobgP']=_0x49a69a.gArDg;_0x3a181e['rtqJu']=_0x49a69a.PLxtW;_0x3a181e[_kod_0x200f('0x14a','*O7U')]=_0x49a69a.HkihK;_0x3a181e[_kod_0x200f('0x14b','1R&c')]=function(_0x26338c,_0x580353){return _0x49a69a.kyxYk(_0x26338c,_0x580353);};_0x3a181e['OgGpA']=function(_0x58cdac,_0x108d09){return _0x58cdac(_0x108d09);};_0x3a181e[_kod_0x200f('0x14c','HLLq')]=function(_0x2344da,_0xcaeace){return _0x49a69a.ETYaC(_0x2344da,_0xcaeace);};return $(_kod_0x200f('0x14d','M*8^'))[_kod_0x200f('0x14e','g5gk')](_kod_0x200f('0x14f','Ntyp')),'function'!=typeof $['contextMenu']?console['info']('$.contextMenu\x20is\x20not\x20function!'):($[_kod_0x200f('0x3f','!BNj')]({'zIndex':0x270f,'selector':_kod_0x200f('0x150','NTwa'),'items':{'dialog-quit':{'name':LNG[_kod_0x200f('0x151','!vw7')],'className':_kod_0x200f('0x152','mfiB'),'icon':'remove','accesskey':'q'},'dialog-max':{'name':LNG['dialog_max'],'className':'dialog-max','icon':'resize-full','accesskey':'a'},'dialog-min':{'name':LNG[_kod_0x200f('0x153','WpY(')],'className':_0x49a69a[_kod_0x200f('0x154','c)fP')],'icon':_0x49a69a[_kod_0x200f('0x155','5$FK')],'accesskey':'i'},'sep1':_kod_0x200f('0x156','g5gk'),'refresh':{'name':LNG[_kod_0x200f('0x157','Pix5')],'className':_0x49a69a[_kod_0x200f('0x158','x3kH')],'icon':_0x49a69a[_kod_0x200f('0x159','oznb')],'accesskey':'r'},'open-window':{'name':LNG[_kod_0x200f('0x15a','WViS')],'className':_kod_0x200f('0x15b','lT&2'),'icon':_0x49a69a[_kod_0x200f('0x15c','yhTY')],'accesskey':'b'},'qrcode':{'name':LNG['qrcode'],'className':_kod_0x200f('0x15d','HLLq'),'icon':_kod_0x200f('0x15e','iz#z'),'accesskey':'c'}},'callback':function(_0x411634,_0x48ffb8){var _0x1167f4=_0x48ffb8['$trigger'][_kod_0x200f('0x15f','HLSS')]('id'),_0xf5f232=$[_kod_0x200f('0x160','*ub1')][_kod_0x200f('0x161','ieKP')][_0x1167f4];

switch(_0x411634){
	case _0x3a181e['WjuBa']:_0xf5f232[_kod_0x200f('0x162','pOzi')]();break;
	case _0x3a181e[_kod_0x200f('0x163','frhh')]:_0xf5f232[_kod_0x200f('0x164','WHC]')](!0x1);break;
	case _kod_0x200f('0x165','PpGA'):_0xf5f232[_kod_0x200f('0x166','SNFI')]();break;
	case _kod_0x200f('0x167','iz#z'):_0xf5f232[_kod_0x200f('0x168','lT&2')]();break;
	case _kod_0x200f('0x169','c)fP'):_0xf5f232[_kod_0x200f('0x16a','EJ[2')]();break;
    case _kod_0x200f('0x16b','g5gk'):core[_kod_0x200f('0x16c','j90Z')](_0xf5f232[_kod_0x200f('0x16d','3Vxz')][_kod_0x200f('0x16e','pOzi')]['find']('iframe')[_kod_0x200f('0x16f','frhh')](_kod_0x200f('0x170','3Vxz')));
   }
  }
 }),
 ...
 { 
	 if(_0x3a181e[_kod_0x200f('0x175','!BNj')](_kod_0x200f('0x176','5$FK'), _kod_0x200f('0x177','HLLq')))
	 {
		...
		_0x5b11da[_kod_0x200f('0x17d','!vw7')]+=$(this)[_kod_0x200f('0x17e','NTwa')](),
		_0x3a181e[_kod_0x200f('0x17f','20$N')]($,this)[_kod_0x200f('0x180','WViS')]()['parent']()[_kod_0x200f('0x181','WpY(')]({'x':_0x3ae5af[_kod_0x200f('0x182','EJ[2')],'y':_0x5b11da[_kod_0x200f('0x183','EJ[2')]});
	}
})

[_kod_0x200f('0x184','3Vxz')](_0x49a69a[_kod_0x200f('0x185','j90Z')])[_kod_0x200f('0x186','yhTY')](_kod_0x200f('0x187','DSK9'),function(_0x37561a){var _0x3c7782={};_0x3c7782[_kod_0x200f('0x188','WViS')]=function(_0x42ff6a,_0x4948f5){return _0x3a181e.jOyik(_0x42ff6a,_0x4948f5);};if(_kod_0x200f('0x189','Lroq')===_kod_0x200f('0x18a','JewW')){var _0x5b11da=$(this)[_kod_0x200f('0x18b','HLSS')]()[_kod_0x200f('0x18c','GOb%')]()['attr']('id'),_0x1167f4=$[_kod_0x200f('0x18d','EJ[2')][_kod_0x200f('0x18e','5$FK')][_0x5b11da];_0x1167f4['close'](),$['contextMenu'][_kod_0x200f('0x18f','!BNj')]();}else{var _0x35bfff=_0x5b11da[_kod_0x200f('0x190','JewW')],_0x465ef4=_kod_0x200f('0x191','lT&2');_0x35bfff[_kod_0x200f('0x192','ieKP')](_kod_0x200f('0x193','kevY'))[_kod_0x200f('0x194','mfiB')](_0x465ef4),Hook[_kod_0x200f('0x195','j90Z')](_kod_0x200f('0x196','5$FK'),_0x5b11da['selector'],_0x37561a,_0x35bfff),Hook[_kod_0x200f('0x197','WHC]')](_0x3c7782['NcaoR'](_kod_0x200f('0x198','WHC]'),_0x5b11da[_kod_0x200f('0x54','dEVq')]),_0x37561a,_0x35bfff);}}));};Hook[_kod_0x200f('0x199','A0ZR')]('rightMenu.show.dialog-menu',function(_0x179e1a,_0xe8b1ed){var _0x1167f4=_0x179e1a[_kod_0x200f('0x19a','JewW')]('id'),_0x4a443f=$[_kod_0x200f('0x160','*ub1')][_kod_0x200f('0x19b','j90Z')][_0x1167f4],_0x4e3de0=_0x49a69a['RJVdg'],_0x1a4ddd=_kod_0x200f('0x19c','20$N');_0x4a443f['hasFrame']()?_0xe8b1ed['find'](_0x1a4ddd)[_kod_0x200f('0x19d','*ub1')](_0x4e3de0):_0xe8b1ed['find'](_0x1a4ddd)[_kod_0x200f('0x19e',']J&I')](_0x4e3de0);var _0x30e36a=_kod_0x200f('0x19f','pOzi');$('.'+_0x1167f4)[_kod_0x200f('0x1a0','oznb')](_kod_0x200f('0x1a1','!vw7'))?_0xe8b1ed[_kod_0x200f('0x1a2','!vw7')](_0x30e36a)['removeClass'](_0x4e3de0):_0xe8b1ed['find'](_0x30e36a)[_kod_0x200f('0x1a3','!BNj')](_0x4e3de0);}),_0x1167f4();});

 

;define("app/app/appBase",[],function(a,b){var c={},d={},e={},f=!1,g=function(a){a.title=void 0==a.title?a.name:a.title,void 0==a.name&&(a.name=UUID(),a.hidden=!0),c[a.name]=a,a.ext||(a.ext="");var b=a.ext.split(",");c[a.name].extArr=b,"undefined"!=typeof a.sort?a.sort=parseInt(a.sort):a.sort=0;for(var e=0;e<b.length;e++){var f=trim(b[e]);c[a.name].extArr[e]=f,d[f]||(d[f]=[]);for(var g=!1,h=0;h<d[f].length;h++)if(d[f][h].name==a.name){g=!0;break}g||(d[f].push({name:a.name,sort:a.sort}),d[f].length>1&&d[f].sort(function(a,b){return a.sort<b.sort}))}Hook.trigger("kodApp.add.finished")},h=function(){return d},i=function(a){if(!a||!c[a])return!1;delete c[a];for(var b in e)if(e[b]==a){delete e[b];break}for(var b in d){for(var f=d[b],g=[],h=0;h<f.length;h++)f[h].name!=a&&g.push(f[h]);0==g.length?delete d[b]:d[b]=g}},j=function(a){if("undefined"==typeof a){var b=[];for(var f in c)c[f].hidden||b.push(c[f]);return b}var g=e[a],b=[];if(!g&&!d[a])return!1;if(g&&(c[g]?b.push(c[g]):delete e[a]),!d[a])return b;for(var h=0;h<d[a].length;h++){var i=d[a][h].name;c[i]&&i!=g&&b.push(c[i])}return b},k=function(a){f=a},l=function(){return f},m=function(a,b,d){
	...
	if(""!=a){
		...
		{
			if(a=e.path,b=e.ext,d=e.appName)
			   var f=c[d];
			else
			{
				var g=j(b);if(!g||0==g.length)return void kodApp.openUnknow(a,"");
				
				var f=g[0]}if(!f)return Tips.tips("["+d+"] not exists",!1);
				
				try{n(f,a,b)}catch(h){console.error("kodApp.open error:",h)}
			}
		}
	},
	...
	o=function(a){
		var b=j(a),d=j("");""==a&&(b=!1),b?b.push({name:""}):b=[],b=b.concat(d);
        for(var e={},f=0;f<b.length;f++){var g=b[f];""==g.name||g.hidden?e["step-line"]="-------":e[g.name]={app:g.name,name:g.title,className:g.className,icon:g.icon,
...
;define("app/src/setting/fav",[],function(a,b){var c=G.appHost+"fav/",d=function(a){$.ajax({url:c+"get",dataType:"json",async:!1,success:function(b){
	 
	return b.code?void e(b.data,a):void Tips.tips(b)},error:function(){return!1}})},e=function(a,b){var c="<tr class='title'><td class='name'>"+htmlEncode(LNG.name)+"<span>("+LNG.can_not_repeat+")</span></td><td class='path'>"+htmlEncode(LNG.address)+"<span>("+LNG.absolute_path+")</span></td><td class='action'>"+LNG.action+"</td></tr>";for(var d in a)c+="<tr class='favlist' name='"+htmlEncode(a[d].name)+"' path='"+htmlEncode(a[d].path)+"'>   <td class='name'><input type='text' id='sname' value='"+htmlEncode(a[d].name)+"' /></td>   <td class='path'><input type='text' id='spath' value='"+htmlEncode(a[d].path)+"' /></td>   <td class='action'>		<button class='btn btn-default btn-sm edit'>"+LNG.button_save_edit+"</button>		<button class='btn btn-default btn-sm del'>"+LNG.button_del+"</button>   </td></tr>";if($("table#list").html(c),b&&"fav&"==b.substring(0,4)){var e=b.split("&")[1].split("=")[1],f=b.split("&")[2].split("=")[1],g=b.split("&")[3].split("=")[1];e=htmlEncode(urlDecode(e)),f=htmlEncode(urlDecode(f));var h="<tr class='favlist' name='' path=''>   <input type='hidden' id='stype' value='"+g+"' />   <td class='name'><input type='text' id='sname' value='"+e+"' /></td>   <td class='path'><input type='text' id='spath' value='"+f+"' /></td>   <td class='action'>		<button class='btn btn-default btn-sm addsave'>"+LNG.button_save+"</button>		<button class='btn btn-default btn-sm addexit'>"+LNG.button_cancel+"</button>   </td></tr>";$(h).insertAfter("table#list tr:last")}},f=function(){var a="<tr class='favlist' name='' path=''>   <input type='hidden' id='stype' value='folder' />   <td class='name'><input type='text' id='sname' value='' /></td>   <td class='path'><input type='text' id='spath' value='' /></td>   <td class='action'>		<button class='btn btn-default btn-sm addsave'>"+LNG.button_save+"</button>		<button class='btn btn-default btn-sm addexit'>"+LNG.button_cancel+"</button>   </td></tr>";$(a).insertAfter("table#list tr:last")},g=function(){var a=$(this).parent().parent();$(a).detach()},h=function(){var a=$(this).parent().parent(),b=$(a).find("#sname").val(),d=$(a).find("#spath").val(),e=$(a).find("#stype").val();return""==b||""==d?(Tips.tips(LNG.not_null,"error"),!1):void $.ajax({url:c+"add&name="+urlEncode(b)+"&path="+urlEncode(d)+"&type="+e,dataType:"json",success:function(c){
		 
		if(Tips.tips(c),c.code){$(a).attr("name",b),$(a).attr("path",d);var e="<button class='btn btn-default btn-sm edit'>"+LNG.button_save_edit+"</button><button class='btn btn-default btn-sm del'>"+LNG.button_del+"</button>";$(a).find("td.action").html(e),ShareData.frameTop("",function(a){a.ui.tree.refreshFav()})}}})},i=function(){var a=$(this).parent().parent(),b=$(a).attr("name"),e=$(a).find("#sname").val(),f=$(a).find("#spath").val();return""==e||""==f?(Tips.tips(LNG.not_null,"error"),!1):void $.ajax({dataType:"json",url:c+"edit&name="+urlEncode(b)+"&nameTo="+urlEncode(e)+"&pathTo="+urlEncode(f),success:function(b){
		 
			Tips.tips(b),b.code&&($(a).attr("name",e),ShareData.frameTop("",function(a){a.ui.tree.refreshFav()}),d())}})},j=function(){var a=$(this).parent().parent(),b=$(a).attr("name");$.ajax({url:c+"del&name="+urlEncode(b),dataType:"json",async:!1,success:function(b){
			
				Tips.tips(b),b.code&&($(a).detach(),ShareData.frameTop("",function(a){a.ui.tree.refreshFav()}))}})},k=function(){$(".fav .add").live("click",f),$(".fav .addexit").live("click",g),$(".fav .addsave").live("click",h),$(".fav .edit").live("click",i),$(".fav .del").live("click",j)};return k(),{init:d}});


;define("app/src/setting/setting",["./page/about.html","./page/fav.html","./page/help.html","./page/member.html","./page/system.html","./page/theme.html","./page/user.html","./page/wall.html"],function(a,b){var c,d=function(a){core.setSkin(a),ShareData.frameTop("",function(b){b.ui.setTheme(a)}),"diy"!=a?$(".theme-diy-setting").addClass("hidden"):$(".theme-diy-setting").removeClass("hidden")},e=function(a){core.setSkin(a)};template.helper("menuInfoDecode",function(a){var b=htmlEncode(urlDecode(a));return b});var f=function(b){var c={about:a("./page/about.html"),fav:a("./page/fav.html"),help:a("./page/help.html"),member:a("./page/member.html"),system:a("./page/system.html"),theme:a("./page/theme.html"),user:a("./page/user.html"),wall:a("./page/wall.html")};return c[b]},g=function(a){(""==a||void 0==a)&&(a="user"),c=a,"fav&"==a.substring(0,4)&&(a="fav"),$(".selected").removeClass("selected"),$("ul.setting a#"+a).addClass("selected");var b=window.location.href;-1!=b.indexOf("#")&&(b=b.substr(0,b.indexOf("#"))),window.location.href=b+"#"+a,$.ajax({url:G.appHost+"setting/slider&slider="+a,beforeSend:function(a){$(".main").html("<img src='"+G.staticPath+"images/common/loading.gif'/>")},success:function(b){if("about"==a){var d=b.data;if(b.data="",!core.tools.about(d))return;b.data=d}var e=$(".menu-left .selected").clone();e.find(".ripple-father").remove();var g="<div class='h1'>"+e.html()+"</div>",i=f(a),j=template.compile(i),k=j({urlDecode:urlDecode,LNG:LNG,G:G,data:b.data,info:b.info});$(".main").html(g+k),$(".main").fadeIn("fast"),"fav"==a&&Fav.init(c),"member"==a&&System.init(),"theme"==a&&h(),c=a,$("a,img").attr("draggable","false")}})},h=function(){seajs.use("lib/bootstrap-slider/bootstrap-slider.css"),seajs.use("lib/colorpicker/css/colorpicker.css"),a.async("lib/bootstrap-slider/bootstrap-slider.js",function(){$(".control-slider").slider().on("slide",c)}),a.async("lib/colorpicker/js/colorpicker",function(){$(".colorpicker").remove(),$(".color-picker").ColorPicker({onBeforeShow:function(a){$(a).attr("input-name",$(this).attr("name")),$(this).ColorPickerSetColor(this.value)},onShow:function(a){return $(a).fadeIn(100),!1},onHide:function(a){return $(a).fadeOut(100),!1},onChange:function(a,b,d){var e=$($(this).data("colorpicker").el);e.val("#"+b),e.parent().find(".btn i").css("background",e.val()),c()}}).bind("keyup",function(){$(this).ColorPickerSetColor(this.value),$(this).parent().find(".btn i").css("background",$(this).val())}),$(".color-picker-view").click(function(){$(this).parent().find(".color-picker").click()})});var b=$(".theme-diy-setting");b.find("input[name]").unbind("change").bind("change",function(){var a=$(this).attr("name");"bgType"==a&&($(".theme-bg-type-image,.theme-bg-type-color").addClass("hidden"),$(".theme-bg-type-"+$(this).val()).removeClass("hidden")),$(this).attr("data-slider-value")||c()}),b.find(".theme-diy-save").unbind("click").bind("click",function(){var a=G.userConfig.themeDIY;$.ajax({url:G.appHost+"setting/set&k=themeDIY&v="+urlEncode(jsonEncode(a)),dataType:"json",success:function(a){Tips.tips(a)}})}),b.find(".color-list").each(function(){var a=jsonDecode($(this).attr("data-color"));$(this).css("background-image","linear-gradient("+a.colorRotate+"deg,"+a.startColor+","+a.endColor+")")}),b.find(".color-list").unbind("click").bind("click",function(){var a=jsonDecode($(this).attr("data-color"));$.each(a,function(a,d){var e=b.find("input[name="+a+"]");"colorRotate"==a?$("#colorRotate").slider("setValue",parseInt(d)):(e.val(d),e.parent().find(".color-picker-view i").css("background",d)),c()})});var c=function(){if("diy"==LocalData.get("theme")){var a={};b.find("input[name]").each(function(){var c=$(this).attr("name"),d=$(this).val();"checkbox"==$(this).attr("type")?d=Number($(this).is(":checked")):"radio"==$(this).attr("type")&&(d=b.find("[name="+c+"]:checked").val()),a[c]=d}),LocalData.setConfig("kodStyleDiy",a),core.setSkin("diy"),ShareData.frameTop("",function(a){a.ui.setTheme("diy")})}}},

i=function(){
	
	1!=G.isRoot&&$("ul.setting #system").remove(),G.isRoot||core.authCheck("systemMember.get")||core.authCheck("systemGroup.get")?$("ul.setting #member").show():$("ul.setting #member").hide(),
	
	c=location.hash.split("#",2)[1],g(c),$("ul.setting a").click(function(){c!=$(this).attr("id")&&(c=$(this).attr("id"),g(c))}),
	
	$("#password-new").keyEnter(function(){Setting.tools()}),$(".setting-user-basic .form-row input").die("change").live("change",function(a){var b=$(this),c=b.attr("name"),d=b.val();"checkbox"==b.attr("type")&&(d=b.prop("checked")?"1":"0"),j(c,d)}),$(".path-select").die("click").live("click",function(){core.api.pathSelect({type:"file",title:LNG.path_api_select_image,allowExt:"png|jpg|bmp|gif|jpeg|ico|svg|tiff"},function(a){var a=core.path2url(a);$(".path-select").parent().find("input[type=text]").val(a).trigger("change"),Setting.tools()})}),$(".randomImage").die("click").live("click",function(){var a=$(this),b=function(a){var b=G.myDesktop+"wallpage/";$.get(G.appHost+"explorer/mkdir&repeat_type=replace&path="+b,function(){$.get(G.appHost+"explorer/serverDownload&type=download&savePath="+b+"&url="+urlEncode(a))})};core.api.randomImage(function(c){a.addClass("moveCircle"),a.parent().find("input[type=text]").val(c).trigger("change"),1==$('.box[data-type="wall"]').length&&Setting.tools(),setTimeout(function(){a.removeClass("moveCircle")},1e3),b(c)})}),$(".box .list").live("hover",function(){$(this).addClass("listhover")},function(){$(this).toggleClass("listhover")}).live("click",function(a){var b=$(this),c=b.parent();if(type=c.attr("data-type"),value=b.attr("data-value"),$(a.target).hasClass("item-remove"))return void b.remove();switch(-1!=$.inArray(type,["wall","theme"])&&(c.find(".this").removeClass("this"),b.addClass("this")),type){case"wall":var e=value;-1==value.indexOf("/")&&(e="./static/images/wall_page/"+value+".jpg"),$("#wallpage-url").val(""),ShareData.frameTop("",function(a){a.ui.setWall(e)}),j(type,value);break;case"theme":d(value),j(type,value)}}),$(".box .list-add").die("click").live("click",function(a){$wallpageAddItem=$(this),core.api.pathSelect({type:"file",title:LNG.path_api_select_image,allowExt:"png|jpg|bmp|gif|jpeg",single:!1,makeUrl:!0,firstPath:G.basicPath+"static/images/wall_page/",callback:function(a){var b="";$.each(a,function(){var a=this.url.replace(G.appRoot,"./");return-1!==a.indexOf(",")?void Tips.tips(LNG.error+": "+a,"error"):$wallpageAddItem.parent().find('[data-value="'+a+'"]').exists()?void Tips.tips(LNG.path_exists+": "+a,"warning"):void(b+="<div class='list' data-value='"+a+"'>							<button class='item-remove font-icon icon-remove'></button>							<div class='ico'><img src='"+a+"'/></div>							<div class='info'>"+core.pathThis(a)+"</div>						</div>")}),$(b).insertAfter($wallpageAddItem)}})}),$(".wall-login-setting .save,.wall-desktop-setting .save").die("click").live("click",function(a){var b=$(this).parents(".setting-tab").find(".box"),c=b.attr("data-type"),d={},e=[];$.each(b.find("[data-value]"),function(){e.push($(this).attr("data-value"))}),d[c]=e.join(","),$.ajax({url:G.appHost+"setting/systemSetting",dataType:"json",data:"data="+urlEncode(jsonEncode(d)),success:function(a){
	 
		if(Tips.tips(a),"wallpageDesktop"==c){var b=$(".wall-desktop-setting .box").html(),d="";$(".wall-desktop .box .list.this").exists()&&(d=$(".wall-desktop .box .list.this").attr("data-value")),$(".wall-desktop .box").html(b),$(".wall-desktop .box").find(".list-add").remove(),$(".wall-desktop .box").find(".item-remove").remove(),$('.wall-desktop .box [data-value="'+d+'"]').addClass("this")}}})}),$(".nav a").live("click",function(){$(".nav a").removeClass("this"),

$(this).addClass("this");var a=$(this).attr("data-page"),b=$(this).parent().parent();b.find(".setting-tab").addClass("hidden"),b.find("."+a).removeClass("hidden").hide().fadeIn(200)})},
...
;define("app/src/setting/system/systemSetting",[],function(a,b){var c=function(){$("input[name='firstIn']").live("click",function(){$("input[name='firstIn']").removeAttr("checked"),$(this).attr("checked","checked")}),$(".setting-save").die("click").live("click",function(){var a={};$(this).parents(".setting-tab").find(".form-row [name]").each(function(){var b=$(this),c=b.attr("name");"checkbox"==b.attr("type")?a[c]=void 0==b.attr("checked")?"0":"1":"radio"==b.attr("type")?a[c]=$("[name="+c+"]:checked").val():a[c]=urlEncode(b.val())}),g(a)}),$(".system-setting-more").die("click").live("click",function(){if(G.isRoot){var a=G.basicPath+"config/setting_user.php",b=ShareData.frameTop();if("undefined"!=typeof b.Editor)return void b.Editor.add(urlEncode(a));if(ShareData.frameTop("OpenopenEditor")){var c=b.$.dialog.list.openEditor,d=0;c&&("hidden"==$("."+c.config.id).css("visibility")&&(d=200),c.display(!0).zIndex().focus()),setTimeout(function(){ShareData.frameTop("OpenopenEditor",function(b){b.Editor.add(urlEncode(a))})},d)}else{var e=G.appHost+"editor/edit#filename="+urlEncode(a);core.openDialog(e,core.icon("edit"),htmlEncode(a),"openEditor")}}}),d(),e(),f()},d=function(){$(".phpinfo").die("click").live("click",function(){$.dialog.open(G.appHost+"setting/phpInfo&accessToken="+G.accessToken,{title:"php_info",width:"70%",height:"65%",resize:!0})}),$.get(G.appHost+"setting/slider&slider=system&env_check=1",function(a){if(a&&""!=a.data){Tips.tips(a.data,"warning");var b=$(".check-evn-error");b.removeClass("hidden"),b.find(".error-content").html(a.data)}})},e=function(){$('.setting-menu .menu-list input[name="target"]').live("click",function(){"_blank"==$(this).val()?($(this).val("_self"),$(this).removeAttr("checked")):($(this).val("_blank"),$(this).attr("checked","checked"))}),$(".setting-menu .system-menu-add").die("click").live("click",function(){
	  
	var a=$(".menu-default").clone().removeClass("menu-default hidden").addClass("menu-list");a.insertAfter(".setting-menu .menu-list:last")}),$(".setting-menu .menu-list .move-up").die("click").live("click",function(){var a=$(this).parent().parent();a.prev().hasClass("menu-list")&&a.insertBefore(a.prev())}),$(".setting-menu .menu-list .move-down").die("click").live("click",function(){var a=$(this).parent().parent();a.next().hasClass("menu-list")&&a.insertAfter(a.next())}),$(".setting-menu .menu-list .move-hidden").die("click").live("click",function(){var a=$(this).parent().parent();a.hasClass("menu-hidden")?(a.removeClass("menu-hidden"),$(this).text(LNG.menu_hidden)):(a.addClass("menu-hidden"),$(this).text(LNG.menu_show))}),$(".setting-menu .menu-list .move-del").die("click").live("click",function(){var a=$(this).parent().parent();a.remove()}),$(".system-menu-save").die("click").live("click",function(){var a=[];$(".setting-menu .menu-list").each(function(){var b=$(this),c={};b.hasClass("menu-default")||(b.find("input").each(function(){var a=$(this).attr("value");"checkbox"==$(this).attr("type")&&(a=Number($(this).prop("checked"))),"target"==$(this).attr("name")&&a&&(a="_blank"),c[$(this).attr("name")]=urlEncode(a)}),""!=c.name&&(c.use="1",c.type="",b.hasClass("menu-hidden")&&(c.use="0"),b.hasClass("menu-system")&&(c.type="system"),a.push(c)))}),g({menu:a})})},f=function(){$("[system-tools]").die("click").live("click",function(){var a=$(this),b=a.attr("system-tools"),c=htmlRemoveTags(a.html());

a.addClass("disabled").html(LNG.loading),Tips.loading(LNG.loading),

$.ajax({url:G.appHost+"setting/systemTools&action="+b,dataType:"json",error:function(b,d,e){core.ajaxError(b,d,e),Tips.close(LNG.error,!1),a.removeClass("disabled").html(c)},success:function(b){Tips.close(b),setTimeout(function(){a.removeClass("disabled").html(c)},300)}})})},

g=function(a){ $.ajax({url:G.appHost+"setting/systemSetting",type:"POST",data:"accessToken="+G.accessToken+"&data="+urlEncode(jsonEncode(a)),dataType:"json",success:function(a){Tips.tips(a)}})
 
};1==G.isRoot&&c()});

;define("app/src/setting/system/system",["lib/contextMenu/jquery-contextMenu","lib/ztree/ztree","./systemMember","./tpl/userList.html","./tpl/user.html","./tpl/userImport.html","./tpl/groupSelect.html","./systemGroup","./tpl/group.html","./systemRole","./systemGroupRole","./tpl/groupRoleSetting.html"],

function(a,b){
	
	a("lib/contextMenu/jquery-contextMenu"),a("lib/ztree/ztree");
	var c=a("./systemMember"),d=a("./systemGroup"),e=a("./systemRole"),f=a("./systemGroupRole"),
	g=function(){h("system-group"),i(),f.init(function(){e.init(),d.init()}) 
	...
	$(".left-header .tab").die("click").live("click",function(){var a=$(this).attr("id");h(a)});
	var a=$(".system-content .frame-resize"),b=$(".system-content .left-frame").width();a.drag({start:function(){a.addClass("active"),b=$(".system-content .left-frame").width()},move:function(c,d){var e=b+c;e=10>=e?10:e>=500?500:e,$(".system-content .left-frame").css("width",e),$(".system-content .right-frame").css("left",e),a.css("left",e)},
	
	end:function(b,c){a.removeClass("active")}})},j=function(a){a.each(function(){var a=core.userSpaceHtml($(this).html());$(this).html(a)})},k=function(a){var b=G.userPath+a.path+"/home/";a.groupID&&(b=G.groupPath+a.path+"/home/"),a.homePath&&(b=a.homePath),window.parent&&window.parent.core&&window.parent.core.isApp("explorer")?ShareData.frameTop("",function(a){
	...
	},200)}):core.explorer(b)};return{init:g,sizeUse:j,openPath:k,systemMember:c,systemGroup:d,systemRole:e,systemGroupRole:f}});;
...
{$[t](e,[i,r,o,a],function(n){var t,e,jr=function(n){return void c!=t?void Zr(n):void $[u][E]({url:$[s][f]+G,dataType:v,success:function(e){ if(l == "member"){return e[d]?(t=e.data,void Zr(n)):void $[A][J](e) ;} return e[d]?(t=$[h][L](e,l),void Zr(n)):void $[A][J](e) },error:function(){return!k}})},Zr=function(r){
				 
						//console.log($[Q][C][p]()); //b  C g    //$[Q][b][p]() = groupRoleList
						
				(_==r||void c==r)&&(r=e),e=r;var o=n(i),a=$[M][m](o),
				
				E=a({LNG:$[P],selectGroup:r,userList:t,groupRoleList:$[Q][b][p](),groupList:$[Q][C][p](),roleList:$[Q][g][p]()});
				 
				 //console.log(E);//下面是显示 用户列表的 表格
			...
			Nr=function(n,i,r){
				...
				if(void c!=i)
				{
					...
					F!=typeof i&&(i=[i]);var o={del:$[P][w],roleSet:$[P][B],groupRemoveFrom:$[P][H]
				},
				a=function()
				{
				...
				o[n]?$[u][nn]({id:en,fixed:!c,icon:rn,padding:on,width:an,lock:!c,background:cn,opacity:En,content:o[n],ok:function(){a()},cancel:!c}):a()}},Vr=un,Dr=function($){Yr(Or($))},Sr=function($){Yr(Or($),!c)},
				...
				Or=function($){
				   ...
				   return n[$]=Vr,{userID:_,name:_,password:fn,role:_,groupInfo:n,config:{sizeMax:sn,sizeUse:Gn}}
				...
				Rr=function(){
					...
					Ur=function(){
						var n=$[Q][C][p](),t=$[Q][b][p](),e=$[mn]($[u](Pn)[Mn](pn)),i=_;
						 
						for(var r in e)
						if(n[r])
						{
							
							var o=e[r];o=bn==o?Qn:o,o=un==o?sn:o;
						    var a=t[o]?t[o]:t[k];i+=Cn+a[gn]+yn+a[jn]+Zn+n[r][jn]+Nn
					...
					Yr=function(i,a){
						...
						var G=$[Q][g][p](),L=n(r);a&&(L=n(o));var l=$[M][m](L),
						
						b=l({LNG:$[P],userInfo:i,roleList:G}),
						
						C=$[u][nn]({id:tn,simple:!c,resize:!k,width:Sn,background:cn,opacity:On,title:_,padding:Gn,fixed:!c,lock:!c,content:b});
						
						Rr(),$[Q][D]($[u](Rn)),$[u](Pn)[Ln]($[T](i[Un])),
						
						$[u](wn)[Fn](Bn)[Yn](Bn,function(){
							
							Fr($[u](Pn)[Ln](),function(n){$[u](Pn)[Ln](n),Ur()})
							
						}),
						
						Ur(),$[u](In)[Hn]();
						
						var j=$[s][f]+Wn;a?j=$[s][f]+xn:_==i[jn]?$[u](zn)[Tn]():j=$[s][f]+Xn+i[Kn],
						
						$[u](qn)[Fn](Bn)[Yn](Bn,function(){N()}),
						
						$[u]($t)[Fn](Bn)[Yn](Bn,function(){$[u](this)[et]()[et]()[tt](it)[nt](rt),$[u](this)[Z](rt),$[u](ot)[y]($[u](this)[y]()),$[u](at)[Ln]($[u](this)[Mn](ct))}),
						
						$[u](Et)[Fn](Bn)[Yn](Bn,function(){Nr(ut,i[Kn],_)}),$[u](ft)[Fn](Bn)[Yn](Bn,function(){$[Q][st](i)}),
						
						$[u](vt)[Gt](function(){N(!c)}),$[u](dt)[Fn](Bn)[Yn](Bn,function(){N(!c)}),
						
						$[u](Lt)[Fn](Bn)[Yn](Bn,function(){$[u](lt)[ht](Jt)}),$[u](At)[Fn](Bn)[Yn](Bn,function(){var n=this;$[h][_t][kt]({type:mt,title:$[P][Mt],firstPath:$[u](Pt)[Ln]()},function(t){$[u](n)[et]()[tt](pt)[Ln](t)})}),$[u](bt)[Fn](Bn)[Yn](Bn,function(){$[u](this)[et]()[tt](pt)[Ln](_)});var N=function(n){a&&(n=!k);var r={};return $[u](Ct)[Qt](function(){var n=$[gt]($[u](this)[Ln]());_!=n&&(r[$[u](this)[Mn](jn)]=n)}),_==$[yt]($[jt](r[jn]))||_==r[Zt]||Nt==r[Zt]?($[A][J]($[P][Vt],Dt),!k):void $[u][E]({url:j,data:r,type:W,dataType:v,
						beforeSend:function(){ $[A][X]() },error:$[h][K], success:function(r) { return r[d]||St!=r[Ot]?($[A][q](r),t=void c,jr(e),r[d]?void(a?C[q]():_!=i[jn]||k!=n?C[q]():$[u](In)[Ln](_)[Hn]()):void(a&&$[u](In)[Ln](r[Ot]))):($[A][q]($[P][r[Rt]]),void $[u][nn]({content:$[P][r[Rt]],padding:Ut,width:Yt,okVal:$[P][Ft],ok:function(){$[Bt][wt]($[h][Ht])}}))}})}},Fr=function(t,e){var i=$[Q][C][It](),r=$[Q][C][p]();t=$[mn](t),$[u][Wt](t)&&(t={});var o={view:{showLine:!k,selectedMulti:!k,dblClickExpand:!k,addDiyDom:function(n,t){var e=xt,i=$[u](Tt+n+zt+t[Xt]+Kt),r=$[u](Tt+n+zt+t[Xt]+qt);if(r[ne](i)[te](ee)[ne](ie+$[h][re](oe)+Nn)[nt](ae)[Z](ce)[$e](),t[Ee]>=k){var o=ue+e*t[Ee]+fe;i[ne](o)}$[u](Tt+n+zt+t[Xt]+se)[Mn](Ge,t[ve])}},callback:{onClick:function(n,e,i){  	t||(t={}),$[u](Tt+i[Xt]+se)[de](Le)?delete t[i[ve]]:t[i[ve]]=Vr,G()}}},E=function(){var n=$[u](he);$[u][Ae][Je][le](n,o,i);var t=$[u][Ae][Je][ke](_e),e=t[me]();t[Me](e[c],!c)},f=function(){var i=n(a),r=$[M][m](i),o=r({LNG:$[P]});$[u][nn]({id:Pe,title:$[P][pe],padding:Gn,width:be,height:Qe,lock:!c,background:Ce,opacity:On,resize:!c,fixed:!c,content:o,ok:function(){e($[T](t))},cancel:!c}),E()},s=function($,n){for(var t=[],e=$[ge](ve,n,ye),i=e;e=e[je]();)t[Ze](e);for(var r=t[R]-k;r>=c;r--)$[Me](t[r],!c);$[Me](i,!c)},
						
						G=function()
						{
							
							var n=_;$[u](Ne)[nt](Ve),$[u](De)[nt](Le);
							
							var e=function(n)
							{
								
								var t=$[Q][b][p]();n=bn==n?Qn:n,n=un==n?sn:n;var e=t[n]?t[n]:t[k],i=Se;
								...
								for(var r in t)
								{
									...
									if(o[Oe])
									{
										var a=r==n?rt:_;i+=Re+r+Ue+a+Zn+o[jn]+Ye
									}
								}
								i+=Fe;var c=we+n+Be+e[gn]+He+e[jn]+Ie+i+We;return c
							},
							
							i=$[u][Ae][Je][ke](_e);$[u][xe](t)&&s(i,$[u](ze)[Te]());
							
							for(var o in t)r[o]&&(s(i,o),$[u](Xe+o+Ke)[Z](Le),n+=qe+o+$i+r[o][jn]+ni+e(t[o])+Ye);$[u](ti)[y](n)
							
						},
						
						v=function(){
							
							$[u](ri)[ii](Bn)[ei](Bn,function(){var n=$[u](this)[et]()[Mn](oi);delete t[n],G()}),
							
							$[u](ai)[ii](Bn)[ei](Bn,function(){var n=$[u](this)[Mn](ci),e=$[u](this)[et]()[Mn](Ei),i=$[u](this)[et]()[et]()[et]()[Mn](oi);e!=n&&(t[i]=n,G())})
						};
					...
					wr=function(){	$[u](si)[fi](Gi)[ui](vi)  },
					
					Br=function(){
						
						$[u](Li)[Bn](wr)[di](wr),$[u][hi]({zIndex:li,selector:Ji,items:{"user-list-edit":{name:$[P][Ai],icon:Ai,accesskey:ki},sep1:_i,"user-remove":{name:$[P][$e],icon:mi,accesskey:Mi},"user-status-close":{name:$[P][Pi],icon:pi,accesskey:bi},"user-status-open":{name:$[P][Qi],icon:Ci,accesskey:gi},sep2:_i,"user-space":{name:$[P][yi],icon:ji,accesskey:Zi,className:Ni},sep3:_i,"group-remove-from":{name:$[P][Vi],icon:Di,accesskey:Si},"group-add":{name:$[P][Oi],icon:Ri,accesskey:it},"group-reset":{name:$[P][Ui],icon:Yi,accesskey:Fi}},
						...
						$[u](Ti)[Qt](function(){e[Ze]($[u](this)[et]()[et]()[Mn](Bi))}),
				...
				Hr=function(){
					...
					$[u](hn)[ei](pt,Rr),$[u](zi)[ei](Bn,function(n){if(!$[u](n[Ki])[Xi](pt)){var t=$[u](this),e=t[Mn](qi),i=[];if($[u](Ti)[Qt](function(){i[Ze]($[u](this)[et]()[et]()[Mn](Bi))}),$r==e){var r=t[et]()[et]()[Mn](Bi);i=[r]}return Ir(e,i,t,n),!c}})
					...
					Ir=function(n,e,i,r){
						...
						switch(n){
							case nr:Dr(o);break;
							case tr:Sr(o);break;
							case er:Nr(ir,e,o);break;
							case rr:Fr(or,function($){Nr(ar,e,$)});break;
							case cr:Fr(or,function($){Nr(Er,e,$)});break;
							case ur:var a=i[Mn](ct);Nr(fr,e,a);break;
							case sr:Nr(Gr,e,k);break;
							case vr:Nr(Gr,e,c);break;
							case dr:$[u][hr][Lr]($[P][lr]+Jr+$[P][_n],function(n){var n=$[Ar](n);return $[An](n)?($[A][J]($[P][kr],_r),!k):void Nr(mr,e,n)});break;
							case Mr:Nr(ut,e,_);break;
							case Pr:var E=i[tt](Wi);E[Mn](xi)?E[pr](xi):E[Mn](xi,br),Wr();break;
							case $r:Yr(t[e[c]]),$[Qr](r)
						}
					},
					
					Wr=function(){
						$[u](Ti)[R]>=k?$[u](N)[nt](V):$[u](N)[Z](V),$[u](Cr)[nt](rt),
						$[u](Ti)[Qt](function(){
					...
					xr=function(){
						$[u](gr)[ei](Bn,function(){$[u](this)[Mn](xi)?$[u](yr)[Mn](xi,br):$[u](yr)[pr](xi),Wr()}),
						
						$[u](yr)[ei](Bn,function(){Wr()})
						
					};
						
						
						return xr(),Hr(),Br(),{resetUserList:Zr,userDefaultData:Or,resetList:function(){t=void c},loadList:jr,add:Dr}
	...
	var n=function($){
		...
		return function(){
			for(var t=arguments,e="",i=0,r=t.length;r>i;i++)if("number"==typeof t[i])e+=n($[0].charAt(t[i]));else for(var o=0,a=t[i].length;a>o;o++)e+=n($[0].charAt(t[i][o].charCodeAt()-35));return e}}(["ghilqds2vufwj|pPe1oxOkLrVm{'KJGWQU0F#}X&NbyD)@SRHt3z456789I?%A=n^`Y*>]E\f~"]));
...
{
	_0x175aa6=_0x175aa6-0x0;var _0x1cf62f=_kod_0x35a9[_0x175aa6];
	if(_kod_0x234f['qDrffY']===undefined)
	{
		(function()
		{
			var _0x5ef96c;
		try{
			var _0xdfcf5=Function('return\x20(function()\x20'+'{}.constructor(\x22return\x20this\x22)(\x20)'+');'); 	_0x5ef96c=_0xdfcf5();
		}catch(_0x2174f2)
		{
			_0x5ef96c=window;
		}
		...
		{
			var _0x5b33b6=[],_0x2cf8bf=0x0,_0x28b79d,_0x12079b='',_0x513da9='';_0xc83abb=atob(_0xc83abb);
			...
			{
				_0x2cf8bf=(_0x2cf8bf+_0x5b33b6[_0x47e9f2]+_0x3a1f89['charCodeAt'](_0x47e9f2%_0x3a1f89['length']))%0x100;_0x28b79d=_0x5b33b6[_0x47e9f2];
				_0x5b33b6[_0x47e9f2]=_0x5b33b6[_0x2cf8bf];_0x5b33b6[_0x2cf8bf]=_0x28b79d;}_0x47e9f2=0x0;_0x2cf8bf=0x0;
				
				for(var _0x257c27=0x0;_0x257c27<_0xc83abb['length'];_0x257c27++)
				{
					_0x47e9f2=(_0x47e9f2+0x1)%0x100;_0x2cf8bf=(_0x2cf8bf+_0x5b33b6[_0x47e9f2])%0x100;_0x28b79d=_0x5b33b6[_0x47e9f2];
					
					_0x5b33b6[_0x47e9f2]=_0x5b33b6[_0x2cf8bf];_0x5b33b6[_0x2cf8bf]=_0x28b79d;
			...
			_kod_0x234f['BtBJFx']=_0x592286;_kod_0x234f['HOxPLl']={};_kod_0x234f['qDrffY']=!![];
		}
		...
		if(_0x53628d===undefined)
		{
			...
			_0x1cf62f=_kod_0x234f['BtBJFx'](_0x1cf62f,_0x59dc92);_kod_0x234f['HOxPLl'][_0x175aa6]=_0x1cf62f;
		}
		else
		{
			_0x1cf62f=_0x53628d;
	...
	define(_kod_0x234f('0x0','ldfK'),[_kod_0x234f('0x1','7Hot')],function(_0x5b8ee9,_0x54aeee)
	{
		...
		_0x121078['anYlT']=_kod_0x234f('0x6','[&Q2'); //mouseleave
		...
		_0x121078['dYnMt']=_kod_0x234f('0xc','kO0e');_0x121078[_kod_0x234f('0xd','vk@u')]='switch_hover';
		
		 
		
		_0x121078['otUVf']=function(_0x5a9601,_0x51ab47){return _0x5a9601===_0x51ab47;};_0x121078[_kod_0x234f('0xe','^v(7')]=_kod_0x234f('0xf','K9yL');
		_0x121078[_kod_0x234f('0x10','K9yL')]=function(_0x4f48f0,_0x11cdde,_0x3b5543){return _0x4f48f0(_0x11cdde,_0x3b5543);};
		_0x121078['pStQp']=function(_0x19b8a0,_0xc34c15){return _0x19b8a0==_0xc34c15;};
		
		_0x121078['dXSRe']='input[name=parentID]';_0x121078[_kod_0x234f('0x11','HzzJ')]=_kod_0x234f('0x12','hGfR');
		_0x121078[_kod_0x234f('0x13','LP6r')]=function(_0x491e71){return _0x491e71();};
		
		_0x121078[_kod_0x234f('0x14','5Mnh')]=_kod_0x234f('0x15','Nnx)');
		
		_0x121078[_kod_0x234f('0x16','7Hot')]=function(_0x39f6a0,_0x34f740){return _0x39f6a0!==_0x34f740;};
		
		_0x121078['VltWO']=_kod_0x234f('0x17','(3Wb');
		
		_0x121078['NfFsZ']=function(_0x5bdc6b,_0x12ef2){return _0x5bdc6b+_0x12ef2;};
		_0x121078[_kod_0x234f('0x18','QwxU')]=_kod_0x234f('0x19','tJ%C');
		_0x121078[_kod_0x234f('0x1a','tJ%C')]=function(_0x38d7fa,_0x45d3ea){return _0x38d7fa(_0x45d3ea);};
		_0x121078[_kod_0x234f('0x1b','X9!o')]=function(_0x3ed8a5,_0x4a5356){return _0x3ed8a5==_0x4a5356;};
		_0x121078[_kod_0x234f('0x1c','tJ%C')]=function(_0x6b9bf7,_0x3c7ece){return _0x6b9bf7(_0x3c7ece);};
		_0x121078[_kod_0x234f('0x1d','HzzJ')]='systemGroup/get';
		 
		_0x121078[_kod_0x234f('0x1e','udfS')]=_kod_0x234f('0x1f','^PNU');
		_0x121078['JTxNd']=function(_0xa6dc8,_0xb7e6d7){return _0xa6dc8(_0xb7e6d7);};
		...
		_0x121078['NbmnW']=function(_0x30e71e,_0x22a9d5){return _0x30e71e==_0x22a9d5;};
		
		_0x121078[_kod_0x234f('0x2f','hGfR')]=function(_0x3b41b7,_0x44aee1){return _0x3b41b7+_0x44aee1;};
		
		_0x121078[_kod_0x234f('0x30','8Jdb')]=_kod_0x234f('0x31','(3Wb');
		
		_0x121078[_kod_0x234f('0x32','bsbw')]=_kod_0x234f('0x33','FXf)');
		
		_0x121078['oPHUG']=function(_0x11f22c,_0x442615){return _0x11f22c*_0x442615;};
		
		_0x121078['bzQgH']=_kod_0x234f('0x34','%JOq');
		
		_0x121078[_kod_0x234f('0x35','GQxD')]=function(_0x126e10,_0x3ae7ea){return _0x126e10(_0x3ae7ea);};
		...
		_0x121078[_kod_0x234f('0x3a','C0Lg')]=function(_0x42cfa9,_0x32610c){return _0x42cfa9(_0x32610c);};
		
		_0x121078[_kod_0x234f('0x3b','FXf)')]=_kod_0x234f('0x3c','8Jdb');
		
		_0x121078[_kod_0x234f('0x3d','ra%W')]=function(_0x19a043,_0x140d6b){return _0x19a043(_0x140d6b);};
		...
		_0x121078[_kod_0x234f('0x45','Nnx)')]=function(_0x5c6783,_0x1cef14){return _0x5c6783+_0x1cef14;};
		
		_0x121078[_kod_0x234f('0x46','hGfR')]=function(_0xd09244,_0x24d868){return _0xd09244(_0x24d868);};
		
		_0x121078['VlcAp']=_kod_0x234f('0x47','5VJD');
		
		_0x121078['iQbqF']=_kod_0x234f('0x48','#!f(');
		_0x121078[_kod_0x234f('0x49','Jp)Y')]=function(_0x33f7cb,_0x354c23){return _0x33f7cb(_0x354c23);};
		
		_0x121078[_kod_0x234f('0x4a','C0Lg')]=_kod_0x234f('0x4b','dS36');
		
		_0x121078[_kod_0x234f('0x4c','7FwE')]='oSHsV';
		
		_0x121078[_kod_0x234f('0x4d','ldfK')]=function(_0x4f4a03,_0x1cc771){return _0x4f4a03(_0x1cc771);};
		
		_0x121078[_kod_0x234f('0x4e','q629')]=function(_0x2a5b68,_0x1e477c){return _0x2a5b68(_0x1e477c);};
		
		_0x121078[_kod_0x234f('0x4f','ymRv')]=_kod_0x234f('0x50','GQxD');
		
		var _0x257855,_0x3d6c2a,_0x1f8d35,_0xc85af5,
		
		_0x59c5ef=function()
		{
			var _0x441bae={};_0x441bae[_kod_0x234f('0x51','TB)3')]='switch_hover';
			...
			if('KSZSG'==='KSZSG')
			{
				_0x121078[_kod_0x234f('0x54','5VJD')](_0x4138fb),_0x121078['YSWsQ'](_0x2c910c),
				$('.ztree\x20.switch')[_kod_0x234f('0x55','CIam')](_0x121078[_kod_0x234f('0x56','7FwE')])[_kod_0x234f('0x57','#oR*')]('mouseenter',function()
				{
					...
					$(_kod_0x234f('0x5e','CIam'))['die'](_0x121078[_kod_0x234f('0x5f','wOly')])[_kod_0x234f('0x60','l6GQ')]('mouseenter',function(){$(this)['addClass']('hover');})['die'](_0x121078[_kod_0x234f('0x61','LP6r')])[_kod_0x234f('0x62','(3Wb')](_0x121078[_kod_0x234f('0x63','Zsms')],function()
					{
			...
			{
				_0x441bae[_kod_0x234f('0x69','TB)3')]($,this)[_kod_0x234f('0x6a','GjhH')]({'x':_0x5b8ee9[_kod_0x234f('0x6b','yN0$')],'y':_0x5b8ee9[_kod_0x234f('0x6c','kO0e')]});
			}
		},
		...
		_0x491c3d=function(_0x5107f4,_0x19c45a)
		{
			...
			{
				_0xc85af5=_0x19c45a;var _0x3d6c2a=_0x257855[_kod_0x234f('0x6e','1*&c')]('id',_0x19c45a,null);
				_0x257855[_kod_0x234f('0x6f','TB)3')](_0x3d6c2a),_0x165384(_0x19c45a);
			}else
			  _0x121078[_kod_0x234f('0x70','c&*T')](_kod_0x234f('0x71','GQxD'),_0x5107f4)&&($(_0x121078[_kod_0x234f('0x72','8Jdb')])['val'](_0x19c45a),$(_0x121078['XNKkn'])['addClass']('hidden'),_0x121078['LNnkT'](_0x158960));
			},
			_0x47e475=function(_0x1aafbe)
			{
				var _0x4e8061={};
				
				_0x4e8061['brsUz']=function(_0x1e64c8,_0x48ad8d){return _0x1e64c8>_0x48ad8d;};
				...
				var _0x54aeee=function(_0xf403cb)
				{
					...
					{
						for(var _0x257855=0x0;_0x257855<_0xf403cb[_kod_0x234f('0x77','CIam')];_0x257855++)
						  void 0x0!=_0xf403cb[_0x257855]?(_0xf403cb[_0x257855]['pid']=_0xf403cb[_0x257855][_kod_0x234f('0x78','tJ%C')],_0xf403cb[_0x257855]['id']=_0xf403cb[_0x257855]['groupID'],delete _0xf403cb[_0x257855][_kod_0x234f('0x79','udfS')],delete _0xf403cb[_0x257855]['parentID'],delete _0xf403cb[_0x257855][_kod_0x234f('0x7a','hFVg')],_0xf403cb[_0x257855]['child']&&(_0xf403cb[_0x257855][_kod_0x234f('0x7b','vk@u')]=_0xf403cb[_0x257855]['child'],delete _0xf403cb[_0x257855][_kod_0x234f('0x7c','5vG2')],_0x54aeee(_0xf403cb[_0x257855][_kod_0x234f('0x7d','Nnx)')]))):delete _0xf403cb[_0x257855];
					}
			 },
			 
			 _0x257855=[],_0x3d6c2a=$['extend'](!0x0,{},_0x1aafbe);
			 for(var _0x1f8d35 in _0x3d6c2a)
			 {
				 var _0xc85af5=_0x3d6c2a[_0x1f8d35],_0x59c5ef=_0xc85af5['parentID'];
				 if(_0x3d6c2a[_0x59c5ef])
				    _0x3d6c2a[_0x59c5ef]['child']||(_0x3d6c2a[_0x59c5ef][_kod_0x234f('0x7e','wOly')]=[]),_0x3d6c2a[_0x59c5ef][_kod_0x234f('0x7f','8Jdb')][_kod_0x234f('0x80','uxxA')](_0x3d6c2a[_0xc85af5[_kod_0x234f('0x81','vk@u')]]);
				 else
				 {
					 var _0x439a69=_0x3d6c2a[_0xc85af5[_kod_0x234f('0x82','LP6r')]];_0x439a69&&_0x257855['push'](_0x439a69);
				 }
			}
			var _0x491c3d=function(_0x354c01,_0x159973)
			{
				...
				var _0x257855=G['settings'][_kod_0x234f('0x8f','C0Lg')]||_kod_0x234f('0x90','uxxA'),_0x3d6c2a=_kod_0x234f('0x91','udfS')==_0x257855?0x1:-0x1,
		...
		_0x2c910c=function()
		{
			...
			$['ajax']({'url':G['appHost']+_0x121078[_kod_0x234f('0x9e','ra%W')],
					  ...
					  'success':function(_0x63dfff)
					  {
						  ...
						  {
							  if(_0x5b8ee9&&_0x5b8ee9[_kod_0x234f('0xa6','GjhH')](),!_0x63dfff[_kod_0x234f('0xa7','ldfK')])
							       return void $(_kod_0x234f('0xa8','X9!o'))[_kod_0x234f('0xa9','hGfR')](_0x121078[_kod_0x234f('0xaa','ra%W')]('<div\x20style=\x22text-align:center;\x22>',LNG[_kod_0x234f('0xab','(3Wb')])+_0x121078['kflIp']);
								    
								   
								   //_0x1f8d35=core['systemData'](_0x63dfff,_kod_0x234f('0xac','K9yL')); //core['systemData'](dataArr ,group);
								    _0x1f8d35 = _0x63dfff.data
								   ...
								   if(core[_kod_0x234f('0xad','Nnx)')]==String['fromCharCode'](0x41))
									  ...
									  { 
										  ...
										  _0x59c5ef[_0x2c910c]=_0x1f8d35[_0x2c910c];//,_0x1f8d35=_0x59c5ef;//break;
									  }
								
								_0x3d6c2a=_0x121078['ezTlr'](_0x47e475,_0x1f8d35),
								
								$['fn']['zTree']['init']($(_kod_0x234f('0xae','7Hot')),_0x439a69,_0x3d6c2a),
								
								_0x257855=$['fn'][_kod_0x234f('0xaf','wOly')][_kod_0x234f('0xb0','q629')](_kod_0x234f('0xb1','ra%W'));
								
								var _0x9f52d6=_0x257855[_kod_0x234f('0xb2','nE0w')]();
								
								_0x257855['expandNode'](_0x9f52d6[0x0],!0x0),
								
								_0x121078[_kod_0x234f('0xb3','hGfR')](void 0x0,_0xc85af5)&&(_0xc85af5='1'),_0x491c3d(_kod_0x234f('0xb4','@@w]'),_0xc85af5),0x0!=_0x121078[_kod_0x234f('0xb5','X9!o')]($,'#group-parent-select')['length']&&_0x121078[_kod_0x234f('0xb6','ra%W')](_0x60d53);
							}
						}
					});
				...
				_0x9f52d6=function()
				{
					...
					if(_kod_0x234f('0xb7','Nnx)')!==_0x121078['tFGfy'])
					{
						...
						if(_0x4f1fec['find'](_0x121078[_kod_0x234f('0xbb','uxxA')])[_kod_0x234f('0xbc','#!f(')](_kod_0x234f('0xbd','GQxD')),'0'==_0x53f670||''==_0x53f670)
						    return $('.select-parent-content\x20.group-title')[_kod_0x234f('0xbe','5VJD')]('is\x20root'),!0x1;

                       var _0x1d1726=_0x56e566(_0x53f670),  _0x32ca21=$['fn'][_kod_0x234f('0xbf','C0Lg')]['getZTreeObj'](_0x121078['wOMLK']);

                      return _0x4dd816(_0x32ca21,_0x53f670),$(_0x121078['DCIko'])[_kod_0x234f('0xc0','^v(7')](_0x1d1726[_kod_0x234f('0xc1','1*&c')]),_0x4f1fec['find'](_0x121078[_kod_0x234f('0xc2','^PNU')](_0x121078[_kod_0x234f('0xc3','X9!o')],_0x53f670)+']')['addClass'](_kod_0x234f('0xc4','HzzJ')),!0x0;}else{$('.context-menu-list')[_kod_0x234f('0xc5','^v(7')](_kod_0x234f('0xc6','udfS'))[_kod_0x234f('0xc7','dS36')]('contextmenu:hide');
...
_0x4138fb=function()
{
	_0x121078[_kod_0x234f('0xc8','LP6r')]($,_kod_0x234f('0xc9','#oR*'))[_kod_0x234f('0xca','[&Q2')](_0x9f52d6)['contextmenu'](_0x9f52d6),$['contextMenu']({'zIndex':0x270f,'selector':_kod_0x234f('0xcb','bsbw'),'items':{'add-child':{'name':LNG[_kod_0x234f('0xcc','ldfK')],'icon':_0x121078[_kod_0x234f('0xcd','5VJD')],'accesskey':'u'},'edit':{'name':LNG[_kod_0x234f('0xce','1*&c')],'icon':_0x121078[_kod_0x234f('0x2d','5vG2')],'accesskey':'e'},'sep1':_kod_0x234f('0xcf','kO0e'),'add-user':{'name':LNG[_kod_0x234f('0xd0','HzzJ')],'icon':_0x121078[_kod_0x234f('0xd1','#!f(')],'accesskey':'g'},'sep2':_kod_0x234f('0xd2','hGfR'),'remove':{'name':LNG['remove'],'icon':_kod_0x234f('0xd3','CIam'),'accesskey':'r'}
},

'callback':function(_0xbe4931,_0x5c4643)
{
	
	var _0x3d6c2a=_0x5c4643[_kod_0x234f('0xd4','5VJD')][_kod_0x234f('0xd5','8Jdb')]('id');_0x3d6c2a=_0x3d6c2a[_kod_0x234f('0xd6','yN0$')]('_a','');
	var _0x1f8d35=_0x257855['getNodeByTId'](_0x3d6c2a);
	switch(_0xbe4931)
	{
		case 'add-child':var _0xc85af5=_0x56e566();_0xc85af5[_kod_0x234f('0xd7','^PNU')]=_0x1f8d35['id'],_0x224704(_0xc85af5);break;
		case _kod_0x234f('0xd8','udfS'):var _0xc85af5=_0x56e566(_0x1f8d35['id']);_0x224704(_0xc85af5);break;
		case _0x121078[_kod_0x234f('0xd9','1*&c')]:System['systemMember']['add'](_0x1f8d35['id']);break;
		case _kod_0x234f('0xda','c&*T'):_0xa62c8d(_0x1f8d35['id']);
	 }
}}),$(_kod_0x234f('0xdb','5vG2'))[_kod_0x234f('0xdc','5VJD')](_kod_0x234f('0xdd','c&*T'))[_kod_0x234f('0xde','dS36')]('click',function(_0x50176a){_0x121078[_kod_0x234f('0xdf','ldfK')]($,this)[_kod_0x234f('0xe0','@@w]')]({'x':_0x50176a[_kod_0x234f('0xe1','Zsms')],'y':_0x50176a[_kod_0x234f('0xe2','C0Lg')]});
...
_0x56e566=function(_0x19e4fa){return _0x121078[_kod_0x234f('0xe3','hGfR')](void 0x0,_0x19e4fa)?_0x276654():_0x1f8d35[_0x19e4fa];},_0x276654=function(){return{'groupID':'','name':'','parentID':'','children':'','config':{'sizeMax':'0','sizeUse':''},'path':'','createTime':''};},_0xa62c8d=function(_0x26dec7,_0x4f56b3){var _0xe7a8e1={};_0xe7a8e1['YTWTN']=function(_0x40e2d5){return _0x40e2d5();};_0xe7a8e1[_kod_0x234f('0xe4','5Mnh')]=function(_0x2e20e5,_0x36d776){return _0x2e20e5===_0x36d776;};_0xe7a8e1['TGHDe']=_kod_0x234f('0xe5','^v(7');if(_kod_0x234f('0xe6','7FwE')!=='ZrFrp'){var _0x3d6c2a=_0x257855[_kod_0x234f('0xe7','c&*T')]()[0x0],_0x1f8d35=_0x3d6c2a['getParentNode'](),_0xc85af5=_0x121078['MhGnd'](G[_kod_0x234f('0xe8','Jp)Y')],_kod_0x234f('0xe9','7Hot'))+_0x26dec7;$[_kod_0x234f('0xea','1*&c')]({'id':_0x121078['KHiyg'],'fixed':!0x0,'icon':_0x121078[_kod_0x234f('0xeb','^v(7')],'title':LNG[_kod_0x234f('0xec','yN0$')],'padding':0x1e,'width':0x12c,'lock':!0x0,'background':'#000','opacity':0.3,'content':LNG[_kod_0x234f('0xed','^PNU')],'ok':function(){var _0x3cfdd1={};_0x3cfdd1['nZdbR']=function(_0x5048c2){return _0xe7a8e1.YTWTN(_0x5048c2);};if(_0xe7a8e1[_kod_0x234f('0xee','Esi%')](_0xe7a8e1['TGHDe'],'zZCDj')){var nXvxGS={};nXvxGS[_kod_0x234f('0xef','[&Q2')]=function(_0xe08a53,_0x21b85f){return _0xe08a53(_0x21b85f);};var _0x57b6b9=this;core[_kod_0x234f('0xf0','c&*T')][_kod_0x234f('0xf1','vk@u')]({'type':'folder','title':LNG[_kod_0x234f('0xf2','%JOq')],'firstPath':$(_kod_0x234f('0xf3','C0Lg'))['val']()},function(_0x3c8e64){nXvxGS[_kod_0x234f('0xf4','GQxD')]($,_0x57b6b9)['parent']()[_kod_0x234f('0xf5','TB)3')](_kod_0x234f('0xf6','ldfK'))[_kod_0x234f('0xf7','7FwE')](_0x3c8e64);});

}
else
{ 
	$[_kod_0x234f('0xf8','ra%W')]({'url':_0xc85af5,'type':'POST','dataType':_kod_0x234f('0xf9','VE0W'),

'beforeSend':function(){Tips[_kod_0x234f('0xfa','#!f(')]();},
'error':function()
{
	var msg = {"code": false,"use_time": 0.03512978553772,"data": unescape("%u5220%u9664%u6210%u529F%uFF01")}
 
		Tips[_kod_0x234f('0xfc','5VJD')](msg),System['systemMember'][_kod_0x234f('0xfd','Zsms')](),_0x491c3d('folder-list-tree',_0x1f8d35['id']),_0x3cfdd1[_kod_0x234f('0xfe','(3Wb')](_0x2c910c),_kod_0x234f('0xff','hFVg')==typeof _0x4f56b3&&_0x4f56b3(_0x26dec7);
},//core[_kod_0x234f('0xfb','FXf)')],
...
}},'cancel':!0x0});}else{window['open'](core[_kod_0x234f('0x100','hFVg')]);}

}

,_0x49a79e=function(){
	
	var _0x5b8ee9=_0x121078['oPHUG'](0x40000000,parseFloat($(_0x121078[_kod_0x234f('0x101','ldfK')])[_kod_0x234f('0x102','yN0$')]())),_0x54aeee=pathTools[_kod_0x234f('0x103','5VJD')](_0x5b8ee9);_0x121078[_kod_0x234f('0x104','VE0W')](0x0,_0x5b8ee9)||isNaN(_0x5b8ee9)?_0x121078[_kod_0x234f('0x105','CIam')]($,_0x121078[_kod_0x234f('0x106','Nnx)')])[_kod_0x234f('0x107','Zsms')](LNG[_kod_0x234f('0x108','ymRv')]):$(_kod_0x234f('0x109','X9!o'))[_kod_0x234f('0x10a','c&*T')](_0x54aeee);},_0x158960=function(){var _0x5b8ee9=$(_0x121078[_kod_0x234f('0x10b','bsbw')]),_0x54aeee=$(_kod_0x234f('0x10c','dS36'))[_kod_0x234f('0x10d','q629')]();if(_0x5b8ee9[_kod_0x234f('0x10e','vk@u')](_kod_0x234f('0x10f','#!f('))['removeClass'](_kod_0x234f('0x110','7Hot')),'0'==_0x54aeee||_0x121078['NbmnW']('',_0x54aeee))return $(_kod_0x234f('0x111','uxxA'))[_kod_0x234f('0x112','5vG2')](_0x121078[_kod_0x234f('0x113','c&*T')]),!0x1;var _0x257855=_0x56e566(_0x54aeee),_0x3d6c2a=$['fn'][_kod_0x234f('0x114','ymRv')][_kod_0x234f('0x115','vk@u')](_kod_0x234f('0x116','X9!o'));return _0x4dd816(_0x3d6c2a,_0x54aeee),$(_0x121078[_kod_0x234f('0x117','1*&c')])[_kod_0x234f('0x118','7FwE')](_0x257855[_kod_0x234f('0x119','c&*T')]),_0x5b8ee9[_kod_0x234f('0x11a','^PNU')](_0x121078[_kod_0x234f('0x11b','nE0w')]+_0x54aeee+']')[_kod_0x234f('0x11c','%JOq')](_kod_0x234f('0x11d','#!f(')),!0x0;},_0x4dd816=function(_0x195e38,_0xee646a){var _0x4ffc27={};_0x4ffc27[_kod_0x234f('0x11e','TB)3')]=function(_0x129290,_0x157327){return _0x129290(_0x157327);};_0x4ffc27['kpPof']=_kod_0x234f('0x11f','C0Lg');if('CdWvZ'!==_kod_0x234f('0x120','ymRv')){for(var _0x257855=[],_0x3d6c2a=_0x195e38[_kod_0x234f('0x121','ymRv')]('id',_0xee646a,null),_0x1f8d35=_0x3d6c2a;_0x3d6c2a=_0x3d6c2a[_kod_0x234f('0x122','GQxD')]();)_0x257855['push'](_0x3d6c2a);for(var _0xc85af5=_0x257855[_kod_0x234f('0x123','#!f(')]-0x1;_0xc85af5>=0x0;_0xc85af5--)_0x195e38[_kod_0x234f('0x124','ldfK')](_0x257855[_0xc85af5],!0x0);_0x195e38[_kod_0x234f('0x125','c&*T')](_0x1f8d35,!0x0);}else{_0x4ffc27[_kod_0x234f('0x126','(3Wb')]($,'.context-menu-list')[_kod_0x234f('0x127','c&*T')](_0x4ffc27[_kod_0x234f('0x128','FXf)')])['trigger'](_kod_0x234f('0x129','bsbw'));}},_0x60d53=function(){if(_kod_0x234f('0x12a','[&Q2')!==_kod_0x234f('0x12b','1*&c')){var _0x5b8ee9=_0x121078[_kod_0x234f('0x12c','C0Lg')]($,'#group-parent-select');$['fn'][_kod_0x234f('0x12d','GQxD')][_kod_0x234f('0x12e','Zsms')](_0x5b8ee9,_0x439a69,_0x3d6c2a);var _0x54aeee=$['fn'][_kod_0x234f('0x12f','(4KK')][_kod_0x234f('0x130','C0Lg')](_kod_0x234f('0x131','ldfK')),_0x257855=_0x54aeee[_kod_0x234f('0x132','wOly')]();_0x54aeee[_kod_0x234f('0x133','7FwE')](_0x257855[0x0],!0x0),_0x158960()&&$(_kod_0x234f('0x134','Nnx)'))[_kod_0x234f('0x135','ldfK')](_0x121078['YoHAZ'])[_kod_0x234f('0x136','yN0$')](_kod_0x234f('0x137','VE0W'),function(){
	
	$('.select-group')['toggleClass']('hidden');
	
	});}else{_0x5b8ee9&&_0x5b8ee9[_kod_0x234f('0x138','CIam')](),$(_kod_0x234f('0x139','vk@u'))[_kod_0x234f('0x13a','q629')](_0x121078[_kod_0x234f('0x13b','uxxA')]('<div\x20style=\x22text-align:center;\x22>'+LNG['system_error'],'</div>'));}},_0x224704=function(_0x38c956){var _0x1b0711={};_0x1b0711[_kod_0x234f('0x13c','GjhH')]=_0x121078.sbpjd;_0x1b0711['AnErY']=function(_0x4c9942,_0x178a9f){return _0x4c9942(_0x178a9f);};_0x1b0711[_kod_0x234f('0x13d','LP6r')]=_kod_0x234f('0x13e','nE0w');_0x1b0711['kEuzi']=function(_0x3cb80,_0x3a9767){return _0x3cb80(_0x3a9767);};_0x1b0711['qrDeP']=function(_0xcfa423,_0x16ec91){return _0xcfa423(_0x16ec91);};_0x1b0711[_kod_0x234f('0x13f','GjhH')]=_0x121078.GVsKp;_0x1b0711[_kod_0x234f('0x140','Esi%')]='IuYpD';_0x1b0711['yUzOp']=_kod_0x234f('0x141','5vG2');_0x1b0711[_kod_0x234f('0x142','5Mnh')]=_0x121078.MisBo;_0x1b0711[_kod_0x234f('0x143','Zsms')]=_kod_0x234f('0x144','uxxA');_0x1b0711['wvsSp']='#group-parent-select';_0x1b0711[_kod_0x234f('0x145','yN0$')]=_kod_0x234f('0x146','FXf)');_0x1b0711[_kod_0x234f('0x147','wOly')]=function(_0x2b8eff,_0x361b48){return _0x2b8eff===_0x361b48;};_0x1b0711[_kod_0x234f('0x148','X9!o')]=_0x121078.chnyi;_0x1b0711[_kod_0x234f('0x149','ra%W')]=_kod_0x234f('0x14a','#oR*');_0x1b0711[_kod_0x234f('0x14b','kO0e')]=function(_0x2db07c,_0x43444b){return _0x2db07c!==_0x43444b;};_0x1b0711[_kod_0x234f('0x14c','1*&c')]=_0x121078.qeAZd;_0x1b0711[_kod_0x234f('0x14d','uxxA')]=function(_0x5a2cd9,_0x5bdc27){return _0x5a2cd9!=_0x5bdc27;};var _0x257855=_0x5b8ee9(_kod_0x234f('0x14e','nE0w')),_0x3d6c2a=template['compile'](_0x257855),_0x1f8d35=_0x3d6c2a({'LNG':LNG,'groupInfo':_0x38c956}),_0xc85af5=$[_kod_0x234f('0x14f','7FwE')]({'id':_0x121078['AJwVZ'],'simple':!0x0,'resize':!0x1,'width':0x1a9,'background':_kod_0x234f('0x150','^PNU'),'opacity':0.1,'title':'','padding':'0','fixed':!0x0,'lock':!0x0,'content':_0x1f8d35});_0x49a79e(),System[_kod_0x234f('0x151','q629')]($(_0x121078[_kod_0x234f('0x152','TB)3')])),_0x60d53(),$(_0x121078['wkblR'])[_kod_0x234f('0x153','vk@u')]();var _0x59c5ef=G[_kod_0x234f('0x154','FXf)')]+'systemGroup/add';if(''!=_0x38c956[_kod_0x234f('0x155','Esi%')])var _0x59c5ef=_0x121078['NzlRB'](G[_kod_0x234f('0x156','5vG2')]+'systemGroup/edit&groupID=',_0x38c956['groupID']);$(_kod_0x234f('0x157','Nnx)'))[_kod_0x234f('0x158','uxxA')]('click')[_kod_0x234f('0x159','c&*T')](_kod_0x234f('0x15a','wOly'),function(){_0x439a69();}),$(_kod_0x234f('0x15b','vk@u'))[_kod_0x234f('0x15c','8Jdb')](_kod_0x234f('0x15d','5Mnh'))['bind'](_kod_0x234f('0x15e','uxxA'),function(){System['openPath'](_0x38c956);}),_0x121078[_kod_0x234f('0x15f','Nnx)')]($,_kod_0x234f('0x160','q629'))[_kod_0x234f('0x161','nE0w')](_kod_0x234f('0x162','dS36'))['bind'](_kod_0x234f('0x163','(3Wb'),function(){if('pKlhd'===_kod_0x234f('0x164','%JOq')){var _0x5e9a9b=urlEncode($(this)['val']());''!=_0x5e9a9b&&(_0x257855[$(this)[_kod_0x234f('0x165','Zsms')](_0x1b0711['cZmoH'])]=_0x5e9a9b);}else{_0xa62c8d(_0x38c956[_kod_0x234f('0x7a','hFVg')],function(){_0xc85af5['close']();});}}),_0x121078[_kod_0x234f('0x166','GjhH')]($,_kod_0x234f('0x167','5VJD'))[_kod_0x234f('0x168','uxxA')](function(){var _0x1a49d9={};_0x1a49d9[_kod_0x234f('0x169','c&*T')]=function(_0x1aee3c,_0x2e488c){return _0x1aee3c(_0x2e488c);};if(_kod_0x234f('0x16a','FXf)')===_0x121078[_kod_0x234f('0x16b','CIam')]){_0x1a49d9[_kod_0x234f('0x16c','FXf)')](_0x439a69,!0x0);}else{_0x121078[_kod_0x234f('0x16d','Jp)Y')](_0x439a69,!0x0);}}),$(_kod_0x234f('0x16e','CIam'))[_kod_0x234f('0x16f','yN0$')](_0x121078[_kod_0x234f('0x170','(4KK')])[_kod_0x234f('0x171','CIam')](_kod_0x234f('0x172','FXf)'),function(){_0x439a69(!0x0);}),$(_0x121078['VlcAp'])[_kod_0x234f('0x15c','8Jdb')](_0x121078[_kod_0x234f('0x173','uxxA')])[_kod_0x234f('0x174','VE0W')](_0x121078[_kod_0x234f('0x175','TB)3')],function(){if(_0x1b0711[_kod_0x234f('0x176','TB)3')]!==_kod_0x234f('0x177','FXf)')){$(_0x1b0711[_kod_0x234f('0x178','nE0w')])[_kod_0x234f('0x179','uxxA')](_0x1b0711[_kod_0x234f('0x17a','TB)3')]);}else{var _0xd7d2b2=0x40000000*parseFloat(_0x1b0711['AnErY']($,_0x1b0711[_kod_0x234f('0x17b','bsbw')])[_kod_0x234f('0x17c','vk@u')]()),_0x3468e0=pathTools[_kod_0x234f('0x17d','ldfK')](_0xd7d2b2);0x0==_0xd7d2b2||_0x1b0711[_kod_0x234f('0x17e','(4KK')](isNaN,_0xd7d2b2)?_0x1b0711[_kod_0x234f('0x17f','[&Q2')]($,_0x1b0711[_kod_0x234f('0x180','X9!o')])[_kod_0x234f('0x181','(3Wb')](LNG[_kod_0x234f('0x182','1*&c')]):_0x1b0711['qrDeP']($,_0x1b0711[_kod_0x234f('0x183','CIam')])[_kod_0x234f('0x184','kO0e')](_0x3468e0);}}),$(_kod_0x234f('0x185','wOly'))[_kod_0x234f('0x161','nE0w')](_kod_0x234f('0x186','#!f('))['bind'](_0x121078[_kod_0x234f('0x187','5VJD')],function(){var _0x5b8ee9=this;core[_kod_0x234f('0x188','GjhH')]['pathSelect']({'type':_0x121078['anuCG'],'title':LNG[_kod_0x234f('0x189','VE0W')],'firstPath':_0x121078[_kod_0x234f('0x18a','5VJD')]($,_kod_0x234f('0x18b','GjhH'))[_kod_0x234f('0x18c','udfS')]()},function(_0x19d019){$(_0x5b8ee9)['parent']()[_kod_0x234f('0x18d','[&Q2')](_kod_0x234f('0x18e','CIam'))[_kod_0x234f('0x18f','(3Wb')](_0x19d019);});}),$(_kod_0x234f('0x190','ymRv'))['unbind']('click')['bind'](_kod_0x234f('0x191','8Jdb'),function(){$(this)[_kod_0x234f('0x192','bsbw')]()[_kod_0x234f('0x193','#!f(')](_0x1b0711[_kod_0x234f('0x194','X9!o')])[_kod_0x234f('0x195','tJ%C')]('');});var _0x439a69=function(_0x202c54){var _0x5077ca={};_0x5077ca[_kod_0x234f('0x196','7FwE')]=function(_0x10789c,_0x3d53b1){return _0x121078.jdllY(_0x10789c,_0x3d53b1);};_0x5077ca[_kod_0x234f('0x197','Nnx)')]=_kod_0x234f('0x198','ymRv');_0x5077ca['CGAgV']='SgBTZ';var _0x257855={};return $(_kod_0x234f('0x199','ra%W'))[_kod_0x234f('0x19a','X9!o')](function(){var _0x202c54=urlEncode($(this)[_kod_0x234f('0x19b','nE0w')]());''!=_0x202c54&&(_0x257855[_0x5077ca['QUErj']($,this)[_kod_0x234f('0x19c','K9yL')](_kod_0x234f('0x19d','5Mnh'))]=_0x202c54);}),''==trim(urlDecode(_0x257855['name']))?(Tips[_kod_0x234f('0x19e','%JOq')](LNG[_kod_0x234f('0x19f','C0Lg')],_kod_0x234f('0x1a0','hGfR')),!0x1):void $[_kod_0x234f('0x1a1','HzzJ')]({'url':_0x59c5ef,'data':_0x257855,'type':_kod_0x234f('0x1a2','dS36'),'dataType':_0x121078[_kod_0x234f('0x1a3','TB)3')],'beforeSend':function(){var _0x22a199={};_0x22a199[_kod_0x234f('0x1a4','[&Q2')]=function(_0x45f3d7,_0x3a9ef6){return _0x45f3d7(_0x3a9ef6);};_0x22a199[_kod_0x234f('0x1a5','hGfR')]=_0x1b0711.wvsSp;_0x22a199['hWrsq']=_0x1b0711.JoBvR;_0x22a199['iLgDW']=function(_0x280153){return _0x280153();};_0x22a199['gxkyE']=_kod_0x234f('0x1a6','1*&c');if(_0x1b0711[_kod_0x234f('0x1a7','Esi%')]('CkfNQ',_kod_0x234f('0x1a8','GjhH'))){var _0x58bd82=_0x22a199[_kod_0x234f('0x1a9','dS36')]($,_0x22a199[_kod_0x234f('0x1aa','[&Q2')]);$['fn'][_kod_0x234f('0x1ab','CIam')][_kod_0x234f('0x1ac','HzzJ')](_0x58bd82,_0x439a69,_0x3d6c2a);var _0x5f22d6=$['fn']['zTree'][_kod_0x234f('0x1ad','tJ%C')](_0x22a199[_kod_0x234f('0x1ae','FXf)')]),_0x4ee947=_0x5f22d6[_kod_0x234f('0x1af','tJ%C')]();_0x5f22d6[_kod_0x234f('0x1b0','8Jdb')](_0x4ee947[0x0],!0x0),_0x22a199['iLgDW'](_0x158960)&&_0x22a199[_kod_0x234f('0x1b1','hGfR')]($,_0x22a199[_kod_0x234f('0x1b2','HzzJ')])['unbind'](_kod_0x234f('0x1b3','ymRv'))[_kod_0x234f('0x1b4','wOly')](_kod_0x234f('0x1b5','K9yL'),function(){$(_kod_0x234f('0x1b6','ra%W'))['toggleClass'](_kod_0x234f('0x1b7','VE0W'));});}else{Tips[_kod_0x234f('0x1b8','HzzJ')]();}},
	...
	'success':function(_0x3e6c91)
	{
		...
		/*if(!_0x3e6c91[_kod_0x234f('0x1ba','tJ%C')]&&_kod_0x234f('0x1bb','tJ%C')==_0x3e6c91['info'])
		{
		    return Tips['close'](LNG[_0x3e6c91[_kod_0x234f('0x1bc','Zsms')]]),void $[_kod_0x234f('0x1bd','hFVg')]({'content':LNG[_0x3e6c91[_kod_0x234f('0x1be','5VJD')]],'padding':_0x1b0711['wXfYf'],'width':_0x1b0711[_kod_0x234f('0x1bf','FXf)')],'okVal':LNG[_kod_0x234f('0x1c0','uxxA')],'ok':function(){window['open'](core[_kod_0x234f('0x1c1','5Mnh')]);}});
		}*/
			  if(Tips['close'](_0x3e6c91),_0x3e6c91[_kod_0x234f('0x1c2','K9yL')])
			  {
				  ...
				  { 
					 ...
					 /*if(core[_kod_0x234f('0x1c6','7Hot')]==String[_kod_0x234f('0x1c7','ldfK')](0x41))for(;;){md5('+');}*/
					   
					  _0x2c910c(),_0x1b0711[_kod_0x234f('0x14d','uxxA')]('',_0x38c956[_kod_0x234f('0x1c8','5VJD')])||_0x1b0711['BJjsd'](0x1,_0x202c54)?_0xc85af5[_kod_0x234f('0x1c9','%JOq')]():setTimeout(function(){var _0x37227b={};_0x37227b[_kod_0x234f('0x1ca','[&Q2')]=_kod_0x234f('0x1cb','ymRv');_0x37227b['KCTgt']=function(_0x446cbd,_0x5f4fc1){return _0x446cbd(_0x5f4fc1);};
		
		if(_0x5077ca[_kod_0x234f('0x1cc','@@w]')]!==_0x5077ca[_kod_0x234f('0x1cd','7Hot')]){_0x5077ca[_kod_0x234f('0x1ce','5Mnh')]($,_kod_0x234f('0x1cf','5Mnh'))[_kod_0x234f('0x1d0','TB)3')]('')[_kod_0x234f('0x1d1','[&Q2')]();}else{$[_kod_0x234f('0x1d2','K9yL')]({'url':_0xc85af5,'type':'POST','dataType':_kod_0x234f('0x1d3','#oR*'),
		
		'beforeSend':function(){/*Tips[_kod_0x234f('0x1d4','uxxA')]();*/},
		'error':core[_kod_0x234f('0x1d5','c&*T')],
		'success':function(_0x3cfa42)
		{ 
			Tips['close'](_0x3cfa42),System['systemMember'][_kod_0x234f('0x1d6','K9yL')](),_0x491c3d(_0x37227b[_kod_0x234f('0x1d7','ymRv')],_0x1f8d35['id']),_0x2c910c(),'function'==typeof _0x38c956&&_0x37227b[_kod_0x234f('0x1d8','^PNU')](_0x38c956,_0x202c54);}});}},0xc8);}}}});
};
},
_0x165384=function(_0x4fb507)
{
	...
	_0x54aeee&&(_0x121078[_kod_0x234f('0x1d9','5vG2')]($,_0x121078[_kod_0x234f('0x1da','%JOq')])['html'](_0x54aeee['name']),
	$(_kod_0x234f('0x1db','#!f('))[_kod_0x234f('0x1dc','ymRv')](_0x54aeee['config'][_kod_0x234f('0x1dd','ldfK')]+'/'+_0x54aeee[_kod_0x234f('0x1de','CIam')][_kod_0x234f('0x1df','c&*T')]),
	$('#content-system-group\x20.group-id')[_kod_0x234f('0x1e0','nE0w')](_0x4fb507),System['sizeUse'](_0x121078[_kod_0x234f('0x1e1','QwxU')]($,_0x121078['ZRgYb'])),System[_kod_0x234f('0x1e2','Nnx)')][_kod_0x234f('0x1e3','VE0W')](_0x4fb507));},
	_0x2f5684=function(){
		var _0x2e6ce1={};
		...
		$(_0x121078[_kod_0x234f('0x1e5','ymRv')])[_kod_0x234f('0x1e6','#!f(')](_kod_0x234f('0x1e7','(3Wb'),_0x49a79e),
		$(_0x121078[_kod_0x234f('0x1e8','bsbw')])[_kod_0x234f('0x1e9','bsbw')](_kod_0x234f('0x1ea','ldfK'),
		function(_0x1c9856)
		{
			if(_kod_0x234f('0x1eb','l6GQ')===_0x121078['kNYgl'])
			{
				...
				_0x257855=$(_kod_0x234f('0x1f2','uxxA'))['html'](),_0x3d6c2a=_0x121078[_kod_0x234f('0x1f3','[&Q2')](_0x56e566,_0x257855);
				switch(_0x54aeee){
					case _kod_0x234f('0x1f4','@@w]'):_0x224704(_0x3d6c2a);break;
					case _kod_0x234f('0x1f5','5Mnh'):System[_kod_0x234f('0x1f6','5Mnh')](_0x3d6c2a);break;
					case _kod_0x234f('0x1f7','yN0$'):var _0x1f8d35=_0x56e566();_0x1f8d35['parentID']=_0x257855,_0x121078[_kod_0x234f('0x1f8','bsbw')](_0x224704,_0x1f8d35);
				}
			}
		});
	};
	
	_0x439a69[_kod_0x234f('0x1fd','C0Lg')]={};_0x439a69[_kod_0x234f('0x1f9','ra%W')]={};
	...
	_0x439a69[_kod_0x234f('0x1f9','ra%W')][_kod_0x234f('0x1fa','nE0w')]=function(_0x4ef0fe,_0x5c4261,_0x4b2148)
	{
		...
		{
			var _0x27e3cc={KZrKE:_0x121078.Bscwi};
		...
		_0x439a69[_kod_0x234f('0x1fd','C0Lg')]['selectedMulti']=!0x1;_0x439a69[_kod_0x234f('0x1fd','C0Lg')][_kod_0x234f('0x1ff','(3Wb')]=!0x0;
		_0x439a69[_kod_0x234f('0x1fd','C0Lg')][_kod_0x234f('0x200','ymRv')]=function(_0x45d144,_0x54efa8)
		{
			var _0x257855=0xc,_0x3d6c2a=$('#'+_0x45d144+'\x20#'+_0x54efa8.tId+_kod_0x234f('0x201','[&Q2')),
