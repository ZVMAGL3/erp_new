...
g_exts.push({type:"img",ext:"bmp",contenttype:"application/x-bmp",src:"jpg.png"});
...
var g_conf={
	...
	rel_chongchuan:{cssText:"position:absolute;cursor:pointer;padding:0px;border:0px;right:0px;bottom:40px;overflow:hidden;text-align:center;margin:0px;filter:alpha(opacity=70);opacity:0.7;-webkit-opacity:0.7; -moz-opacity:0.7;padding:2px; padding-left:5px;padding-right:5px;font-size:12px;display:block;line-height:20px;height:20px;color:#ffffff;background-color:#000000;z-index:200"},
	...
	rel_chongxuan:{cssText:"position:absolute;bottom:0px; cursor:pointer; text-align:center; left:0px; width:100%;height:100%;z-index:204;"},
	...
	rel_jieping:{cssText:"position:absolute;cursor:pointer; bottom:0px;padding:0px;border:0px;right:1px;overflow:hidden;text-align:center;margin:0px;filter:alpha(opacity=70);opacity:0.7;-webkit-opacity:0.7; -moz-opacity:0.7;line-height:18px;height:20px;width:30px;z-index:400;font-size:12px;color:#666666;background-color: #f0f0f0;"},
...
var g_jiaozheng_ua=[
		 {"userAgent:":"iPhone OS 13_2_3 like Mac OS X) AppleWebKit/605.1.15"}
        ,{"userAgent:":"iPhone OS 13_2_3 like Mac OS X) AppleWebKit/605.1.15"}
  ];
