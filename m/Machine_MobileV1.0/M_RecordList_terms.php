...
<body>
<div id="wrapper">
    <div id="header"> <a href="M_RecordList.php" class="home"></a> <em class="eleft"><?php echo $textsname ?></em> <a href="#" onclick="$('#wrapper .rightmenu').toggle(300)" class="siteMap"></a><a href="#" onClick="SearchToggle(this)" class="search"></a> <a href="<?php echo $phpstart ?>_add.php?id=<?php echo $id ?>" class="add"></a> </div>
    <div class="topsearchmenu">
        ...
        <tm class='right' onclick='SearchGet("list","0","<?php echo $phpstart ?>","<?php echo $id ?>")'><i class='fa fa-search2'></i></tm>
    </div>
    <!--  编辑菜单头部  
    ...
    <div class="rightmenu">
        <ul>
            ...
            !-->
            <li><a href="<?php echo $phpstart ?>_huis.php?id=<?php echo $id ?>">
                <tm>03</tm>
...
<script type='text/JavaScript'>
	...
	SearchGet('list','0','<?php echo $phpstart ?>','<?php echo $id ?>');
});
</script>