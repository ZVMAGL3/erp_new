...
if ( $act == 'add_mobile' ) { //当接收到处理指令时
    ...
    if ( $sys_GuoChengMingChen . '1' == '1' ) {
        ...
        if ( $record_count > 0 ) { //有重复值时
            ...
            $sys_postzd_list = "$colsname,sys_id_standard,sys_huis,sys_id_login,sys_login,sys_yfzuid,sys_id_fz,bumen_id,sys_adddate"; //加上系统默认值
            $sys_postvalue_list = "'$sys_GuoChengMingChen','$sys_id_standard','0','$bh','$SYS_UserName','$hy','$sys_id_fz','$bumen_id','$nowdata'";
