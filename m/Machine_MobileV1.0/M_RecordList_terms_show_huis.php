...
<body>
<div id="wrapper">
    <div id="header"> <a href="<?php echo $phpstart ?>.php?parent_id=<?php echo $parent_id ?>&id=<?php echo $id ?>" class="home"></a> <em class="eleft"><?php echo $textsname ?> [回收站]</em> <a href="#" onclick="$('#wrapper .rightmenu').toggle(300)" class="siteMap"></a><a href="#" onClick="SearchToggle(this)" class="search"></a> </div>
    <div class="topsearchmenu">
        ...
        <tm class='right' onclick='SearchGet("list","1","<?php echo $phpstart ?>","<?php echo $id ?>","<?php echo $parent_id ?>")'><i class='fa fa-search2'></i></tm>
    </div>
    <div class="rightmenu">
        <ul>
    ...
    <div  class="foot topedit_menu_foot" style="height: 55px;line-height: 55px;">
        ...
        <li class='widd' onclick='DelToHuishou_mobile("dels_huis","<?php echo $tablename  ?>","1","<?php echo $phpstart ?>","<?php echo $id ?>")'><a href="#" class="menu site8">恢复</a></li>
        <!--  批量编辑菜单底部  ！-->
        <li class='widd' onclick='DelToHuishou_mobile("dels_true","<?php echo $tablename  ?>","1","<?php echo $phpstart ?>,"<?php echo $id ?>")'><a href="#" class="menu site9">彻删</a></li>
...
<script type='text/JavaScript'>
	...
	SearchGet('list','1','<?php echo $phpstart ?>','<?php echo $id ?>','<?php echo $parent_id ?>');
});
</script>