...
if ( $act == 'add_mobile' ) { //当接收到处理指令时
    ...
    if ( $name . '1' == '1' ) {
        ...
        $sql = $rs = $record_count = '';
        $sql = "select id,$colsname From `$tablename` where $colsname='$name' and sys_yfzuid='$hy' order by id Asc";
        //echo $sql.'_'; 
        ...
        <div id='mobanaddbox' class='NowULTable nocopytext' style='text-align:right;width:100%;margin-top: 100px;margin-bottom: 90px;'>
            ...
            <ul>
                ...
                <li class='cols02'>
                    ...
                    echo( "<select name='bumen'  class='addboxinput inputfocus' style='width:93%;padding:0;margin:0;'>" );
