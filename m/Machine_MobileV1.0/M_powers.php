...
//---------------------------------------------------------------------得到职位名称
$sql = $rs = $listdata = '';
$sql = "select id,zu From `msc_zhiwei` where id='$id'  order by id Asc";
...
<body>
<div id="wrapper">
    <div id="header"> <a href="M_ZhiQuan.php" class="home"></a> <em class="eleft">职权:<?php echo $zu ?>-><?php echo $textsname ?></em> <a href="#" onclick="$('#wrapper .rightmenu').toggle(300)" class="siteMap"></a><a href="#" onClick="SearchToggle(this)" class="search"></a> </div>
