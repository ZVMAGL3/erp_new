...
<body>
<div id="wrapper">
    <div id="header"> <a href="<?php echo $phpstart ?>.php?id=<?php echo $id ?>" class="home"></a> <em class="eleft"><?php echo $textsname ?> [回收站]</em> <a href="#" onclick="$('#wrapper .rightmenu').toggle(300)" class="siteMap"></a><a href="#" onClick="SearchToggle(this)" class="search"></a> </div>
    <div class="topsearchmenu">
        ...
        <tm class='right' onclick='SearchGet("list","1","<?php echo $phpstart ?>","<?php echo $id ?>")'><i class='fa fa-search2'></i></tm>
    </div>
    <div class="rightmenu">
        <ul>
...
<script type='text/JavaScript'>
	...
	SearchGet('list','1','<?php echo $phpstart ?>','<?php echo $id ?>');
});
</script>