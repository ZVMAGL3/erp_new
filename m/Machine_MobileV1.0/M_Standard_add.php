...
if ( $act == 'add_mobile' ) { //当接收到处理指令时
    ...
    if ( isset( $_POST[ 'number' ] ) )$number = $_POST[ 'number' ]; //标准编号
    ...
    if ( $name . '1' == '1' ) {
        ...
        $sql = $rs = $record_count = '';
        $sql = "select id,$colsname,sys_beizhu From `$tablename` where ($colsname='$name' or number='$number') and sys_yfzuid='$hy' order by id Asc";
        //echo $sql.'_'; 
        ...
        if ( $record_count > 0 ) { //有重复值时
            ...
            $sys_postzd_list = "$colsname,number,sys_beizhu,sys_huis,sys_id_login,sys_login,sys_yfzuid,sys_id_fz,sys_id_bumen,sys_adddate"; //加上系统默认值
            $sys_postvalue_list = "'$name','$number','$sys_beizhu','0','$bh','$SYS_UserName','$hy','$const_id_fz','$const_id_bumen','$nowdata'";
    ...
    <form autocomplete='off' οnsubmit='return false' οnkeydοwn="if(event.keyCode==13){return false;}">
        <div id='mobanaddbox' class='NowULTable nocopytext' style='text-align:right;width:100%;margin-top: 75px;margin-bottom: 90px;'>
            ...
            <ul>
                ...
                <li class='cols02'>
                    <input type='text' typeid='1' name='number' id='number'  class='addboxinput inputfocus'  value='<?php echo $number ?>'  style='width:90%' />
            ...
            <ul>
                ...
                <li class='cols02'>
                    <input type='text' typeid='1' name='name' id='name' class='addboxinput inputfocus'  value='<?php echo $name ?>'  style='width:90%' />
                    <div class='cols03 font_red yanzheng' id='name_bitian'></div>
                </li>
            </ul>
            ...
            <ul>
                ...
                <li class='cols02'>
                    <textarea name="sys_beizhu" class='addboxinput inputfocus' style="width: 90%;height: 150px"><?php echo $sys_beizhu ?></textarea>
            ...
            <ul>
                <li class='cols01'> &nbsp;</li>
                <li class='cols02'>
                    <input id='reset_add' type='reset' value='重填' tabindex=-1 style='width:50px;margin-left: 2px;' class='button button_reset' onclick=inputfocusfirst('#mobanaddbox','number') >
