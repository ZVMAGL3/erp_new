...
<body>
<div id="wrapper">
    <div id="header"> <a href="M_set.php" class="home"></a> <em class="eleft"><?php echo $textsname ?></em> <a href="#" onclick="$('#wrapper .rightmenu').toggle(300)" class="siteMap"></a><a href="#" onClick="SearchToggle(this)" class="search"></a> <a href="<?php echo $phpstart ?>_add.php" class="add"></a> </div>
