...
<body>
<div id="wrapper">
    <div id="header"> <a href="M_Template_terms.php?id=<?php echo $parent_id ?>" class="home"></a> <em class="eleft"><?php echo $textsname ?></em> <a href="#" onclick="$('#wrapper .rightmenu').toggle(300)" class="siteMap"></a><a href="#" onClick="SearchToggle(this)" class="search"></a> <a href="<?php echo $phpstart ?>_add.php?parent_id=<?php echo $parent_id ?>" class="add"></a> </div>
...
<script type='text/JavaScript'>
	...
	SearchGet('list','0','<?php echo $phpstart ?>','','<?php echo $parent_id ?>');
});
</script>