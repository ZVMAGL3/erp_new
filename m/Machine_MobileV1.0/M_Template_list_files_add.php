...
if ( $act == 'add_mobile' ) { //当接收到处理指令时
    ...
    if ( $sys_keyword_cn . '1' == '1' ) {
        ...
        if ( $record_count > 0 ) { //有重复值时
            ...
            $sys_postzd_list = "$colsname,sys_Id_MenuBigClass,sys_keyword_en,sys_huis,sys_id_login,sys_login,sys_yfzuid,sys_id_fz,bumen_id,sys_adddate"; //加上系统默认值
            $sys_postvalue_list = "'$sys_keyword_cn','$sys_Id_MenuBigClass','$sys_keyword_en','0','$bh','$SYS_UserName','$hy','$sys_id_fz','$bumen_id','$nowdata'";
    ...
    <form autocomplete='off' οnsubmit='return false' οnkeydοwn="if(event.keyCode==13){return false;}">
        <div id='mobanaddbox' class='NowULTable nocopytext' style='text-align:right;width:100%;margin-top: 75px;margin-bottom: 90px;'>
            ...
            <ul>
                ...
                <li class='cols02'>
                    <input type='text' typeid='1' name='sys_keyword_cn' id='sys_keyword_cn' class='addboxinput inputfocus'  onkeyup='chanshu_pinyin_mobile(this,"<?php echo $parent_id ?>")' value='<?php echo $sys_keyword_cn ?>'  style='width:90%' />
            ...
            <ul>
                ...
                <li class='cols02'>
                    <input type='text' typeid='1' name='sys_keyword_en' id='sys_keyword_en' class='addboxinput inputfocus'  value='<?php echo $sys_keyword_en ?>'  style='width:90%' readonly />
            ...
            <ul style="display: none">
                ...
                <li class='cols02'>
                    <input type='text' typeid='1' name='sys_Id_MenuBigClass' id='sys_Id_MenuBigClass' class='addboxinput inputfocus'  value='<?php echo $parent_id ?>'  style='width:90%' />
            ...
            <ul>
                <li class='cols01'> &nbsp;</li>
                <li class='cols02'>
                    <input id='reset_add' type='reset' value='重填' tabindex=-1 style='width:50px;margin-left: 2px;' class='button button_reset' onclick=inputfocusfirst('#mobanaddbox','sys_keyword_cn') >
                    <input id='SYS_submit' value='提交' type='button' title='Ctrl+Enter提交' class='button button_ADD' style='width:100px'   onclick="add_edit_mobile(this,'<?php echo $phpstart ?>_add.php','add_mobile','<?php echo $phpstart ?>.php?parent_id=<?php echo $parent_id ?>')"    />
