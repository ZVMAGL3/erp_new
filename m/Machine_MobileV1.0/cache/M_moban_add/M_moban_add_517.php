...
<ul>
  ...
  <input id='SYS_submit' value='提交' type='button' title='Ctrl+Enter提交' class='button button_ADD' style='width:88%'  SYS_Company_id='' strmk_id='' firstinputname='id' bitian_Arry='' databiao='msc_RenZhengMoBan' Wuchongfu_Arry='' onclick=data_add_arrys(this,'#addbox','DeskMenuDiv517')   onkeydown="EnterPress(event,this,this.click)" />
  ...
  <font id='editsuccess' class='font_red'></font></li>
		...
		<div id='clonecopy2'>&nbsp;</div><script>YanZhen_ChongFu_ZuLoad(0,'','msc_RenZhengMoBan','DeskMenuDiv517');form_add_copy('DeskMenuDiv517');inputfocusfirst('#addbox .htmlleirong','id');</script>
