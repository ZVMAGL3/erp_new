...
<ul>
  ...
  <input id='SYS_submit' value='提交' type='button' title='Ctrl+Enter提交' class='button button_ADD' style='width:88%'  SYS_Company_id='' strmk_id='' firstinputname='id' bitian_Arry='' databiao='SQP_ChuChaShiJianHuiZong' Wuchongfu_Arry='' onclick=data_add_arrys(this,'#addbox','DeskMenuDiv505')   onkeydown="EnterPress(event,this,this.click)" />
