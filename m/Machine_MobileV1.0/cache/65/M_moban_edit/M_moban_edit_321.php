...
echo"<ul><li class='cols01'><font color='red' class='s_bt'>*</font>&nbsp;<font color='red'>[验重]</font>&nbsp;公司名称:</li>
...
echo"<ul><li class='cols01'><font color='red' class='s_bt'>*</font>&nbsp;负责人:</li>
               <li class='cols02 reset_list'><input type='text' typeid='1' name='ZD_FuZeRen' id='ZD_FuZeRen' class='addboxinput inputfocus'  value='$row[ZD_FuZeRen]'  style='width:100%'   />
			   <div class='cols03 font_red yanzheng' id='ZD_FuZeRen_bitian'></div>
			   </li>
			   </ul>";
echo"<ul><li class='cols01'>意向服务:</li>
               <li class='cols02 reset_list'><input type='text' typeid='1' name='ZD_YiXiangFuWu' id='ZD_YiXiangFuWu' class='addboxinput inputfocus'  value='$row[ZD_YiXiangFuWu]'  style='width:100%'   />
			   <div class='cols03 font_red yanzheng' id='ZD_YiXiangFuWu_bitian'></div>
			   </li>
			   </ul>";
echo"<ul><li class='cols01'>项目经理:</li>
               <li class='cols02 reset_list'><input type='text' typeid='1' name='XiangMuJingLi' id='XiangMuJingLi' class='addboxinput inputfocus'  value='$row[XiangMuJingLi]'  style='width:100%'   />
			   <div class='cols03 font_red yanzheng' id='XiangMuJingLi_bitian'></div>
			   </li>
			   </ul>";
echo"<ul><li class='cols01'>成交项目:</li>
               <li class='cols02 reset_list'><input type='text' typeid='1' name='ZD_ChengJiaoXiangMu' id='ZD_ChengJiaoXiangMu' class='addboxinput inputfocus'  value='$row[ZD_ChengJiaoXiangMu]'  style='width:100%'   />
			   <div class='cols03 font_red yanzheng' id='ZD_ChengJiaoXiangMu_bitian'></div>
			   </li>
			   </ul>";
echo"<ul><li class='cols01'>等级:</li>
               <li class='cols02 reset_list'><input type='text' typeid='1' name='ZD_DengJi' id='ZD_DengJi' class='addboxinput inputfocus'  value='$row[ZD_DengJi]'  style='width:100%'   />
...
echo"<ul><li class='cols01'>报价附件:</li>
               <li class='cols02 reset_list'><input type='text' typeid='6' name='ZD_BaoJiaFuJian' id='ZD_BaoJiaFuJian' tidno='321_ZD_BaoJiaFuJian_$strmk_id' class='addboxinput inputfocus' value='' style='display:none;width:100%'   />
	    <div id='ZD_BaoJiaFuJian_panel_1' style='height:auto; width:auto; float:left; overflow:hidden;'><div id='ZD_BaoJiaFuJian_weizhi_1' style=' text-align:center; background-color:#FFF; height:76px; width:76px; color:#333; line-height:66px; text-align:center;border:1px solid #CCC;font-size:65px;margin:2px;float:left;'>+</div></div><script>createupload_jiaohu({'inputid':'ZD_BaoJiaFuJian','ToHtmlID':'DeskMenuDiv321'});</script>
			   <div class='cols03 font_red yanzheng' id='ZD_BaoJiaFuJian_bitian'></div>
			   </li>
			   </ul>";
echo"<ul><li class='cols01'>备注【企业工商信用等】:</li>
               <li class='cols02 reset_list'><textarea type='textarea' typeid='2' name='ZD_BeiZhuQiYeGongShangXinYongDeng' id='ZD_BeiZhuQiYeGongShangXinYongDeng' class='addboxinput inputfocus' style='width:100%;height:50px;'   >$row[ZD_BeiZhuQiYeGongShangXinYongDeng]</textarea>
...
echo"<ul><li class='cols01'><font color='red' class='s_bt'>*</font>&nbsp;电话:</li>
               <li class='cols02 reset_list'><input type='text' typeid='1' name='DianHua' id='DianHua' class='addboxinput inputfocus'  value='$row[DianHua]'  style='width:100%'   />
			   <div class='cols03 font_red yanzheng' id='DianHua_bitian'></div>
			   </li>
			   </ul>";
echo"<ul><li class='cols01'>生产产品:</li>
               <li class='cols02 reset_list'><input type='text' typeid='1' name='ShengChanChanPin' id='ShengChanChanPin' class='addboxinput inputfocus'  value='$row[ShengChanChanPin]'  style='width:100%'   />
			   <div class='cols03 font_red yanzheng' id='ShengChanChanPin_bitian'></div>
			   </li>
			   </ul>";
echo"<ul><li class='cols01'>地址:</li>
               <li class='cols02 reset_list'><input type='text' typeid='1' name='DiZhi' id='DiZhi' class='addboxinput inputfocus'  value='$row[DiZhi]'  style='width:100%'   />
			   <div class='cols03 font_red yanzheng' id='DiZhi_bitian'></div>
			   </li>
			   </ul>";
echo"<ul><li class='cols01'>分类:</li>
               <li class='cols02 reset_list'>
<label><input type='checkbox' typeid='15' name='sys_id_zu' id='sys_id_zu0' tit=' $row[sys_id_zu]' value='' class='addboxinput inputfocus' checked>&nbsp;所有分类&nbsp;</label><script>Inputdate('sys_id_zu','15','$row[sys_id_zu]','DeskMenuDiv321','');</script>
			   <div class='cols03 font_red yanzheng' id='sys_id_zu_bitian'></div>
			   </li>
			   </ul>";
echo"<ul><li class='cols01'>经办人:</li>
               <li class='cols02 reset_list'><input type='text' typeid='1' name='sys_chaosong' id='sys_chaosong' class='addboxinput inputfocus'  value='$row[sys_chaosong]'  style='width:100%'   />
			   <div class='cols03 font_red yanzheng' id='sys_chaosong_bitian'></div>
			   </li>
			   </ul>";
echo"<ul style='height:15px'><li style='width:98%'></li></ul>";
echo"<ul><li class='cols01'><i class='fa fa-sitting-ziduan' title='设定显示与锁定。' onClick=Table_Set_XianShi('DeskMenuDiv321',this) title='设定修改字段。'></i>&nbsp;</li><li  class='cols02'><input type='hidden' id='sys_postzd_list' name='sys_postzd_list' value='ZD_GongSiMingChen,ZD_FuZeRen,ZD_YiXiangFuWu,XiangMuJingLi,ZD_ChengJiaoXiangMu,ZD_DengJi,ZD_WeiXin,ZD_BaoJiaFuJianZD_BeiZhuQiYeGongShangXinYongDeng,XingBie,DianHua,ShengChanChanPin,DiZhi,sys_id_zu,sys_chaosong'/>";
