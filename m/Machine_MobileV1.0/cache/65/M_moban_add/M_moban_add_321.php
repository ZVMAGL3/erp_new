...
<form id='post_form' autocomplete='off' tit='' SYS_Company_id='65'><div id='mobanaddbox' class='NowULTable nocopytext' style='text-align:right;width:100%;'>
		                 ...
		                 <li class='cols02 reset_list'><input type='text' typeid='1' name='ZD_FuZeRen' id='ZD_FuZeRen' class='addboxinput inputfocus'  value='<?php echo $ZD_FuZeRen ?>'  style='width:100%'   />
		                 ...
		                 <li class='cols02 reset_list'><input type='text' typeid='1' name='ZD_YiXiangFuWu' id='ZD_YiXiangFuWu' class='addboxinput inputfocus'  value='<?php echo $ZD_YiXiangFuWu ?>'  style='width:100%'   />
		                 ...
		                 <li class='cols02 reset_list'><input type='text' typeid='1' name='XiangMuJingLi' id='XiangMuJingLi' class='addboxinput inputfocus'  value='<?php echo $XiangMuJingLi ?>'  style='width:100%'   />
		                 ...
		                 <li class='cols02 reset_list'><input type='text' typeid='1' name='ZD_ChengJiaoXiangMu' id='ZD_ChengJiaoXiangMu' class='addboxinput inputfocus'  value='<?php echo $ZD_ChengJiaoXiangMu ?>'  style='width:100%'   />
		                 ...
		                 <li class='cols02 reset_list'><input type='text' typeid='1' name='ZD_DengJi' id='ZD_DengJi' class='addboxinput inputfocus'  value='<?php echo $ZD_DengJi ?>'  style='width:100%'   />
		                 ...
		                 <li class='cols02 reset_list'><textarea type='textarea' typeid='2' name='ZD_BeiZhuQiYeGongShangXinYongDeng' id='ZD_BeiZhuQiYeGongShangXinYongDeng' class='addboxinput inputfocus' style='width:100%;height:50px;'   ><?php echo $ZD_BeiZhuQiYeGongShangXinYongDeng ?></textarea>
		                 ...
		                 <li class='cols02 reset_list'><input type='text' typeid='1' name='DianHua' id='DianHua' class='addboxinput inputfocus'  value='<?php echo $DianHua ?>'  style='width:100%'   />
		                 ...
		                 <li class='cols02 reset_list'><input type='text' typeid='1' name='ShengChanChanPin' id='ShengChanChanPin' class='addboxinput inputfocus'  value='<?php echo $ShengChanChanPin ?>'  style='width:100%'   />
		                 ...
		                 <li class='cols02 reset_list'><input type='text' typeid='1' name='DiZhi' id='DiZhi' class='addboxinput inputfocus'  value='<?php echo $DiZhi ?>'  style='width:100%'   />
...
<label><input type='checkbox' typeid='15' name='sys_id_zu' id='sys_id_zu0' tit=' <?php echo $sys_id_zu ?>' value='' class='addboxinput inputfocus' checked>&nbsp;所有分类&nbsp;</label><script>Inputdate('sys_id_zu','15','<?php echo $sys_id_zu ?>','DeskMenuDiv321','addbox');</script>
		                 ...
		                 <li class='cols02 reset_list'><input type='text' typeid='1' name='sys_chaosong' id='sys_chaosong' class='addboxinput inputfocus'  value='<?php echo $sys_chaosong ?>'  style='width:100%'   />
