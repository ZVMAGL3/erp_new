...
echo"<ul><li class='cols01'><font color='red' class='s_bt'>*</font>&nbsp;<font color='red'>[验重]</font>&nbsp;工号:</li>
               <li class='cols02 reset_list'><input type='text' typeid='1' name='SYS_GongHao' id='SYS_GongHao' class='addboxinput inputfocus'  value='$row[SYS_GongHao]'  style='width:100%'   />
			   <div class='cols03 font_red yanzheng' id='SYS_GongHao_bitian'></div>
			   </li>
			   </ul>";
echo"<ul><li class='cols01'><font color='red' class='s_bt'>*</font>&nbsp;姓名:</li>
               <li class='cols02 reset_list'><input type='text' typeid='1' name='SYS_UserName' id='SYS_UserName' class='addboxinput inputfocus'  value='$row[SYS_UserName]'  style='width:100%'   />
			   <div class='cols03 font_red yanzheng' id='SYS_UserName_bitian'></div>
			   </li>
			   </ul>";
echo"<ul><li class='cols01'>照片:</li>
               <li class='cols02 reset_list'><input type='text' typeid='6' name='ZD_ZhaoPian' id='ZD_ZhaoPian' tidno='204_ZD_ZhaoPian_$strmk_id' class='addboxinput inputfocus' value='' style='display:none;width:100%'   />
	    <div id='ZD_ZhaoPian_panel_1' style='height:auto; width:auto; float:left; overflow:hidden;'><div id='ZD_ZhaoPian_weizhi_1' style=' text-align:center; background-color:#FFF; height:76px; width:76px; color:#333; line-height:66px; text-align:center;border:1px solid #CCC;font-size:65px;margin:2px;float:left;'>+</div></div><script>createupload_jiaohu({'inputid':'ZD_ZhaoPian','ToHtmlID':'DeskMenuDiv204'});</script>
			   <div class='cols03 font_red yanzheng' id='ZD_ZhaoPian_bitian'></div>
			   </li>
			   </ul>";
echo"<ul><li class='cols01'>职位:</li>
               <li class='cols02 reset_list'><input type='text' typeid='1' name='SYS_QuanXian' id='SYS_QuanXian' class='addboxinput inputfocus'  value='$row[SYS_QuanXian]'  style='width:100%'   />
...
echo"<ul><li class='cols01'><font color='red' class='s_bt'>*</font>&nbsp;<font color='red'>[验重]</font>&nbsp;联系方式:</li>
               <li class='cols02 reset_list'><input type='text' typeid='1' name='SYS_ShouJi' id='SYS_ShouJi' class='addboxinput inputfocus'  value='$row[SYS_ShouJi]'  style='width:100%'   />
			   <div class='cols03 font_red yanzheng' id='SYS_ShouJi_bitian'></div>
			   </li>
			   </ul>";
echo"<ul><li class='cols01'>工资:</li>
               <li class='cols02 reset_list'><input type='text' typeid='1' name='GongZi' id='GongZi' class='addboxinput inputfocus'  value='$row[GongZi]'  style='width:100%'   />
			   <div class='cols03 font_red yanzheng' id='GongZi_bitian'></div>
			   </li>
			   </ul>";
echo"<ul><li class='cols01'>工资发放账户:</li>
               <li class='cols02 reset_list'><input type='text' typeid='1' name='ZD_GongZiFaFangZhangHu' id='ZD_GongZiFaFangZhangHu' class='addboxinput inputfocus'  value='$row[ZD_GongZiFaFangZhangHu]'  style='width:100%'   />
			   <div class='cols03 font_red yanzheng' id='ZD_GongZiFaFangZhangHu_bitian'></div>
			   </li>
			   </ul>";
echo"<ul><li class='cols01'>身份证:</li>
               <li class='cols02 reset_list'><input type='text' typeid='1' name='SYS_ShenFenZheng' id='SYS_ShenFenZheng' class='addboxinput inputfocus'  value='$row[SYS_ShenFenZheng]'  style='width:100%'   />
...
echo"<ul><li class='cols01'>邮箱:</li>
               <li class='cols02 reset_list'><input type='text' typeid='1' name='SYS_Email' id='SYS_Email' class='addboxinput inputfocus'  value='$row[SYS_Email]'  style='width:100%'   />
			   <div class='cols03 font_red yanzheng' id='SYS_Email_bitian'></div>
			   </li>
			   </ul>";
echo"<ul><li class='cols01'><font color='red' class='s_bt'>*</font>&nbsp;入职时间:</li>
               <li class='cols02 reset_list'><input type='text' typeid='8' name='SYS_StartDate' id='SYS_StartDate' class='addboxinput inputfocus' value='$row[SYS_StartDate]' style='width:100%'   /><a class='jia jiaok'  onclick=''><i class='fa fa-24-03'></i></a><script>laydate.render({  elem: '#SYS_StartDate',theme: '#393D49',lang: 'cn'});</script>
			   <div class='cols03 font_red yanzheng' id='SYS_StartDate_bitian'></div>
			   </li>
			   </ul>";
echo"<ul><li class='cols01'>离职时间:</li>
               <li class='cols02 reset_list'><input type='text' typeid='1' name='SYS_EndDate' id='SYS_EndDate' class='addboxinput inputfocus'  value='$row[SYS_EndDate]'  style='width:100%'   />
...
echo"<ul><li class='cols01'>证件:</li>
               <li class='cols02 reset_list'><input type='text' typeid='6' name='ZD_ZhengJian' id='ZD_ZhengJian' tidno='204_ZD_ZhengJian_$strmk_id' class='addboxinput inputfocus' value='' style='display:none;width:100%'   />
	    <div id='ZD_ZhengJian_panel_1' style='height:auto; width:auto; float:left; overflow:hidden;'><div id='ZD_ZhengJian_weizhi_1' style=' text-align:center; background-color:#FFF; height:76px; width:76px; color:#333; line-height:66px; text-align:center;border:1px solid #CCC;font-size:65px;margin:2px;float:left;'>+</div></div><script>createupload_jiaohu({'inputid':'ZD_ZhengJian','ToHtmlID':'DeskMenuDiv204'});</script>
			   <div class='cols03 font_red yanzheng' id='ZD_ZhengJian_bitian'></div>
			   </li>
			   </ul>";
echo"<ul style='height:15px'><li style='width:98%'></li></ul>";
echo"<ul><li class='cols01'><i class='fa fa-sitting-ziduan' title='设定显示与锁定。' onClick=Table_Set_XianShi('DeskMenuDiv204',this) title='设定修改字段。'></i>&nbsp;</li><li  class='cols02'><input type='hidden' id='sys_postzd_list' name='sys_postzd_list' value='SYS_GongHao,SYS_UserName,ZD_ZhaoPianSYS_QuanXian,XingBie,SYS_ShouJi,GongZi,ZD_GongZiFaFangZhangHu,SYS_ShenFenZheng,ZD_XianZhuDiZhi,QQ,SYS_Email,SYS_StartDate,SYS_EndDate,zzzt,ZD_HunYinZhuangTai,ZD_ZhengJian'/>";
if ( $const_q_xiug >= 0 ) { //有修改权限时
    ...
    echo"<input id='SYS_submit' value='确定修改' title='&nbsp;Ctrl+Enter提交&nbsp;' type='button' class='button button_ADD'  SYS_Company_id='$SYS_Company_id'  firstinputname='id' bitian_Arry='SYS_GongHao,SYS_UserNameSYS_ShouJi,SYS_StartDate,zzzt'  Wuchongfu_Arry='SYS_GongHaoSYS_ShouJi'  onclick=data_edit_arrys(this,'#post_form','DeskMenuDiv204')  style='width:85%'  />";
}else{
    echo"<input value='复制添加' tabindex=-1 title='&nbsp;复制该条修改后快速添加&nbsp;' type='button' class='button button_reset' style='width:15%;border-right:0px solid #333' onclick=loodfoot(1,'DeskMenuDiv204','.sett',$strmk_id); />";
    echo"<input id='SYS_submit' value='确定修改' title='&nbsp;Ctrl+Enter提交&nbsp;' type='button' class='button button_ADD'  SYS_Company_id='$SYS_Company_id'  firstinputname='id' bitian_Arry='SYS_GongHao,SYS_UserNameSYS_ShouJi,SYS_StartDate,zzzt'  Wuchongfu_Arry='SYS_GongHaoSYS_ShouJi'  onclick=alert('您无修改权限')  style='width:85%'  />";
};
...
<A  onClick=SelectTag_Menu('DeskMenuDiv204_MenuDiv_506',this,'DeskMenuDiv204','41',$strmk_id)>工资汇总表</A>
