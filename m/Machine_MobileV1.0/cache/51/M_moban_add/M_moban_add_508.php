...
<form id='post_form' autocomplete='off' tit='' SYS_Company_id='51'><div id='mobanaddbox' class='NowULTable nocopytext' style='text-align:right;width:100%;'>
	                     ...
	                     <ul>
		                 <li class='cols01'>共计:</li>
		                 <li class='cols02 reset_list'><input type='text' typeid='1' name='ZD_GongJi' id='ZD_GongJi' class='addboxinput inputfocus'  value='<?php echo $ZD_GongJi ?>'  style='width:100%'   />
...
<ul>
  <li class='cols01'><i class='fa fa-sitting-ziduan'  onClick='Table_Set_XianShi('DeskMenuDiv508',this)' title='设定添加字段。'/>&nbsp;</li>
  <li class='cols02'>
  ...
  <font id='editsuccess' class='font_red'></font></li>
        ...
        ?>
		<input type='hidden' name='re_id' id='re_id' value='508' />
		
		</div>
		</form>
		<div id='clonecopy2'>&nbsp;</div><script>YanZhen_ChongFu_ZuLoad(0,'','SQP_QingJiaShiJianHuiZong','DeskMenuDiv508');form_add_copy('DeskMenuDiv508');inputfocusfirst('#addbox .htmlleirong','sys_nowbh');</script>
