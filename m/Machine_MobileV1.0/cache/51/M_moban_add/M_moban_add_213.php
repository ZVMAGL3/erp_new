...
<form id='post_form' autocomplete='off' tit='' SYS_Company_id='51'><div id='mobanaddbox' class='NowULTable nocopytext' style='text-align:right;width:100%;'>
		                 ...
		                 <li class='cols02 reset_list'><input type='text' typeid='1' name='SheBeiMingChen' id='SheBeiMingChen' class='addboxinput inputfocus'  value='<?php echo $SheBeiMingChen ?>'  style='width:100%'   />
		                 ...
		                 <li class='cols02 reset_list'><input type='text' typeid='1' name='XingHaoGuiGe' id='XingHaoGuiGe' class='addboxinput inputfocus'  value='<?php echo $XingHaoGuiGe ?>'  style='width:100%'   />
		                 ...
		                 <li class='cols02 reset_list'><input type='text' typeid='1' name='ZhiZaoChangShang' id='ZhiZaoChangShang' class='addboxinput inputfocus'  value='<?php echo $ZhiZaoChangShang ?>'  style='width:100%'   />
		                 ...
		                 <li class='cols02 reset_list'><input type='text' typeid='1' name='ChuChangBianHao' id='ChuChangBianHao' class='addboxinput inputfocus'  value='<?php echo $ChuChangBianHao ?>'  style='width:100%'   />
		                 <div class='cols03 font_red yanzheng' id='ChuChangBianHao_bitian'></div>
						 </li>
		                 </ul>

	                     <ul>
		                 <li class='cols01'>所属部门:</li>
		                 <li class='cols02 reset_list'><input type='text' typeid='1' name='SuoShuBuMen' id='SuoShuBuMen' class='addboxinput inputfocus'  value='<?php echo $SuoShuBuMen ?>'  style='width:100%'   />
		                 <div class='cols03 font_red yanzheng' id='SuoShuBuMen_bitian'></div>
						 </li>
		                 </ul>

	                     <ul>
		                 <li class='cols01'>使用日期:</li>
		                 <li class='cols02 reset_list'><input type='text' typeid='1' name='ShiYongRiQi' id='ShiYongRiQi' class='addboxinput inputfocus'  value='<?php echo $ShiYongRiQi ?>'  style='width:100%'   />
		                 ...
		                 <li class='cols02 reset_list'><input type='text' typeid='1' name='BeiZhu' id='BeiZhu' class='addboxinput inputfocus'  value='<?php echo $BeiZhu ?>'  style='width:100%'   />
...
<ul>
  <li class='cols01'><i class='fa fa-sitting-ziduan'  onClick='Table_Set_XianShi('DeskMenuDiv213',this)' title='设定添加字段。'/>&nbsp;</li>
  <li class='cols02'>
  ...
  <font id='editsuccess' class='font_red'></font></li>
        ...
        ?>
		<input type='hidden' name='re_id' id='re_id' value='213' />
		
		</div>
		</form>
		<div id='clonecopy2'>&nbsp;</div><script>YanZhen_ChongFu_ZuLoad(0,'','SQP_JiChuSheShiGuanLiTaiZhang','DeskMenuDiv213');form_add_copy('DeskMenuDiv213');inputfocusfirst('#addbox .htmlleirong','id');</script>
