...
<ul>
  <li class='cols01'><i class='fa fa-sitting-ziduan'  onClick='Table_Set_XianShi('DeskMenuDiv513',this)' title='设定添加字段。'/>&nbsp;</li>
  <li class='cols02'>
  ...
  <input id='SYS_submit' value='提交' type='button' title='Ctrl+Enter提交' class='button button_ADD' style='width:88%'  SYS_Company_id='51' strmk_id='' firstinputname='id' bitian_Arry='' databiao='sys_JiangFaJiLu' Wuchongfu_Arry='' onclick=data_add_arrys(this,'#addbox','DeskMenuDiv513')   onkeydown="EnterPress(event,this,this.click)" />
  ...
  <font id='editsuccess' class='font_red'></font></li>
        ...
        ?>
		<input type='hidden' name='re_id' id='re_id' value='513' />
		
		</div>
		</form>
		<div id='clonecopy2'>&nbsp;</div><script>YanZhen_ChongFu_ZuLoad(0,'','sys_JiangFaJiLu','DeskMenuDiv513');form_add_copy('DeskMenuDiv513');inputfocusfirst('#addbox .htmlleirong','id');</script>
