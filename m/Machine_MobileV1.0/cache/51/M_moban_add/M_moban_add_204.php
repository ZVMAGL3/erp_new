...
<form id='post_form' autocomplete='off' tit='' SYS_Company_id='51'><div id='mobanaddbox' class='NowULTable nocopytext' style='text-align:right;width:100%;'>
		                 ...
		                 <li class='cols02 reset_list'><input type='text' typeid='1' name='GongZi' id='GongZi' class='addboxinput inputfocus' value='<?php echo $GongZi ?>'   />
		                 ...
		                 <li class='cols02 reset_list'><input type='text' typeid='1' name='ZD_GongZiFaFangZhangHu' id='ZD_GongZiFaFangZhangHu' class='addboxinput inputfocus' value='<?php echo $ZD_GongZiFaFangZhangHu ?>'   />
		                 ...
		                 <li class='cols02 reset_list'><input type='text' typeid='1' name='ZD_XianZhuDiZhi' id='ZD_XianZhuDiZhi' class='addboxinput inputfocus' value='<?php echo $ZD_XianZhuDiZhi ?>'   />
		                 ...
		                 <li class='cols02 reset_list'><input type='text' typeid='1' name='QQ' id='QQ' class='addboxinput inputfocus' value='<?php echo $QQ ?>'   />
		                 ...
		                 <li class='cols02 reset_list'><input type='text' typeid='8' name='SYS_StartDate' id='SYS_StartDate' class='addboxinput inputfocus' value='<?php echo $SYS_StartDate ?>'   /><a class='jia jiaok'  onclick=''><i class='fa fa-24-03'></i></a><script>laydate.render({  elem: '#SYS_StartDate',theme: '#393D49',lang: 'cn'});</script>
...
<ul>
  ...
  <input type='hidden' id='sys_postzd_list' name='sys_postzd_list' value='SYS_UserName,XingBie,SYS_GongHao,SYS_QuanXian,SYS_ShouJi,GongZi,ZD_GongZiFaFangZhangHu,SYS_ShenFenZheng,ZD_XianZhuDiZhi,QQ,SYS_Email,SYS_StartDate,SYS_EndDate,zzzt,ZD_HunYinZhuangTai'/>
