...
<form id='post_form' autocomplete='off' tit='' SYS_Company_id='51'><div id='mobanaddbox' class='NowULTable nocopytext' style='text-align:right;width:100%;'>
	                     ...
	                     <ul>
		                 <li class='cols01'>共计（天）:</li>
		                 <li class='cols02 reset_list'><input type='text' typeid='1' name='ZD_GongJiTian' id='ZD_GongJiTian' class='addboxinput inputfocus'  value='<?php echo $ZD_GongJiTian ?>'  style='width:100%'   />
...
<ul>
  <li class='cols01'><i class='fa fa-sitting-ziduan'  onClick='Table_Set_XianShi('DeskMenuDiv505',this)' title='设定添加字段。'/>&nbsp;</li>
  <li class='cols02'>
  ...
  <input id='SYS_submit' value='提交' type='button' title='Ctrl+Enter提交' class='button button_ADD' style='width:88%'  SYS_Company_id='51' strmk_id='' firstinputname='id' bitian_Arry='' databiao='SQP_ChuChaShiJianHuiZong' Wuchongfu_Arry='' onclick=data_add_arrys(this,'#addbox','DeskMenuDiv505')   onkeydown="EnterPress(event,this,this.click)" />
  ...
  <font id='editsuccess' class='font_red'></font></li>
        ...
        ?>
		<input type='hidden' name='re_id' id='re_id' value='505' />
		
		</div>
		</form>
		<div id='clonecopy2'>&nbsp;</div><script>YanZhen_ChongFu_ZuLoad(0,'','SQP_ChuChaShiJianHuiZong','DeskMenuDiv505');form_add_copy('DeskMenuDiv505');inputfocusfirst('#addbox .htmlleirong','id');</script>
