...
<ul>
  <li class='cols01'><i class='fa fa-sitting-ziduan'  onClick='Table_Set_XianShi('DeskMenuDiv385',this)' title='设定添加字段。'/>&nbsp;</li>
  <li class='cols02'>
  ...
  <font id='editsuccess' class='font_red'></font></li>
        ...
        ?>
		<input type='hidden' name='re_id' id='re_id' value='385' />
		
		</div>
		</form>
		<div id='clonecopy2'>&nbsp;</div><script>YanZhen_ChongFu_ZuLoad(0,'','SQP_TeZhongSheBeiJianYanBaoGao','DeskMenuDiv385');form_add_copy('DeskMenuDiv385');inputfocusfirst('#addbox .htmlleirong','id');</script>
