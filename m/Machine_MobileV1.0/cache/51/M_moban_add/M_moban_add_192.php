...
<ul>
  <li class='cols01'><i class='fa fa-sitting-ziduan'  onClick='Table_Set_XianShi('DeskMenuDiv192',this)' title='设定添加字段。'/>&nbsp;</li>
  <li class='cols02'>
  ...
  <input id='SYS_submit' value='提交' type='button' title='Ctrl+Enter提交' class='button button_ADD' style='width:88%'  SYS_Company_id='51' strmk_id='' firstinputname='id' bitian_Arry='' databiao='SQP_YuanGongManYiDuDiaoChaJiHua' Wuchongfu_Arry='' onclick=data_add_arrys(this,'#addbox','DeskMenuDiv192')   onkeydown="EnterPress(event,this,this.click)" />
  ...
  <font id='editsuccess' class='font_red'></font></li>
        ...
        ?>
		<input type='hidden' name='re_id' id='re_id' value='192' />
		
		</div>
		</form>
		<div id='clonecopy2'>&nbsp;</div><script>YanZhen_ChongFu_ZuLoad(0,'','SQP_YuanGongManYiDuDiaoChaJiHua','DeskMenuDiv192');form_add_copy('DeskMenuDiv192');inputfocusfirst('#addbox .htmlleirong','id');</script>
