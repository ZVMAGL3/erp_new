...
$const_shaixuan="";
$SYS_ALL_ziduan_list="id,SYS_YongHuMing,SYS_ShouJi,SYS_PC_Mobile,sys_id_login,sys_shenpi_all";
$xianshi_ZD_num="3";
$xianshi_KD_num="1788";
$shuoding_num_list="";
	   $maxrecord="15";
...
if ( "1" . $databiao == "1" ) {
   ...
   if ( !$sql_all_id_list ) {
      ...
      $sql = "select  id,SYS_YongHuMing,SYS_ShouJi,SYS_PC_Mobile,sys_id_login,sys_shenpi_all  from `msc_yonghudenglujilu` where id in($sql_all_id_list) and sys_yfzuid='$hy' and sys_huis='$huis'";
      ...
      while ( $row = mysqli_fetch_array( $rs ) ) {
        ...
        if ( $const_q_cak >= 0 or $now_id_login == $bh ) {
            ...
            $tdqaqclass = "tdsclass" . $i;
              ...
              echo("<font  style=width:125px class='F_M_XS_1 ET_SYS_YongHuMing$now_id'>".DeleteHtml($row['SYS_YongHuMing'])."&nbsp;</font>");
              echo("<font  style=width:150px class='F_M_XS_1 ET_SYS_ShouJi$now_id'>".DeleteHtml($row['SYS_ShouJi'])."&nbsp;</font>");
              echo("<font  style=width:109px class='F_M_XS_1 ET_SYS_PC_Mobile$now_id'>".DeleteHtml($row['SYS_PC_Mobile'])."&nbsp;</font>");
              echo("</a>");
              echo("</li>");
   ...
   echo '<script>$("#loadingtimes").html("'.$ymdate.'ms");list_data_end_mobile("'.$sys_const_pagetype.'","DeskMenuDiv463");</script>';
};
