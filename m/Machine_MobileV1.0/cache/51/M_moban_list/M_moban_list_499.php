...
$const_shaixuan="";
$SYS_ALL_ziduan_list="id,ZD_GongSiMingChen,sys_id_login,sys_shenpi_all";
$xianshi_ZD_num="1";
$xianshi_KD_num="1810";
$shuoding_num_list="";
	   $maxrecord="20";
...
if ( "1" . $databiao == "1" ) {
   ...
   if ( !$sql_all_id_list ) {
      ...
      $sql = "select  id,ZD_GongSiMingChen,sys_id_login,sys_shenpi_all  from `SQP_HeTongXiangMuGenZongJiLu` where id in($sql_all_id_list) and sys_yfzuid='$hy' and sys_huis='$huis'";
   ...
   echo '<script>$("#loadingtimes").html("'.$ymdate.'ms");list_data_end_mobile("'.$sys_const_pagetype.'","DeskMenuDiv499");</script>';
};
