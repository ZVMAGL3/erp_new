...
global $const_q_cak,$ToHtmlID,$const_q_shanc,$const_q_xiug,$nowkeyword,$px_ziduan,$pxv,$Conn,$hy;
	...
	$SYS_ALL_ziduan_list="id,sys_nowbh,ZD_BeiZhuQiYeGongShangXinYongDeng,ZD_GongSiMingChen,ZD_FuZeRen,ZD_YiXiangFuWu,XiangMuJingLi,ZD_ChengJiaoXiangMu,ZD_DengJi,DianHua,ShengChanChanPin,DiZhi,sys_id_zu,sys_chaosong,sys_count_510,ZD_WeiXin,ZD_BaoJiaFuJian,sys_id_login,sys_shenpi_all";
	$xianshi_ZD_num="16";
	$xianshi_KD_num="2474";
	$shuoding_num="10";
	$maxrecord="20";
...
if ( "1" . $databiao == "1" ) {
   ...
   if ( !$sql_all_id_list ) {
      ...
      $sql = "select  id,sys_nowbh,ZD_BeiZhuQiYeGongShangXinYongDeng,ZD_GongSiMingChen,ZD_FuZeRen,ZD_YiXiangFuWu,XiangMuJingLi,ZD_ChengJiaoXiangMu,ZD_DengJi,DianHua,ShengChanChanPin,DiZhi,sys_id_zu,sys_chaosong,sys_count_510,ZD_WeiXin,ZD_BaoJiaFuJian,sys_id_login,sys_shenpi_all  from `sys_gukedanganbiao` where id in($sql_all_id_list) and sys_yfzuid='$hy' and sys_huis='$huis'";
      $sql .= " order by $px_ziduan $pxv";
      $rs = mysqli_query( $Conn, $sql );
      echo( "<div id='para'  tabindex='-1' class='tables'  style='border:0;border-bottom:1px solid #CCC;min-width:100%;width: 2474px'>" );
	      ...
	      if ( $const_q_cak >= 0 or $now_id_login == $bh ) {
			...
			//}
			echo( "  style='height:" . $r_cow_height . "px;line-height:" . $r_cow_height . "px;min-width:100%;width:2474px'> " );
