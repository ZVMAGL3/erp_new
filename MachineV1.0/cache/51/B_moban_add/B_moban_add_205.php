<?php
		...
		$Table_name="SQP_YuanGongManYiDuDiaoChaHeQuShiFenXiBiao";
		$sys_re_id_02="205";
		$getdate=getdate();
...
if ( strpos($const_q_tianj, "205") !== false  ) { //有添加权限时
       echo"<ul>
		...
		echo"<input type='hidden' name='re_id' id='re_id' value='205' />
		
		</div>
		</form>
		<div id='clonecopy2'>&nbsp;</div><script>YanZhen_ChongFu_ZuLoad(0,'','SQP_YuanGongManYiDuDiaoChaHeQuShiFenXiBiao','$ToHtmlID');form_add_copy('$ToHtmlID');inputfocusfirst('#".$ToHtmlID."_content_foot .htmlleirong','id');form_weikong('#post_form','DeskMenuDiv205');</script>";
