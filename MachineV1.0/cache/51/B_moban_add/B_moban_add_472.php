<?php
		...
		$sys_gx_id_190=$row["sys_gx_id_190"];
...
echo"
	                         <ul zd='sys_gx_id_190'>
		                        <li style='text-align:right;width:220px'>[关系]总过程清单ID:</li>
                                
		                        <li style='width:40%' class='reset_list'><input type='text' typeid='1' name='sys_gx_id_190' id='sys_gx_id_190' class='addboxinput inputfocus' value='$sys_gx_id_190'   /></li>
								
		                        <li style='text-align:left;width:30%' class='font_red yanzheng' id='sys_gx_id_190_bitian'></li>
                                <script> GuanXiFillInput('sys_gx_id_190','58','SQP_APQP','DeskMenuDiv472');</script>
		                     </ul>
	                         
";
echo"</span>";
echo"<ul style='height:15px;'><li style='width:98%'></li></ul>";
if ( strpos($const_q_tianj, "472") !== false  ) { //有添加权限时
       echo"<ul>
          ...
          <input type='hidden' id='sys_postzd_list' name='sys_postzd_list' value='sys_gx_id_190'/>
  
          <input id='SYS_submit' value='提交' type='button' title='Ctrl+Enter提交' class='button button_ADD' style='width:90%'  SYS_Company_id='51' strmk_id='' firstinputname='id' bitian_Arry='' databiao='SQP_APQP' Wuchongfu_Arry=''  onclick=data_add_arrys(this,'#post_form','$ToHtmlID')   onkeydown='EnterPress(event,this,this.click)' />
  
          <font id='editsuccess' class='font_red'></font></li>
        </ul>";
}
		echo"<input type='hidden' name='re_id' id='re_id' value='472' />
		
		</div>
		</form>
		<div id='clonecopy2'>&nbsp;</div><script>YanZhen_ChongFu_ZuLoad(0,'','SQP_APQP','$ToHtmlID');form_add_copy('$ToHtmlID');inputfocusfirst('#".$ToHtmlID."_content_foot .htmlleirong','id');form_weikong('#post_form','DeskMenuDiv472');</script>";
