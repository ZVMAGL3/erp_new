...
echo"
	                         <ul zd='sys_card'>
		                        ...
		                        <li style='width:40%' class='reset_list'><input type='text' typeid='1' name='sys_card' id='sys_card' class='addboxinput inputfocus'  value='$sys_card'  style='width:100%'   /></li>
...
echo"
	                         <ul zd='mdb_name_SYS'>
		                        ...
		                        <li style='width:40%' class='reset_list'><input type='text' typeid='1' name='mdb_name_SYS' id='mdb_name_SYS' class='addboxinput inputfocus'  value='$mdb_name_SYS'  style='width:100%'   /></li>
...
echo"
	                         <ul zd='Id_MenuBigClass'>
		                        ...
		                        <li style='width:40%' class='reset_list'><input type='text' typeid='1' name='Id_MenuBigClass' id='Id_MenuBigClass' class='addboxinput inputfocus'  value='$Id_MenuBigClass'  style='width:100%'   /></li>
...
echo"
	                         <ul zd='banben'>
		                        ...
		                        <li style='width:40%' class='reset_list'><input type='text' typeid='1' name='banben' id='banben' class='addboxinput inputfocus'  value='$banben'  style='width:100%'   /></li>
...
echo"
	                         <ul zd='xiugaicishu'>
		                        ...
		                        <li style='width:40%' class='reset_list'><input type='text' typeid='1' name='xiugaicishu' id='xiugaicishu' class='addboxinput inputfocus'  value='$xiugaicishu'  style='width:100%'   /></li>
...
echo"
	                         <ul zd='ul_row_height'>
		                        ...
		                        <li style='width:40%' class='reset_list'><input type='text' typeid='1' name='ul_row_height' id='ul_row_height' class='addboxinput inputfocus'  value='$ul_row_height'  style='width:100%'   /></li>
...
if ( strpos($const_q_tianj, "262") !== false  ) { //有添加权限时
       echo"<ul>
		...
		echo"<input type='hidden' name='re_id' id='re_id' value='262' />
		
		</div>
		</form>
		<div id='clonecopy2'>&nbsp;</div><script>YanZhen_ChongFu_ZuLoad(0,'','sys_jlmb','$ToHtmlID');form_add_copy('$ToHtmlID');inputfocusfirst('#".$ToHtmlID."_content_foot .htmlleirong','sys_nowbh');form_weikong('#post_form','DeskMenuDiv262');</script>";
