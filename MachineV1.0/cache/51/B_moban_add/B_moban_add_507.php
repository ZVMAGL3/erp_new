<?php
		...
		$Table_name="SQP_JiaBanDiaoXiuShiJianHuiZong";
		$sys_re_id_02="507";
		$getdate=getdate();
...
echo"
	                         <ul zd='ZD_HeJiShiJian'>
		                        ...
		                        <li style='width:40%' class='reset_list'><input type='text' typeid='1' name='ZD_HeJiShiJian' id='ZD_HeJiShiJian' class='addboxinput inputfocus'  value='$ZD_HeJiShiJian'  style='width:100%'   /></li>
...
echo"
	                         <ul zd='ZD_DiaoXiuShiJian'>
		                        ...
		                        <li style='width:40%' class='reset_list'><input type='text' typeid='1' name='ZD_DiaoXiuShiJian' id='ZD_DiaoXiuShiJian' class='addboxinput inputfocus'  value='$ZD_DiaoXiuShiJian'  style='width:100%'   /></li>
...
echo"
	                         <ul zd='ZD_ShiJiJiaBanShiJian'>
		                        ...
		                        <li style='width:40%' class='reset_list'><input type='text' typeid='1' name='ZD_ShiJiJiaBanShiJian' id='ZD_ShiJiJiaBanShiJian' class='addboxinput inputfocus'  value='$ZD_ShiJiJiaBanShiJian'  style='width:100%'   /></li>
...
echo"
	                         <ul zd='ZD_JiaBanGongZi'>
		                        ...
		                        <li style='width:40%' class='reset_list'><input type='text' typeid='1' name='ZD_JiaBanGongZi' id='ZD_JiaBanGongZi' class='addboxinput inputfocus'  value='$ZD_JiaBanGongZi'  style='width:100%'   /></li>
...
if ( strpos($const_q_tianj, "507") !== false  ) { //有添加权限时
       echo"<ul>
		...
		echo"<input type='hidden' name='re_id' id='re_id' value='507' />
		
		</div>
		</form>
		<div id='clonecopy2'>&nbsp;</div><script>YanZhen_ChongFu_ZuLoad(0,'','SQP_JiaBanDiaoXiuShiJianHuiZong','$ToHtmlID');form_add_copy('$ToHtmlID');inputfocusfirst('#".$ToHtmlID."_content_foot .htmlleirong','sys_nowbh');form_weikong('#post_form','DeskMenuDiv507');</script>";
