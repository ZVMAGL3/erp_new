<?php
		...
		$ZD_LianJie=$row["ZD_LianJie"];
		$ZD_WenJianMingChen=$row["ZD_WenJianMingChen"];
...
echo"
	                         <ul zd='ZD_WenJianMingChen'>
		                        ...
		                        <li style='width:40%' class='reset_list'><input type='text' typeid='1' name='ZD_WenJianMingChen' id='ZD_WenJianMingChen' class='addboxinput inputfocus'  value='$ZD_WenJianMingChen'  style='width:100%'   /></li>
...
echo"
	                         <ul zd='ZD_LianJie'>
		                        <li style='text-align:right;width:220px'>链接:</li>
                                
		                        <li style='width:40%' class='reset_list'><input type='text' typeid='1' name='ZD_LianJie' id='ZD_LianJie' class='addboxinput inputfocus'  value='$ZD_LianJie'  style='width:100%'   /></li>
								
		                        <li style='text-align:left;width:30%' class='font_red yanzheng' id='ZD_LianJie_bitian'></li>
...
echo"
	                         <ul zd='sys_gx_id_198'>
                                ...
                                <script> GuanXiFillInput('sys_gx_id_198','48','SQP_ZhengCeFaGui','DeskMenuDiv512');</script>
		                     </ul>
	                         
";
echo"</span>";
echo"<ul style='height:15px;'><li style='width:98%'></li></ul>";
if ( strpos($const_q_tianj, "512") !== false  ) { //有添加权限时
       echo"<ul>
          ...
          <input type='hidden' id='sys_postzd_list' name='sys_postzd_list' value='ZD_LianJie,ZD_WenJianMingChen,sys_gx_id_198'/>
  
          <input id='SYS_submit' value='提交' type='button' title='Ctrl+Enter提交' class='button button_ADD' style='width:90%'  SYS_Company_id='51' strmk_id='' firstinputname='id' bitian_Arry='' databiao='SQP_ZhengCeFaGui' Wuchongfu_Arry=''  onclick=data_add_arrys(this,'#post_form','$ToHtmlID')   onkeydown='EnterPress(event,this,this.click)' />
  
          <font id='editsuccess' class='font_red'></font></li>
        </ul>";
}
		echo"<input type='hidden' name='re_id' id='re_id' value='512' />
		
		</div>
		</form>
		<div id='clonecopy2'>&nbsp;</div><script>YanZhen_ChongFu_ZuLoad(0,'','SQP_ZhengCeFaGui','$ToHtmlID');form_add_copy('$ToHtmlID');inputfocusfirst('#".$ToHtmlID."_content_foot .htmlleirong','id');form_weikong('#post_form','DeskMenuDiv512');</script>";
