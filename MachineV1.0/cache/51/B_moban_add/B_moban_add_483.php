<?php
		...
		$Table_name="SQP_TuiHuoFenXiChuLiDan";
		$sys_re_id_02="483";
		$getdate=getdate();
		...
		$sys_gx_id_302=$row["sys_gx_id_302"];
...
echo"
	                         <ul zd='sys_gx_id_302'>
		                        <li style='text-align:right;width:220px'>[关系]凭证统计ID:</li>
                                
		                        <li style='width:40%' class='reset_list'><input type='text' typeid='1' name='sys_gx_id_302' id='sys_gx_id_302' class='addboxinput inputfocus' value='$sys_gx_id_302'   /></li>
								
		                        <li style='text-align:left;width:30%' class='font_red yanzheng' id='sys_gx_id_302_bitian'></li>
...
if ( strpos($const_q_tianj, "483") !== false  ) { //有添加权限时
       echo"<ul>
          ...
          <input type='hidden' id='sys_postzd_list' name='sys_postzd_list' value='sys_gx_id_302'/>
  
          <input id='SYS_submit' value='提交' type='button' title='Ctrl+Enter提交' class='button button_ADD' style='width:90%'  SYS_Company_id='51' strmk_id='' firstinputname='id' bitian_Arry='' databiao='SQP_TuiHuoFenXiChuLiDan' Wuchongfu_Arry=''  onclick=data_add_arrys(this,'#post_form','$ToHtmlID')   onkeydown='EnterPress(event,this,this.click)' />
  
          <font id='editsuccess' class='font_red'></font></li>
        </ul>";
}
		echo"<input type='hidden' name='re_id' id='re_id' value='483' />
		
		</div>
		</form>
		<div id='clonecopy2'>&nbsp;</div><script>YanZhen_ChongFu_ZuLoad(0,'','SQP_TuiHuoFenXiChuLiDan','$ToHtmlID');form_add_copy('$ToHtmlID');inputfocusfirst('#".$ToHtmlID."_content_foot .htmlleirong','id');form_weikong('#post_form','DeskMenuDiv483');</script>";
