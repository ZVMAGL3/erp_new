<?php
		...
		$Table_name="SQP_XiaoFangSheShiGuanLiTaiZhang";
		$sys_re_id_02="491";
		$getdate=getdate();
...
if ( strpos($const_q_tianj, "491") !== false  ) { //有添加权限时
       echo"<ul>
		...
		echo"<input type='hidden' name='re_id' id='re_id' value='491' />
		
		</div>
		</form>
		<div id='clonecopy2'>&nbsp;</div><script>YanZhen_ChongFu_ZuLoad(0,'','SQP_XiaoFangSheShiGuanLiTaiZhang','$ToHtmlID');form_add_copy('$ToHtmlID');inputfocusfirst('#".$ToHtmlID."_content_foot .htmlleirong','id');form_weikong('#post_form','DeskMenuDiv491');</script>";
