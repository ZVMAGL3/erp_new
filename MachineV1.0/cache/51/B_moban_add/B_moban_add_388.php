...
echo"
	                         <ul zd='lname1'>
		                        <li style='text-align:right;width:220px'>分类名称:</li>
                                
		                        <li style='width:40%' class='reset_list'><input type='text' typeid='1' name='lname1' id='lname1' class='addboxinput inputfocus'  value='$lname1'  style='width:100%'   /></li>
								
		                        <li style='text-align:left;width:30%' class='font_red yanzheng' id='lname1_bitian'></li>
...
echo"
	                         <ul zd='tableid'>
		                        <li style='text-align:right;width:220px'>表ID:</li>
                                
		                        <li style='width:40%' class='reset_list'><input type='text' typeid='1' name='tableid' id='tableid' class='addboxinput inputfocus'  value='$tableid'  style='width:100%'   /></li>
								
		                        <li style='text-align:left;width:30%' class='font_red yanzheng' id='tableid_bitian'></li>
...
echo"
	                         <ul zd='sys_paixu'>
		                        ...
		                        <li style='width:40%' class='reset_list'><input type='text' typeid='1' name='sys_paixu' id='sys_paixu' class='addboxinput inputfocus'  value='$sys_paixu'  style='width:100%'   /></li>
...
if ( strpos($const_q_tianj, "388") !== false  ) { //有添加权限时
       echo"<ul>
          ...
          <input type='hidden' id='sys_postzd_list' name='sys_postzd_list' value='lname1,tableid,sys_paixu'/>
  
          <input id='SYS_submit' value='提交' type='button' title='Ctrl+Enter提交' class='button button_ADD' style='width:90%'  SYS_Company_id='51' strmk_id='' firstinputname='id' bitian_Arry='' databiao='sys_zuall' Wuchongfu_Arry=''  onclick=data_add_arrys(this,'#post_form','$ToHtmlID')   onkeydown='EnterPress(event,this,this.click)' />
  
          <font id='editsuccess' class='font_red'></font></li>
        </ul>";
}
		echo"<input type='hidden' name='re_id' id='re_id' value='388' />
		
		</div>
		</form>
		<div id='clonecopy2'>&nbsp;</div><script>YanZhen_ChongFu_ZuLoad(0,'','sys_zuall','$ToHtmlID');form_add_copy('$ToHtmlID');inputfocusfirst('#".$ToHtmlID."_content_foot .htmlleirong','id');form_weikong('#post_form','DeskMenuDiv388');</script>";
