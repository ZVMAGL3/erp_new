...
include_once "{$_SERVER['PATH_TRANSLATED']}/inc/Sub_All.php";
		...
		//--------------------------------------以下为查询到表的信息
	    $sql = "select sys_zt,sys_zt_bianhao From `sys_jlmb` where sys_yfzuid='$hy' and mdb_name_SYS='SQP_ChuChaShiJianHuiZong' ";
	    //echo $sql;
	    ...
	    //--------------------------------------以下为查询到自动编号
	    $sql = "select MAX(sys_bh) AS sys_bh From `SQP_ChuChaShiJianHuiZong` where sys_yfzuid='$hy' and sys_zt='$r_zt' and sys_zt_bianhao='$r_zt_bianhao' ";
	    //echo $sql;
	    $rs = mysqli_query(  $Conn , $sql );
	    $row = mysqli_fetch_array( $rs );
		$maxbh=$row[ "sys_bh" ];
		...
		//--------------------------------------以下为得交数据
		$sql = "insert into  `SQP_ChuChaShiJianHuiZong`  (ZD_XingMing,ZD_NianFen,ZD_1Ri,ZD_2Ri,ZD_3Ri,ZD_4Ri,ZD_5Ri,ZD_6Ri,ZD_7Ri,ZD_8Ri,ZD_9Ri,ZD_10Ri,ZD_11Ri,ZD_12Ri,ZD_13Ri,ZD_14Ri,ZD_15Ri,ZD_16Ri,ZD_17Ri,ZD_18Ri,ZD_19Ri,ZD_20Ri,ZD_21Ri,ZD_22Ri,ZD_23Ri,ZD_24Ri,ZD_25Ri,ZD_26Ri,ZD_27Ri,ZD_28Ri,ZD_29Ri,ZD_30Ri,ZD_31Ri,ZD_GongJiTian,ZD_ChuChaBuTie,ZD_BeiZhu,sys_nowbh,sys_bh,sys_zt,sys_zt_bianhao,sys_huis,sys_id_login,sys_login,sys_yfzuid,sys_id_fz,sys_id_bumen,sys_adddate) values ('$ZD_XingMing','$ZD_NianFen','$ZD_1Ri','$ZD_2Ri','$ZD_3Ri','$ZD_4Ri','$ZD_5Ri','$ZD_6Ri','$ZD_7Ri','$ZD_8Ri','$ZD_9Ri','$ZD_10Ri','$ZD_11Ri','$ZD_12Ri','$ZD_13Ri','$ZD_14Ri','$ZD_15Ri','$ZD_16Ri','$ZD_17Ri','$ZD_18Ri','$ZD_19Ri','$ZD_20Ri','$ZD_21Ri','$ZD_22Ri','$ZD_23Ri','$ZD_24Ri','$ZD_25Ri','$ZD_26Ri','$ZD_27Ri','$ZD_28Ri','$ZD_29Ri','$ZD_30Ri','$ZD_31Ri','$ZD_GongJiTian','$ZD_ChuChaBuTie','$ZD_BeiZhu','$nowbh','$bh_y','$r_zt','$r_zt_bianhao','0','$bh','$SYS_UserName','$hy','$const_id_fz','$const_id_bumen','$nowdata')";
		mysqli_query( $Conn,$sql );
		echo "<script></script>";
		//--------------------------------------以下为查询数据
		$sql = "select id From `SQP_ChuChaShiJianHuiZong` where   ZD_XingMing='$ZD_XingMing' and ZD_NianFen='$ZD_NianFen' and ZD_1Ri='$ZD_1Ri' and ZD_2Ri='$ZD_2Ri' and ZD_3Ri='$ZD_3Ri' and ZD_4Ri='$ZD_4Ri' and ZD_5Ri='$ZD_5Ri' and ZD_6Ri='$ZD_6Ri' and ZD_7Ri='$ZD_7Ri' and ZD_8Ri='$ZD_8Ri' and ZD_9Ri='$ZD_9Ri' and ZD_10Ri='$ZD_10Ri' and ZD_11Ri='$ZD_11Ri' and ZD_12Ri='$ZD_12Ri' and ZD_13Ri='$ZD_13Ri' and ZD_14Ri='$ZD_14Ri' and ZD_15Ri='$ZD_15Ri' and ZD_16Ri='$ZD_16Ri' and ZD_17Ri='$ZD_17Ri' and ZD_18Ri='$ZD_18Ri' and ZD_19Ri='$ZD_19Ri' and ZD_20Ri='$ZD_20Ri' and ZD_21Ri='$ZD_21Ri' and ZD_22Ri='$ZD_22Ri' and ZD_23Ri='$ZD_23Ri' and ZD_24Ri='$ZD_24Ri' and ZD_25Ri='$ZD_25Ri' and ZD_26Ri='$ZD_26Ri' and ZD_27Ri='$ZD_27Ri' and ZD_28Ri='$ZD_28Ri' and ZD_29Ri='$ZD_29Ri' and ZD_30Ri='$ZD_30Ri' and ZD_31Ri='$ZD_31Ri' and ZD_GongJiTian='$ZD_GongJiTian' and ZD_ChuChaBuTie='$ZD_ChuChaBuTie' and ZD_BeiZhu='$ZD_BeiZhu'   order by `id` desc";
	    //echo $sql;
	    $rs = mysqli_query(  $Conn , $sql );
	    if ( $rs ) {
		   $row = mysqli_fetch_array( $rs );
        ...
        if($sys_editcontent!=''){
	        ...
	        $sys_postvalue_list = "'505','$nowid','$sys_editcontent'";		
	        Jilu_add_Modular( 'sys_xiuguaijilu', $sys_postzd_list, $sys_postvalue_list); //添加数据 并生成添加的id
	        LiYi_Add(505,$nowid,534,'+');       //利益函数 这里奖励货币
        }
