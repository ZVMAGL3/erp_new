...
if ( $const_q_xiug >= 0 ) { //有修改权限时
    ...
    //-----------------------------------------------------------查询原记录
    $sql2 = "select * From  `SQP_JiaBanDiaoXiuShiJianHuiZong`  where `id`='$strmk_id'";
    ...
    $Y_ZD_HeJiShiJian=$row2['ZD_HeJiShiJian'];
    $Y_ZD_DiaoXiuShiJian=$row2['ZD_DiaoXiuShiJian'];
    $Y_ZD_ShiJiJiaBanShiJian=$row2['ZD_ShiJiJiaBanShiJian'];
    $Y_ZD_JiaBanGongZi=$row2['ZD_JiaBanGongZi'];
	...
	//-----------------------------------------------------------更新记录
	$sql = "UPDATE  `SQP_JiaBanDiaoXiuShiJianHuiZong`  set `ZD_XingMing`='$ZD_XingMing',`ZD_NianFen`='$ZD_NianFen',`ZD_1Ri`='$ZD_1Ri',`ZD_2Ri`='$ZD_2Ri',`ZD_3Ri`='$ZD_3Ri',`ZD_4Ri`='$ZD_4Ri',`ZD_5Ri`='$ZD_5Ri',`ZD_6Ri`='$ZD_6Ri',`ZD_7Ri`='$ZD_7Ri',`ZD_8Ri`='$ZD_8Ri',`ZD_9Ri`='$ZD_9Ri',`ZD_10Ri`='$ZD_10Ri',`ZD_11Ri`='$ZD_11Ri',`ZD_12Ri`='$ZD_12Ri',`ZD_13Ri`='$ZD_13Ri',`ZD_14Ri`='$ZD_14Ri',`ZD_15Ri`='$ZD_15Ri',`ZD_16Ri`='$ZD_16Ri',`ZD_17Ri`='$ZD_17Ri',`ZD_18Ri`='$ZD_18Ri',`ZD_19Ri`='$ZD_19Ri',`ZD_20Ri`='$ZD_20Ri',`ZD_21Ri`='$ZD_21Ri',`ZD_22Ri`='$ZD_22Ri',`ZD_23Ri`='$ZD_23Ri',`ZD_24Ri`='$ZD_24Ri',`ZD_25Ri`='$ZD_25Ri',`ZD_26Ri`='$ZD_26Ri',`ZD_27Ri`='$ZD_27Ri',`ZD_28Ri`='$ZD_28Ri',`ZD_29Ri`='$ZD_29Ri',`ZD_30Ri`='$ZD_30Ri',`ZD_31Ri`='$ZD_31Ri',`ZD_HeJiShiJian`='$ZD_HeJiShiJian',`ZD_DiaoXiuShiJian`='$ZD_DiaoXiuShiJian',`ZD_ShiJiJiaBanShiJian`='$ZD_ShiJiJiaBanShiJian',`ZD_JiaBanGongZi`='$ZD_JiaBanGongZi',`ZD_BeiZhu`='$ZD_BeiZhu',`sys_adddate_g`='$nowdates' where `id`='$strmk_id'";
	...
	if($Y_ZD_HeJiShiJian!=$ZD_HeJiShiJian){
		$sys_editcontent.='合计时间:  '.$Y_ZD_HeJiShiJian.'=>'.$ZD_HeJiShiJian.';</br>';
	};
	if($Y_ZD_DiaoXiuShiJian!=$ZD_DiaoXiuShiJian){
		$sys_editcontent.='调休时间:  '.$Y_ZD_DiaoXiuShiJian.'=>'.$ZD_DiaoXiuShiJian.';</br>';
	};
	if($Y_ZD_ShiJiJiaBanShiJian!=$ZD_ShiJiJiaBanShiJian){
		$sys_editcontent.='实际加班时间:  '.$Y_ZD_ShiJiJiaBanShiJian.'=>'.$ZD_ShiJiJiaBanShiJian.';</br>';
	};
	if($Y_ZD_JiaBanGongZi!=$ZD_JiaBanGongZi){
		$sys_editcontent.='加班工资:  '.$Y_ZD_JiaBanGongZi.'=>'.$ZD_JiaBanGongZi.';</br>';
	};
...
if($sys_editcontent!=''){
	...
	$sys_postvalue_list = "'507','$strmk_id','$sys_editcontent'";		
	Jilu_add_Modular( 'sys_xiuguaijilu', $sys_postzd_list, $sys_postvalue_list); //添加数据 并生成添加的id
	LiYi_Add(507,$strmk_id,535,'+');       //利益函数 这里奖励货币
}


    Sys_XuanYongMoban(507,$strmk_id);//利益函数 这里奖励货币 
