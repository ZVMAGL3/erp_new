...
echo"
	                         <ul zd='title'>
		                        ...
		                        <li style='width:40%' class='reset_list'><input type='text' typeid='1' name='title' id='title' class='addboxinput inputfocus'  value='$row[title]'  style='width:100%'   /></li>
...
echo"
	                         <ul zd='path'>
		                        ...
		                        <li style='width:40%' class='reset_list'><input type='text' typeid='1' name='path' id='path' class='addboxinput inputfocus'  value='$row[path]'  style='width:100%'   /></li>
...
echo"
	                         <ul zd='src'>
		                        ...
		                        <li style='width:40%' class='reset_list'><input type='text' typeid='1' name='src' id='src' class='addboxinput inputfocus'  value='$row[src]'  style='width:100%'   /></li>
...
echo"<ul><li style='width:220px;text-align:right;'><i class='fa fa-sitting-ziduan' title='设定显示与锁定。' onClick=Table_Set_XianShi('$ToHtmlID',this) title='设定修改字段。'></i>&nbsp;</li><li style='width:40%;text-align:left;padding-left:2px;'><input type='hidden' id='sys_postzd_list' name='sys_postzd_list' value='title,path,src'/>";
if ( strpos($const_q_xiug, "391") !== false ) { //有修改权限时
...
echo"</form>";
echo"<script>guanximenucopy('$ToHtmlID');YanZhen_ChongFu_ZuLoad('$strmk_id','','sys_file','$ToHtmlID');inputfocusfirst('#$ToHtmlID  #content_foot .htmlleirong','id');</script>
<div class='moban_set_menu'>
<A class='selectTag' onClick=SelectTag_Menu('tagContent',this,'$ToHtmlID')>编辑</A>
<A title='修改记录'  onClick=SelectTag_Menu('DeskMenuDiv391_MenuDiv_368',this,'$ToHtmlID','368',$strmk_id)>E+</A>
</div>
