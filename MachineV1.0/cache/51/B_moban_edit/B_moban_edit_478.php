<?php
	    ...
	    $zu_all_list="";
	    $sql = 'select * From `SQP_QuanChiCunQuanGongNenJianChaBaoGao` where `id`='.$strmk_id;
...
echo"
	                         <ul zd='sys_gx_id_198'>
                                ...
                                <script> GuanXiFillInput('sys_gx_id_198','48','SQP_QuanChiCunQuanGongNenJianChaBaoGao','DeskMenuDiv478');</script>
		                     </ul>
...
if ( strpos($const_q_xiug, "478") !== false ) { //有修改权限时
...
echo"<input type='hidden' name='re_id' value='478' />";
echo"<input type='hidden' name='strmk_id' value='$strmk_id'/>";
echo"<font id='editsuccess' class='font_red'></font></li></ul></br></br></div>";
echo"</form>";
echo"<script>guanximenucopy('$ToHtmlID');YanZhen_ChongFu_ZuLoad('$strmk_id','','SQP_QuanChiCunQuanGongNenJianChaBaoGao','$ToHtmlID');inputfocusfirst('#$ToHtmlID  #content_foot .htmlleirong','id');</script>
<div class='moban_set_menu'>
<A class='selectTag' onClick=SelectTag_Menu('tagContent',this,'$ToHtmlID')>编辑</A>
<A title='修改记录'  onClick=SelectTag_Menu('DeskMenuDiv478_MenuDiv_368',this,'$ToHtmlID','368',$strmk_id)>E+</A>
</div>
