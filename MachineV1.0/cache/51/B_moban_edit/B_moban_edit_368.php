...
echo"
	                         <ul zd='sys_re_id'>
		                        <li style='text-align:right;width:220px'>对应表id:</li>
                                
		                        <li style='width:40%' class='reset_list'><input type='text' typeid='1' name='sys_re_id' id='sys_re_id' class='addboxinput inputfocus' value='$row[sys_re_id]'   /></li>
								
		                        <li style='text-align:left;width:30%' class='font_red yanzheng' id='sys_re_id_bitian'></li>
...
echo"
	                         <ul zd='sys_edit_id'>
		                        <li style='text-align:right;width:220px'>记录ID:</li>
                                
		                        <li style='width:40%' class='reset_list'><input type='text' typeid='1' name='sys_edit_id' id='sys_edit_id' class='addboxinput inputfocus' value='$row[sys_edit_id]'   /></li>
								
		                        <li style='text-align:left;width:30%' class='font_red yanzheng' id='sys_edit_id_bitian'></li>
                                
		                     </ul>
	                         
";
echo"
	                         <ul zd='sys_editcontent'>
		                        <li style='text-align:right;width:220px'>修改内容:</li>
                                
		                        <li style='width:40%' class='reset_list'><input type='text' typeid='1' name='sys_editcontent' id='sys_editcontent' class='addboxinput inputfocus' value='$row[sys_editcontent]'   /></li>
								
		                        <li style='text-align:left;width:30%' class='font_red yanzheng' id='sys_editcontent_bitian'></li>
...
echo"<ul><li style='width:220px;text-align:right;'><i class='fa fa-sitting-ziduan' title='设定显示与锁定。' onClick=Table_Set_XianShi('$ToHtmlID',this) title='设定修改字段。'></i>&nbsp;</li><li style='width:40%;text-align:left;padding-left:2px;'><input type='hidden' id='sys_postzd_list' name='sys_postzd_list' value='sys_re_id,sys_edit_id,sys_editcontent'/>";
if ( strpos($const_q_xiug, "368") !== false ) { //有修改权限时
...
echo"</form>";
echo"<script>guanximenucopy('$ToHtmlID');YanZhen_ChongFu_ZuLoad('$strmk_id','','sys_xiuguaijilu','$ToHtmlID');inputfocusfirst('#$ToHtmlID  #content_foot .htmlleirong','id');</script>
<div class='moban_set_menu'>
<A class='selectTag' onClick=SelectTag_Menu('tagContent',this,'$ToHtmlID')>编辑</A>
<A title='修改记录'  onClick=SelectTag_Menu('DeskMenuDiv368_MenuDiv_368',this,'$ToHtmlID','368',$strmk_id)>E+</A>
</div>
