...
echo"
	                         <ul zd='user_id'>
		                        ...
		                        <li style='width:40%' class='reset_list'><input type='text' typeid='1' name='user_id' id='user_id' class='addboxinput inputfocus' value='$row[user_id]'   /></li>
...
echo"
	                         <ul zd='state'>
		                        ...
		                        <li style='width:40%' class='reset_list'><input type='text' typeid='1' name='state' id='state' class='addboxinput inputfocus' value='$row[state]'   /></li>
...
echo"
	                         <ul zd='zhiwei_id'>
		                        ...
		                        <li style='width:40%' class='reset_list'><input type='text' typeid='1' name='zhiwei_id' id='zhiwei_id' class='addboxinput inputfocus' value='$row[zhiwei_id]'   /></li>
...
echo"
	                         <ul zd='add_time'>
		                        ...
		                        <li style='width:40%' class='reset_list'><input type='text' typeid='9' name='add_time' id='add_time' class='addboxinput inputfocus' value='$row[add_time]'    /><a class='jia jiaok'  onclick=''><i class='fa fa-25-03'></i></a><script>laydate.render({  elem: '#add_time',theme: '#393D49',type: 'datetime',lang: 'cn'});</script></li>
...
echo"
	                         <ul zd='new_time'>
		                        ...
		                        <li style='width:40%' class='reset_list'><input type='text' typeid='9' name='new_time' id='new_time' class='addboxinput inputfocus' value='$row[new_time]'    /><a class='jia jiaok'  onclick=''><i class='fa fa-25-03'></i></a><script>laydate.render({  elem: '#new_time',theme: '#393D49',type: 'datetime',lang: 'cn'});</script></li>
...
echo"
	                         <ul zd='Remark'>
		                        ...
		                        <li style='width:40%' class='reset_list'><input type='text' typeid='1' name='Remark' id='Remark' class='addboxinput inputfocus' value='$row[Remark]'   /></li>
...
echo"<ul><li style='width:220px;text-align:right;'><i class='fa fa-sitting-ziduan' title='设定显示与锁定。' onClick=Table_Set_XianShi('$ToHtmlID',this) title='设定修改字段。'></i>&nbsp;</li><li style='width:40%;text-align:left;padding-left:2px;'><input type='hidden' id='sys_postzd_list' name='sys_postzd_list' value='user_id,state,SYS_GongHao,zhiwei_id,add_time,new_time,Remark'/>";
if ( strpos($const_q_xiug, "529") !== false ) { //有修改权限时
...
echo"</form>";
echo"<script>guanximenucopy('$ToHtmlID');YanZhen_ChongFu_ZuLoad('$strmk_id','','msc_user_hy','$ToHtmlID');inputfocusfirst('#$ToHtmlID  #content_foot .htmlleirong','id');</script>
<div class='moban_set_menu'>
<A class='selectTag' onClick=SelectTag_Menu('tagContent',this,'$ToHtmlID')>编辑</A>
<A title='修改记录'  onClick=SelectTag_Menu('DeskMenuDiv529_MenuDiv_368',this,'$ToHtmlID','368',$strmk_id)>E+</A>
</div>
