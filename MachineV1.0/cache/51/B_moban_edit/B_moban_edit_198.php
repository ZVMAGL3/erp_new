...
echo"
	                         <ul zd='sys_card'>
		                        ...
		                        <li style='width:40%' class='reset_list'><input type='text' typeid='1' name='sys_card' id='sys_card' class='addboxinput inputfocus' value='$row[sys_card]'   /></li>
...
echo"
	                         <ul zd='mdb_name_SYS'>
		                        ...
		                        <li style='width:40%' class='reset_list'><input type='text' typeid='1' name='mdb_name_SYS' id='mdb_name_SYS' class='addboxinput inputfocus' value='$row[mdb_name_SYS]'   /></li>
...
echo"
	                         <ul zd='Id_MenuBigClass'>
		                        ...
		                        <li style='width:40%' class='reset_list'><input type='text' typeid='1' name='Id_MenuBigClass' id='Id_MenuBigClass' class='addboxinput inputfocus' value='$row[Id_MenuBigClass]'   /></li>
...
echo"
	                         <ul zd='banben'>
		                        ...
		                        <li style='width:40%' class='reset_list'><input type='text' typeid='1' name='banben' id='banben' class='addboxinput inputfocus' value='$row[banben]'   /></li>
...
echo"
	                         <ul zd='xiugaicishu'>
		                        ...
		                        <li style='width:40%' class='reset_list'><input type='text' typeid='1' name='xiugaicishu' id='xiugaicishu' class='addboxinput inputfocus' value='$row[xiugaicishu]'   /></li>
...
echo"
	                         <ul zd='ul_row_height'>
		                        ...
		                        <li style='width:40%' class='reset_list'><input type='text' typeid='1' name='ul_row_height' id='ul_row_height' class='addboxinput inputfocus' value='$row[ul_row_height]'   /></li>
...
if ( strpos($const_q_xiug, "198") !== false ) { //有修改权限时
...
<A  onClick=SelectTag_Menu('DeskMenuDiv198_MenuDiv_254',this,'$ToHtmlID','48',$strmk_id)>锁定IP</A>
<A title='修改记录'  onClick=SelectTag_Menu('DeskMenuDiv198_MenuDiv_368',this,'$ToHtmlID','368',$strmk_id)>E+</A>
</div>
