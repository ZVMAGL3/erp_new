...
echo"
	                         <ul zd='ZD_WangZhanMingChen'>
		                        ...
		                        <li style='width:40%' class='reset_list'><input type='text' typeid='1' name='ZD_WangZhanMingChen' id='ZD_WangZhanMingChen' class='addboxinput inputfocus'  value='$row[ZD_WangZhanMingChen]'  style='width:100%'   /></li>
...
echo"
	                         <ul zd='ZD_WangZhi'>
		                        ...
		                        <li style='width:40%' class='reset_list'><textarea type='textarea' typeid='2' name='ZD_WangZhi' id='ZD_WangZhi' class='addboxinput inputfocus' style='width:100%;height:25px;'   >$row[ZD_WangZhi]</textarea></li>
...
echo"
	                         <ul zd='ZD_WangZhanZhangHaoMiMa'>
		                        ...
		                        <li style='width:40%' class='reset_list'><input type='text' typeid='1' name='ZD_WangZhanZhangHaoMiMa' id='ZD_WangZhanZhangHaoMiMa' class='addboxinput inputfocus'  value='$row[ZD_WangZhanZhangHaoMiMa]'  style='width:100%'   /></li>
...
echo"<ul><li style='width:220px;text-align:right;'><i class='fa fa-sitting-ziduan' title='设定显示与锁定。' onClick=Table_Set_XianShi('$ToHtmlID',this) title='设定修改字段。'></i>&nbsp;</li><li style='width:40%;text-align:left;padding-left:2px;'><input type='hidden' id='sys_postzd_list' name='sys_postzd_list' value='ZD_WangZhanMingChen,ZD_WangZhi,ZD_WangZhanZhangHaoMiMa,sys_gx_id_321,sys_gx_id_198'/>";
if ( strpos($const_q_xiug, "281") !== false ) { //有修改权限时
...
echo"</form>";
echo"<script>guanximenucopy('$ToHtmlID');YanZhen_ChongFu_ZuLoad('$strmk_id','','SQP_ChangYongWangZhi','$ToHtmlID');inputfocusfirst('#$ToHtmlID  #content_foot .htmlleirong','id');</script>
<div class='moban_set_menu'>
<A class='selectTag' onClick=SelectTag_Menu('tagContent',this,'$ToHtmlID')>编辑</A>
<A title='修改记录'  onClick=SelectTag_Menu('DeskMenuDiv281_MenuDiv_368',this,'$ToHtmlID','368',$strmk_id)>E+</A>
</div>
