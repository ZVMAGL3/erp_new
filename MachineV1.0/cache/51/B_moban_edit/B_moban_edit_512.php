...
echo"
	                         <ul zd='ZD_LianJie'>
		                        ...
		                        <li style='width:40%' class='reset_list'><input type='text' typeid='1' name='ZD_LianJie' id='ZD_LianJie' class='addboxinput inputfocus'  value='$row[ZD_LianJie]'  style='width:100%'   /></li>
...
echo"
	                         <ul zd='ZD_FuJian'>
		                        ...
		                        <li style='width:40%' class='reset_list'><input type='text' typeid='6' name='ZD_FuJian' id='ZD_FuJian' tidno='512_ZD_FuJian_$strmk_id' class='addboxinput inputfocus' value='' style='display:none;width:100%'   />
...
echo"<ul><li style='width:220px;text-align:right;'><i class='fa fa-sitting-ziduan' title='设定显示与锁定。' onClick=Table_Set_XianShi('$ToHtmlID',this) title='设定修改字段。'></i>&nbsp;</li><li style='width:40%;text-align:left;padding-left:2px;'><input type='hidden' id='sys_postzd_list' name='sys_postzd_list' value='ZD_LianJie,ZD_FuJian,ZD_WenJianMingChen,sys_gx_id_198'/>";
if ( strpos($const_q_xiug, "512") !== false ) { //有修改权限时
...
echo"</form>";
echo"<script>guanximenucopy('$ToHtmlID');YanZhen_ChongFu_ZuLoad('$strmk_id','','SQP_ZhengCeFaGui','$ToHtmlID');inputfocusfirst('#$ToHtmlID  #content_foot .htmlleirong','id');</script>
<div class='moban_set_menu'>
<A class='selectTag' onClick=SelectTag_Menu('tagContent',this,'$ToHtmlID')>编辑</A>
<A title='修改记录'  onClick=SelectTag_Menu('DeskMenuDiv512_MenuDiv_368',this,'$ToHtmlID','368',$strmk_id)>E+</A>
</div>
