...
echo"
	                         <ul zd='sys_gx_id_190'>
		                        ...
		                        <li style='width:40%' class='reset_list'><input type='text' typeid='1' name='sys_gx_id_190' id='sys_gx_id_190' class='addboxinput inputfocus'  value='$row[sys_gx_id_190]'  style='width:100%'   /></li>
...
if ( strpos($const_q_xiug, "287") !== false ) { //有修改权限时
...
echo"</form>";
echo"<script>guanximenucopy('$ToHtmlID');YanZhen_ChongFu_ZuLoad('$strmk_id','','SQP_ZhiLiangXieYi202008232114374213','$ToHtmlID');inputfocusfirst('#$ToHtmlID  #content_foot .htmlleirong','id');</script>
<div class='moban_set_menu'>
<A class='selectTag' onClick=SelectTag_Menu('tagContent',this,'$ToHtmlID')>编辑</A>
<A title='修改记录'  onClick=SelectTag_Menu('DeskMenuDiv287_MenuDiv_368',this,'$ToHtmlID','368',$strmk_id)>E+</A>
</div>
