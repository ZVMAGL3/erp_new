...
global $const_q_cak,$ToHtmlID,$const_q_shanc,$const_q_xiug,$nowkeyword,$px_ziduan,$pxv,$Conn,$hy;
	...
	$databiao="sys_msn";
	$const_shaixuan="";
	$SYS_ALL_ziduan_list="id,sys_nowbh,sys_gx_id_321,sys_jilu,sys_adddate,sys_gx_id_223,sys_gx_id_495,sys_gx_id_308,sys_id_login,sys_shenpi_all";
	$xianshi_ZD_num="7";
	$xianshi_KD_num="1589";
	$shuoding_num="3";
	$maxrecord="50";
...
if ( "1" . $databiao == "1" ) {
   ...
   $Tablecol_list="sys_nowbh,id,sys_gx_id_321,re_id222,sys_jilu,leixin,ismy,sys_id_zu,sys_shenpi,sys_web_shenpi,sys_shenpi_all,sys_yfzuid,sys_id_fz,sys_id_bumen,sys_huis,sys_adddate,sys_adddate_g,sys_login,sys_id_login,sys_bh,sys_zt,sys_zt_bianhao,sys_gx_id_223,sys_chaosong,sys_gx_id_495,sys_gx_id_308,sys_paixu,sys_gx_id_497,sys_gx_id_204";

   $sql2 = "select (@rownum:=@rownum+1) as rownum,sys_msn.id  from `sys_msn`,(select @rownum:=0) as sys_msn where  sys_yfzuid='$hy' and sys_huis='$huis' "; //这里得到查询id清单的sql
   ...
   if ( !$sql_all_id_list ) {
      ...
      $sql = "select  id,sys_nowbh,sys_gx_id_321,sys_jilu,sys_adddate,sys_gx_id_223,sys_gx_id_495,sys_gx_id_308,sys_id_login,sys_shenpi_all  from `sys_msn` where id in($sql_all_id_list) and sys_yfzuid='$hy' and sys_huis='$huis'";
      $sql .= " order by $px_ziduan $pxv";
      $rs = mysqli_query( $Conn, $sql );
      echo( "<div id='para'  tabindex='-1' class='tables'  style='border:0;border-bottom:1px solid #CCC;min-width:100%;width: 1589px'>" );
	      ...
	      if ( $const_q_cak >= 0 or $now_id_login == $bh ) {
			...
			//}
			echo( "  style='height:" . $r_cow_height . "px;line-height:" . $r_cow_height . "px;min-width:100%;width:1589px'> " );
			echo( "<li class='cols1 shuodingli'  title='$now_id'  style='height:" . $r_cow_height . "px;line-height:" . $r_cow_height . "px;text-align:center;'></li>" );
              ...
              echo("<li  class='shuodingli   ET_sys_gx_id_321$now_id F_M_XS_1' ET='ET_sys_gx_id_321'  xstypeid='1' name='sys_gx_id_321' style='height:28px;line-height:28px;width:90px;'>".DeleteHtml($row['sys_gx_id_321'])."</li>");
              echo("<li  class='shuodingli  border_shuoding  ET_sys_gx_id_223$now_id F_M_XS_1' ET='ET_sys_gx_id_223'  xstypeid='1' name='sys_gx_id_223' style='height:28px;line-height:28px;width:130px;'>".DeleteHtml($row['sys_gx_id_223'])."</li>");
              echo("<li  class='contentli ET_sys_jilu$now_id F_M_XS_1' ET='ET_sys_jilu'  xstypeid='1' name='sys_jilu' style='height:28px;line-height:28px;width:589px;'>".DeleteHtml($row['sys_jilu'])."</li>");
              ...
              echo("<li  class='contentli ET_sys_gx_id_495$now_id F_M_XS_1' ET='ET_sys_gx_id_495'  xstypeid='1' name='sys_gx_id_495' style='height:28px;line-height:28px;width:130px;'>".DeleteHtml($row['sys_gx_id_495'])."</li>");
              echo("<li  class='contentli ET_sys_gx_id_308$now_id F_M_XS_1' ET='ET_sys_gx_id_308'  xstypeid='1' name='sys_gx_id_308' style='height:28px;line-height:28px;width:140px;'>".DeleteHtml($row['sys_gx_id_308'])."</li>");
