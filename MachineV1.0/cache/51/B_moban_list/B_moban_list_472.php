...
if ( "1" . $databiao == "1" ) {
   ...
   $sql2 = "select (@rownum:=@rownum+1) as rownum,SQP_APQP.id  from `SQP_APQP`,(select @rownum:=0) as SQP_APQP where  sys_yfzuid='$hy' and sys_huis='$huis' "; //这里得到查询id清单的sql
   ...
   if ( !$sql_all_id_list ) {
      ...
      $sql = "select  id,sys_nowbh  from `SQP_APQP` where id in($sql_all_id_list) and sys_yfzuid='$hy' and sys_huis='$huis'";
