...
if ( "1" . $databiao == "1" ) {
   ...
   $Tablecol_list="id,sys_gx_id_198";

   $sql2 = "select (@rownum:=@rownum+1) as rownum,sys_biaozhun_menu.id  from `sys_biaozhun_menu`,(select @rownum:=0) as sys_biaozhun_menu where  sys_yfzuid='$hy' and sys_huis='$huis' "; //这里得到查询id清单的sql
   ...
   if ( !$sql_all_id_list ) {
      ...
      $sql = "select  id  from `sys_biaozhun_menu` where id in($sql_all_id_list) and sys_yfzuid='$hy' and sys_huis='$huis'";
