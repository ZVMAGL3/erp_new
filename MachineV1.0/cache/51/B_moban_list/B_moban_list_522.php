...
if ( "1" . $databiao == "1" ) {
   ...
   $sql2 = "select (@rownum:=@rownum+1) as rownum,SQP_LaTing77.id  from `SQP_LaTing77`,(select @rownum:=0) as SQP_LaTing77 where  sys_yfzuid='$hy' and sys_huis='$huis' "; //这里得到查询id清单的sql
   ...
   if ( !$sql_all_id_list ) {
      ...
      $sql = "select  id,sys_id_login,sys_shenpi_all  from `SQP_LaTing77` where id in($sql_all_id_list) and sys_yfzuid='$hy' and sys_huis='$huis'";
