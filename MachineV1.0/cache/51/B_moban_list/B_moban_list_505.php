   ...
   if ( !$sql_all_id_list ) {
      ...
      echo( "<div id='para'  tabindex='-1' class='tables'  style='border:0;border-bottom:1px solid #CCC;min-width:100%;width: 1748px'>" );
	      ...
	      if ( $const_q_cak >= 0 or $now_id_login == $bh ) {
			...
			//}
			echo( "  style='height:" . $r_cow_height . "px;line-height:" . $r_cow_height . "px;min-width:100%;width:1748px'> " );
			echo( "<li class='cols1 shuodingli'  title='$now_id'  style='height:" . $r_cow_height . "px;line-height:" . $r_cow_height . "px;text-align:center;'></li>" );
              ...
              echo("<li  class='contentli ET_ZD_NianFen$now_id F_M_XS_1' ET='ET_ZD_NianFen'  xstypeid='1' name='ZD_NianFen' style='height:28px;line-height:28px;width:30px;'>".DeleteHtml($row['ZD_NianFen'])."</li>");
              ...
              echo("<li  class='contentli ET_ZD_GongJiTian$now_id F_M_XS_1' ET='ET_ZD_GongJiTian'  xstypeid='1' name='ZD_GongJiTian' style='height:28px;line-height:28px;width:60px;'>".DeleteHtml($row['ZD_GongJiTian'])."</li>");
              echo("<li  class='contentli ET_ZD_ChuChaBuTie$now_id F_M_XS_1' ET='ET_ZD_ChuChaBuTie'  xstypeid='1' name='ZD_ChuChaBuTie' style='height:28px;line-height:28px;width:60px;'>".DeleteHtml($row['ZD_ChuChaBuTie'])."</li>");
              echo("<li  class='contentli ET_ZD_BeiZhu$now_id F_M_XS_2' ET='ET_ZD_BeiZhu'  xstypeid='2' name='ZD_BeiZhu' style='height:28px;line-height:28px;width:300px;'>".DeleteHtml($row['ZD_BeiZhu'])."</li>");
