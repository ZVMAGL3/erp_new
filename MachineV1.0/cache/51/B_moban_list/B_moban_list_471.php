...
global $const_q_cak,$ToHtmlID,$const_q_shanc,$const_q_xiug,$nowkeyword,$px_ziduan,$pxv,$Conn,$hy;
	$r_cow_height="28";
	$databiao="SQP_HeTongPingShenJiLuBiao";
	$const_shaixuan="";
	$SYS_ALL_ziduan_list="id,sys_nowbh,ZD_GuKeMingChen,ZD_HeTongBianHao,ZD_GuKeTeShuYaoQiuMiaoShu,ZD_XiaoShouBuPingShenRiQi,ZD_JiShuBuPingShenRiQi,ZD_ZongJingLiPingShenRiQi,ZD_BeiZhu,sys_id_login,sys_shenpi_all";
	$xianshi_ZD_num="8";
	$xianshi_KD_num="1300";
	$shuoding_num="2";
	$maxrecord="50";
...
if ( "1" . $databiao == "1" ) {
   ...
   $Tablecol_list="sys_nowbh,ZD_GuKeMingChen,id,sys_id_login,sys_login,sys_id_zu,sys_id_fz,sys_yfzuid,sys_bh,sys_zt,sys_zt_bianhao,sys_huis,sys_id_bumen,sys_shenpi,sys_web_shenpi,sys_adddate,sys_adddate_g,sys_shenpi_all,sys_chaosong,sys_gx_id_321,ZD_HeTongBianHao,ZD_GuKeTeShuYaoQiuMiaoShu,ZD_XiaoShouBuPingShenRiQi,ZD_JiShuBuPingShenRiQi,ZD_ZongJingLiPingShenRiQi,ZD_BeiZhu,sys_gx_id_423,sys_paixu";

   $sql2 = "select (@rownum:=@rownum+1) as rownum,SQP_HeTongPingShenJiLuBiao.id  from `SQP_HeTongPingShenJiLuBiao`,(select @rownum:=0) as SQP_HeTongPingShenJiLuBiao where  sys_yfzuid='$hy' and sys_huis='$huis' "; //这里得到查询id清单的sql
   ...
   if ( !$sql_all_id_list ) {
      ...
      $sql = "select  id,sys_nowbh,ZD_GuKeMingChen,ZD_HeTongBianHao,ZD_GuKeTeShuYaoQiuMiaoShu,ZD_XiaoShouBuPingShenRiQi,ZD_JiShuBuPingShenRiQi,ZD_ZongJingLiPingShenRiQi,ZD_BeiZhu,sys_id_login,sys_shenpi_all  from `SQP_HeTongPingShenJiLuBiao` where id in($sql_all_id_list) and sys_yfzuid='$hy' and sys_huis='$huis'";
      $sql .= " order by $px_ziduan $pxv";
      $rs = mysqli_query( $Conn, $sql );
      echo( "<div id='para'  tabindex='-1' class='tables'  style='border:0;border-bottom:1px solid #CCC;min-width:100%;width: 1300px'>" );
	      ...
	      if ( $const_q_cak >= 0 or $now_id_login == $bh ) {
			...
			//}
			echo( "  style='height:" . $r_cow_height . "px;line-height:" . $r_cow_height . "px;min-width:100%;width:1300px'> " );
			echo( "<li class='cols1 shuodingli'  title='$now_id'  style='height:" . $r_cow_height . "px;line-height:" . $r_cow_height . "px;text-align:center;'></li>" );
              ...
              echo("<li  class='shuodingli  border_shuoding  ET_ZD_GuKeMingChen$now_id F_M_XS_1' ET='ET_ZD_GuKeMingChen'  xstypeid='1' name='ZD_GuKeMingChen' style='height:28px;line-height:28px;width:150px;'>".DeleteHtml($row['ZD_GuKeMingChen'])."</li>");
              echo("<li  class='contentli ET_ZD_HeTongBianHao$now_id F_M_XS_1' ET='ET_ZD_HeTongBianHao'  xstypeid='1' name='ZD_HeTongBianHao' style='height:28px;line-height:28px;width:70px;'>".DeleteHtml($row['ZD_HeTongBianHao'])."</li>");
              echo("<li  class='contentli ET_ZD_GuKeTeShuYaoQiuMiaoShu$now_id F_M_XS_2' ET='ET_ZD_GuKeTeShuYaoQiuMiaoShu'  xstypeid='2' name='ZD_GuKeTeShuYaoQiuMiaoShu' style='height:28px;line-height:28px;width:300px;'>".DeleteHtml($row['ZD_GuKeTeShuYaoQiuMiaoShu'])."</li>");
              echo("<li  class='contentli ET_ZD_XiaoShouBuPingShenRiQi$now_id F_M_XS_1' ET='ET_ZD_XiaoShouBuPingShenRiQi'  xstypeid='1' name='ZD_XiaoShouBuPingShenRiQi' style='height:28px;line-height:28px;width:100px;'>".DeleteHtml($row['ZD_XiaoShouBuPingShenRiQi'])."</li>");
              echo("<li  class='contentli ET_ZD_JiShuBuPingShenRiQi$now_id F_M_XS_1' ET='ET_ZD_JiShuBuPingShenRiQi'  xstypeid='1' name='ZD_JiShuBuPingShenRiQi' style='height:28px;line-height:28px;width:100px;'>".DeleteHtml($row['ZD_JiShuBuPingShenRiQi'])."</li>");
              echo("<li  class='contentli ET_ZD_ZongJingLiPingShenRiQi$now_id F_M_XS_1' ET='ET_ZD_ZongJingLiPingShenRiQi'  xstypeid='1' name='ZD_ZongJingLiPingShenRiQi' style='height:28px;line-height:28px;width:100px;'>".DeleteHtml($row['ZD_ZongJingLiPingShenRiQi'])."</li>");
