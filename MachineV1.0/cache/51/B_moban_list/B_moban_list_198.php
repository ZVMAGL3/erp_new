...
global $const_q_cak,$ToHtmlID,$const_q_shanc,$const_q_xiug,$nowkeyword,$px_ziduan,$pxv,$Conn,$hy;
	...
	$databiao="sys_jlmb";
	$const_shaixuan="";
	$SYS_ALL_ziduan_list="id,sys_nowbh,sys_card,mdb_name_SYS,Id_MenuBigClass,banben,xiugaicishu,ul_row_height";
	$xianshi_ZD_num="7";
	$xianshi_KD_num="907";
	$shuoding_num="3";
	$maxrecord="50";
...
if ( "1" . $databiao == "1" ) {
   ...
   if ( !$sql_all_id_list ) {
      ...
      $sql = "select  id,sys_nowbh,sys_card,mdb_name_SYS,Id_MenuBigClass,banben,xiugaicishu,ul_row_height  from `sys_jlmb` where id in($sql_all_id_list) and sys_yfzuid='$hy' and sys_huis='$huis'";
