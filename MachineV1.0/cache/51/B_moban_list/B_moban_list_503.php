...
global $const_q_cak,$ToHtmlID,$const_q_shanc,$const_q_xiug,$nowkeyword,$px_ziduan,$pxv,$Conn,$hy;
	$r_cow_height="28";
	$databiao="SQP_JieChuLaoDongHeTongZhengMingShu";
	$const_shaixuan="";
	$SYS_ALL_ziduan_list="id,sys_nowbh,ZD_XingMing,ZD_XingBie,ZD_ShenFenZhengHao,ZD_QiShiGongZuoShiJian,ZD_SuoJieChuLaoDongHeTongQiXian,ZD_LiZhiYuanYin,ZD_JieChuLaoDongHeTongShiJian,ZD_LaoDongZheQianZi,sys_id_login,sys_shenpi_all";
	$xianshi_ZD_num="9";
	$xianshi_KD_num="1290";
	$shuoding_num="2";
	$maxrecord="50";
	$FormattingXianShi_idlist="1,11,8,2,17";
	$zu_all_list="";
...
if ( "1" . $databiao == "1" ) {
   ...
   if ( !$sql_all_id_list ) {
      ...
      $sql = "select  id,sys_nowbh,ZD_XingMing,ZD_XingBie,ZD_ShenFenZhengHao,ZD_QiShiGongZuoShiJian,ZD_SuoJieChuLaoDongHeTongQiXian,ZD_LiZhiYuanYin,ZD_JieChuLaoDongHeTongShiJian,ZD_LaoDongZheQianZi,sys_id_login,sys_shenpi_all  from `SQP_JieChuLaoDongHeTongZhengMingShu` where id in($sql_all_id_list) and sys_yfzuid='$hy' and sys_huis='$huis'";
      $sql .= " order by $px_ziduan $pxv";
      $rs = mysqli_query( $Conn, $sql );
      echo( "<div id='para'  tabindex='-1' class='tables'  style='border:0;border-bottom:1px solid #CCC;min-width:100%;width: 1290px'>" );
	      ...
	      if ( $const_q_cak >= 0 or $now_id_login == $bh ) {
			...
			//}
			echo( "  style='height:" . $r_cow_height . "px;line-height:" . $r_cow_height . "px;min-width:100%;width:1290px'> " );
			echo( "<li class='cols1 shuodingli'  title='$now_id'  style='height:" . $r_cow_height . "px;line-height:" . $r_cow_height . "px;text-align:center;'></li>" );
              ...
              echo("<li  class='shuodingli  border_shuoding  ET_ZD_XingMing$now_id F_M_XS_1' ET='ET_ZD_XingMing'  xstypeid='1' name='ZD_XingMing' style='height:28px;line-height:28px;width:70px;'>".DeleteHtml($row['ZD_XingMing'])."</li>");
              ...
              echo("<li  class='contentli ET_ZD_ShenFenZhengHao$now_id F_M_XS_1' ET='ET_ZD_ShenFenZhengHao'  xstypeid='1' name='ZD_ShenFenZhengHao' style='height:28px;line-height:28px;width:130px;'>".DeleteHtml($row['ZD_ShenFenZhengHao'])."</li>");
              echo("<li  class='contentli ET_ZD_QiShiGongZuoShiJian$now_id F_M_XS_8' ET='ET_ZD_QiShiGongZuoShiJian'  xstypeid='8' name='ZD_QiShiGongZuoShiJian' style='height:28px;line-height:28px;width:130px;'>".DeleteHtml($row['ZD_QiShiGongZuoShiJian'])."</li>");
              echo("<li  class='contentli ET_ZD_SuoJieChuLaoDongHeTongQiXian$now_id F_M_XS_1' ET='ET_ZD_SuoJieChuLaoDongHeTongQiXian'  xstypeid='1' name='ZD_SuoJieChuLaoDongHeTongQiXian' style='height:28px;line-height:28px;width:130px;'>".DeleteHtml($row['ZD_SuoJieChuLaoDongHeTongQiXian'])."</li>");
              echo("<li  class='contentli ET_ZD_LiZhiYuanYin$now_id F_M_XS_2' ET='ET_ZD_LiZhiYuanYin'  xstypeid='2' name='ZD_LiZhiYuanYin' style='height:28px;line-height:28px;width:200px;'>".DeleteHtml($row['ZD_LiZhiYuanYin'])."</li>");
              echo("<li  class='contentli ET_ZD_JieChuLaoDongHeTongShiJian$now_id F_M_XS_8' ET='ET_ZD_JieChuLaoDongHeTongShiJian'  xstypeid='8' name='ZD_JieChuLaoDongHeTongShiJian' style='height:28px;line-height:28px;width:130px;'>".DeleteHtml($row['ZD_JieChuLaoDongHeTongShiJian'])."</li>");
              echo("<li  class='contentli ET_ZD_LaoDongZheQianZi$now_id F_M_XS_17' ET='ET_ZD_LaoDongZheQianZi'  xstypeid='17' name='ZD_LaoDongZheQianZi' style='height:28px;line-height:28px;width:70px;'>".DeleteHtml($row['ZD_LaoDongZheQianZi'])."</li>");
