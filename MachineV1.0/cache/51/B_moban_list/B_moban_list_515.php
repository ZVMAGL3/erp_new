...
if ( "1" . $databiao == "1" ) {
   ...
   $sql2 = "select (@rownum:=@rownum+1) as rownum,sys_Work.id  from `sys_Work`,(select @rownum:=0) as sys_Work where  sys_yfzuid='$hy' and sys_huis='$huis' "; //这里得到查询id清单的sql
   ...
   if ( !$sql_all_id_list ) {
      ...
      $sql = "select  id  from `sys_Work` where id in($sql_all_id_list) and sys_yfzuid='$hy' and sys_huis='$huis'";
