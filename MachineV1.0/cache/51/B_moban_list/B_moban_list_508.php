   ...
   if ( !$sql_all_id_list ) {
      ...
      echo( "<div id='para'  tabindex='-1' class='tables'  style='border:0;border-bottom:1px solid #CCC;min-width:100%;width: 1448px'>" );
	      ...
	      if ( $const_q_cak >= 0 or $now_id_login == $bh ) {
			...
			//}
			echo( "  style='height:" . $r_cow_height . "px;line-height:" . $r_cow_height . "px;min-width:100%;width:1448px'> " );
			echo( "<li class='cols1 shuodingli'  title='$now_id'  style='height:" . $r_cow_height . "px;line-height:" . $r_cow_height . "px;text-align:center;'></li>" );
              ...
              echo("<li  class='contentli ET_ZD_GongJi$now_id F_M_XS_1' ET='ET_ZD_GongJi'  xstypeid='1' name='ZD_GongJi' style='height:28px;line-height:28px;width:50px;'>".DeleteHtml($row['ZD_GongJi'])."</li>");
