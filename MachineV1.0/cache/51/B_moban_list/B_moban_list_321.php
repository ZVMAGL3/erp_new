...
global $const_q_cak,$ToHtmlID,$const_q_shanc,$const_q_xiug,$nowkeyword,$px_ziduan,$pxv,$Conn,$hy;
	...
	$SYS_ALL_ziduan_list="id,sys_nowbh,ZD_BeiZhuQiYeGongShangXinYongDeng,ZD_GongSiMingChen,ZD_FuZeRen,ZD_YiXiangFuWu,XiangMuJingLi,ZD_ChengJiaoXiangMu,ZD_DengJi,ZD_BaoJiaFuJian,DianHua,ShengChanChanPin,DiZhi,sys_id_zu,sys_chaosong,sys_count_510,ZD_WeiXin";
	$xianshi_ZD_num="16";
	$xianshi_KD_num="2313";
	$shuoding_num="10";
	$maxrecord="20";
...
if ( "1" . $databiao == "1" ) {
   ...
   if ( !$sql_all_id_list ) {
      ...
      $sql = "select  id,sys_nowbh,ZD_BeiZhuQiYeGongShangXinYongDeng,ZD_GongSiMingChen,ZD_FuZeRen,ZD_YiXiangFuWu,XiangMuJingLi,ZD_ChengJiaoXiangMu,ZD_DengJi,ZD_BaoJiaFuJian,DianHua,ShengChanChanPin,DiZhi,sys_id_zu,sys_chaosong,sys_count_510,ZD_WeiXin  from `sys_gukedanganbiao` where id in($sql_all_id_list) and sys_yfzuid='$hy' and sys_huis='$huis'";
      $sql .= " order by $px_ziduan $pxv";
      $rs = mysqli_query( $Conn, $sql );
      echo( "<div id='para'  tabindex='-1' class='tables'  style='border:0;border-bottom:1px solid #CCC;min-width:100%;width:2313'>" );
	      ...
	      if ( $const_q_cak >= 0 ) {
			...
			echo( "<li class='cols1 shuodingli'  title='$now_id'  style='height:" . $r_cow_height . "px;line-height:" . $r_cow_height . "px;text-align:center;'></li>" );
              ...
              echo("<li id='c_tdtop1'  class='shuodingli   ET_sys_nowbh$now_id F_M_XS_1' ET='ET_sys_nowbh'  xstypeid='1' name='sys_nowbh' style='height:28px;line-height:28px;width:88px;'>".DeleteHtml($row['sys_nowbh'])."</li>");
              ...
              echo("<li  class='shuodingli   ET_ZD_BaoJiaFuJian$now_id F_M_XS_6' ET='ET_ZD_BaoJiaFuJian'  xstypeid='6' name='ZD_BaoJiaFuJian' style='height:28px;line-height:28px;width:80px;'>".DeleteHtml($row['ZD_BaoJiaFuJian'])."</li>");
              ...
              echo("<li  class='shuodingli  border_shuoding  ET_ZD_WeiXin$now_id F_M_XS_18' ET='ET_ZD_WeiXin'  xstypeid='18' name='ZD_WeiXin' style='height:28px;line-height:28px;width:39px;'>".DeleteHtml($row['ZD_WeiXin'])."</li>");
