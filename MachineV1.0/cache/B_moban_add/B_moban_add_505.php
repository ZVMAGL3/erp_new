<?php
		...
		echo"<form id='post_form' autocomplete='off' tit='' SYS_Company_id=''  style='padding-top:18px'>
...
if ( strpos($const_q_tianj, "505") !== false  ) { //有添加权限时
       echo"<ul>
          ...
          <input id='SYS_submit' value='提交' type='button' title='Ctrl+Enter提交' class='button button_ADD' style='width:90%'  SYS_Company_id='' strmk_id='' firstinputname='id' bitian_Arry='' databiao='SQP_ChuChaShiJianHuiZong' Wuchongfu_Arry=''  onclick=data_add_arrys(this,'#post_form','$ToHtmlID')   onkeydown='EnterPress(event,this,this.click)' />
